...
namespace Ams.CodeGenerator
{
    ...
    public class GenConstants
    {
        ...
        /// InputDto输入实体是不包含字段
        /// </summary>
        public static readonly string[] inputDtoNoField = new string[] { "UDF01", "UDF02", "UDF03", "UDF04", "UDF05", "UDF06", "UDF51", "UDF52", "UDF53", "UDF54", "UDF55", "UDF56", "IsDeleted", "createTime", "updateTime", "addtime", "create_time", "update_time", "create_by", "update_by" };
        /// <summary>
        /// 图片字段
        /// </summary>
        ...
        /// 数据库数值类型
        /// </summary>
        public static string[] COLUMNTYPE_INT = { "bool", "decimal", "double", "float" , "int", "long" };
        /// <summary>
        /// 页面不需要编辑字段
        /// </summary>
        public static string[] COLUMNNAME_NOT_EDIT = { "id", "UDF01", "UDF02", "UDF03", "UDF04", "UDF05", "UDF06", "UDF51", "UDF52", "UDF53", "UDF54", "UDF55", "UDF56", "create_by", "create_time", "Create_by", "Create_time", "update_by", "update_time", "Update_by", "Update_time", "IsDeleted" };

        /// <summary>
        /// 页面不需要显示的列表字段
        /// </summary>
        public static string[] COLUMNNAME_NOT_LIST = { "UDF01","UDF02","UDF03","UDF04","UDF05","UDF06","UDF51","UDF52","UDF53","UDF54","UDF55","UDF56","IsDeleted","create_by", "create_time", "IsDeleted", "update_by",
            "update_time" , "password"};

        /// <summary>
        /// 页面不需要查询字段
        /// </summary>
        public static string[] COLUMNNAME_NOT_QUERY = { "id", "UDF01","UDF02","UDF03","UDF04","UDF05","UDF06","UDF51","UDF52","UDF53","UDF54","UDF55","UDF56","IsDeleted","create_by", "create_time", "IsDeleted", "update_by",
            "update_time", "remark" };
        /// <summary>
        /// 页面不需要导出字段
        /// </summary>
        ...
        public static string[] COLUMNNAME_NOT_REQUIRED = { "IsDeleted", "UDF01", "UDF02", "UDF03", "UDF04", "UDF05", "UDF06", "UDF51", "UDF52", "UDF53", "UDF54", "UDF55", "UDF56", "create_by", "create_time", "Create_by", "Create_time", "update_by", "update_time", "Update_by", "Update_time", };
        /// <summary>
        /// Entity基类字段
        /// </summary>
