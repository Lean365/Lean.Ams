    ...
    public class CodeGeneratorTool
    {
        ...
        public static void Generate(GenerateDto dto)
        {
            ...
            ReplaceDto replaceDto = new()
            {
                ...
                ShowBtnImport = dto.GenTable.Options.CheckedBtn.Any(f => f == 4),
                ShowBtnExport = dto.GenTable.Options.CheckedBtn.Any(f => f == 5),
                ShowBtnMultiDel = dto.GenTable.Options.CheckedBtn.Any(f => f == 6),
                ShowBtnTruncate = dto.GenTable.Options.CheckedBtn.Any(f => f == 7),
                ShowBtnView = dto.GenTable.Options.CheckedBtn.Any(f => f == 8),
