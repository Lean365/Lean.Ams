namespace Ams.Generator
{
    ...
    public class GenConstants
    {
        ...
        /// InputDto输入实体是不包含字段
        /// </summary>
        public static readonly string[] inputDtoNoField = new string[] { "createTime", "updateTime", "create_time", "update_time", "create_by", "update_by" };
        ...
        /// 页面不需要显示的列表字段
        /// </summary>
        public static string[] COLUMNNAME_NOT_LIST = { "create_by", "create_time", "IsDeleted", "update_by",
            "update_time" , "password", "UDF01", "UDF02", "UDF03", "UDF04", "UDF05", "UDF06", "UDF51", "UDF52", "UDF53", "UDF54", "UDF55", "UDF56"};

        /// <summary>
        /// 页面不需要查询字段
        /// </summary>
        public static string[] COLUMNNAME_NOT_QUERY = { "id", "create_by", "create_time", "IsDeleted", "update_by",
            "update_time", "remark", "UDF01", "UDF02", "UDF03", "UDF04", "UDF05", "UDF06", "UDF51", "UDF52", "UDF53", "UDF54", "UDF55", "UDF56" };

        /// <summary>
        /// 页面不需要导出字段
        /// </summary>
        public static string[] COLUMNNAME_NOT_EXPORT = { "update_by", "updateTime", "update_time", "UDF01", "UDF02", "UDF03", "UDF04", "UDF05", "UDF06", "UDF51", "UDF52", "UDF53", "UDF54", "UDF55", "UDF56" };

        /// <summary>
        /// 页面不需要填写字段
        /// </summary>

        public static string[] COLUMNNAME_NOT_REQUIRED = { "IsDeleted", "createTime", "updateTime", "create_time", "update_time", "create_by", "update_by", "UDF01", "UDF02", "UDF03", "UDF04", "UDF05", "UDF06", "UDF51", "UDF52", "UDF53", "UDF54", "UDF55", "UDF56" };
