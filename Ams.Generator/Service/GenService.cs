...
namespace Ams.Generator.Service
{
    ...
    /// @Date 2004-02-01
    /// @Email <itsup@lean365.cn>
    /// </summary>
    public class GenService : GenDbProvider
    {
        /// <summary>
        /// 获取所有数据库名
        /// </summary>
        ...
        /// <param name="dbName"></param>
        /// <returns></returns>
        public List<GenOracleSeq> GetAllGenOracleSeqs(string dbName)
        {
            string sql = "SELECT * FROM USER_SEQUENCES";
            var seqs = GetSugarDbContext(dbName).Ado.SqlQuery<GenOracleSeq>(sql);
