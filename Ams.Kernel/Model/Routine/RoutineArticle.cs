...
namespace Ams.Kernel.Model.Routine
{
    ...
    [Tenant("0")]
    public class RoutineArticle : SysBase
    {
        /// <summary>
        /// 文章id
        /// </summary>
        ...
        /// 文章状态 1、发布 2、草稿
        /// </summary>
        [SugarColumn(ColumnDescription = "文章状态 1、发布 2、草稿", DefaultValue = "0")]
        ...
        [Navigate(NavigateType.OneToOne, nameof(CategoryId), nameof(RoutineArticleCategory.CategoryId))] //自定义关系映射
