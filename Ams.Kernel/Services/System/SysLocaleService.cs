...
namespace Ams.Kernel.Services.System
{
    ...
    public class SysLocaleService : BaseService<SysLocale>, ISysLocaleService
    {
        ...
        /// <returns></returns>
        public PagedInfo<SysLocale> GetList(SysLocaleQueryDto parm)
        {
            var predicate = Expressionable.Create<SysLocale>();
        ...
        /// <param name="parm"></param>
        /// <returns></returns>
        public dynamic GetListToPivot(SysLocaleQueryDto parm)
        {
            var predicate = Expressionable.Create<SysLocale>();
        ...
        public List<SysLocale> GetLangList(SysLocaleQueryDto parm)
        {
            var predicate = Expressionable.Create<SysLocale>();
        ...
        public void StorageSysLocale(SysLocaleDto parm)
        {
            List<SysLocale> langs = new();
        ...
        public Dictionary<string, object> SetLang(List<SysLocale> msgList)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public (string, object, object) ImportSysLocale(List<SysLocale> list)
        {
