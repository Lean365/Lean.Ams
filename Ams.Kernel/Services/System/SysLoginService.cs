...
namespace Ams.Kernel.Services.System
{
    ...
    public class SysLoginService : BaseService<LogLogin>, ISysLoginService
    {
        ...
        /// <returns></returns>
        public SysUser PhoneLogin(PhoneLoginDto loginBody, LogLogin logininfor, SysUser user)
        {
        ...
        public List<LogStatiDto> GetStatiLoginlog()
        {
