namespace Ams.Model.Accounting
{
    ...
    public class FicoBudgetStaff : SysBase
    {
        ...
        /// 年月
        /// </summary>
        [SugarColumn(ColumnName = "FbsFm", ColumnDescription = "年月 ", Length = 4)]
        public string FbsFm { get; set; }

        /// <summary>
        /// 科目
        /// </summary>
        [SugarColumn(ColumnName = "FbsTitle", ColumnDescription = "科目 ", Length = 40)]
        public string FbsTitle { get; set; }

        /// <summary>
        /// 名称
        /// </summary>
        [SugarColumn(ColumnName = "FbsClass", ColumnDescription = "名称 ", Length = 100)]
        public string FbsClass { get; set; }

        /// <summary>
        /// 类别
        /// </summary>
        [SugarColumn(ColumnName = "FbsCategory", ColumnDescription = "类别 ", Length = 100)]
        public string FbsCategory { get; set; }

        /// <summary>
        /// 保有
        /// </summary>
        [SugarColumn(ColumnName = "FbsKeepPersonnel", ColumnDescription = "保有 ", DefaultValue = "0")]
        public int FbsKeepPersonnel { get; set; }

        /// <summary>
        /// 现有
        /// </summary>
        [SugarColumn(ColumnName = "FbsNowPersonnel", ColumnDescription = "现有 ", DefaultValue = "0")]
        public int FbsNowPersonnel { get; set; }

        /// <summary>
        /// 预算
        /// </summary>
        [SugarColumn(ColumnName = "FbsPersonnel", ColumnDescription = "预算 ", DefaultValue = "0")]
        public int FbsPersonnel { get; set; }

        /// <summary>
        /// 启用
        /// </summary>
        [SugarColumn(ColumnName = "FbsFlag", ColumnDescription = "启用 ", DefaultValue = "0")]
