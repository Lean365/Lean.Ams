...
namespace Ams.Model.Accounting
{
    ...
    public class FicoProfitCenter
    {
        ...
        /// 负责人 
        /// </summary>
        [SugarColumn(ColumnName="Verak", ColumnDescription = "负责人 ",Length = 4)]
        public string Verak { get; set; }

        /// <summary>
        /// 货币 
        /// </summary>
        [SugarColumn(ColumnName="Waers", ColumnDescription = "货币 ",DefaultValue = "0")]
        public int? Waers { get; set; }

        /// <summary>
        /// 名称 
        /// </summary>
        [SugarColumn(ColumnName="Ktext", ColumnDescription = "名称 ",Length = 20)]
        public string Ktext { get; set; }

        /// <summary>
        /// 长文本 
        /// </summary>
        [SugarColumn(ColumnName="Ltext", ColumnDescription = "长文本 ",Length = 40)]
        public string Ltext { get; set; }

        /// <summary>
        /// 利润中心说明 
        /// </summary>
        [SugarColumn(ColumnName="Mctext", ColumnDescription = "利润中心说明 ",Length = 40)]
