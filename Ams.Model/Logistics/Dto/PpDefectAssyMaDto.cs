...
namespace Ams.Model.Logistics.Dto
{
    ...
    /// </summary>
    public class PpDefectAssyMaQueryDto : PagerInfo 
    {
        /// <summary>
        /// 生产订单 
        /// </summary>        
    ...
    /// @Date: 2024/11/12 17:19:09
    /// </summary>
    public class PpDefectAssyMaDto
    {
        //[ExcelColumn(Name = "ID")]
        [ExcelColumnName("ID")]
        ...
        [ExcelIgnore]
        public List<PpDefectAssySlvDto> PpDefectAssySlvNav { get; set; }
        [ExcelIgnore]
        [ExcelColumn(Name = "生产订单")]
    ...
    /// @Date: 2024/11/12 17:19:09
    /// </summary>
    public class PpDefectAssyMaImportTpl
    {
        //[ExcelColumn(Name = "ID")]
        [ExcelColumnName("ID")]
        [JsonConverter(typeof(ValueToStringConverter))]
