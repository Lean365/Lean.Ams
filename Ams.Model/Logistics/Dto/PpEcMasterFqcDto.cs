...
namespace Ams.Model.Logistics.Dto
{
    ...
    /// </summary>
    public class PpEcMasterFqcQueryDto : PagerInfo 
    {
    ...
    public class PpEcMasterFqcDto
    {
        ...
        [ExcelIgnore]
        public List<PpEcSlaveFqcDto> PpEcSlaveFqcNav { get; set; }
        [ExcelColumn(Name = "担当")]
    ...
    /// @Date: 2024/7/31 15:49:12
    /// </summary>
    public class PpEcMasterFqcImportTpl
    {
        [ExcelColumn(Name = "SfId")]
        [ExcelColumnName("SfId")]
        public long? EcmSfId { get; set; }
