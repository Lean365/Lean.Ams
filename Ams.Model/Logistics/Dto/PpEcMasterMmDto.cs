...
namespace Ams.Model.Logistics.Dto
{
    ...
    /// </summary>
    public class PpEcMasterMmQueryDto : PagerInfo 
    {
    ...
    public class PpEcMasterMmDto
    {
        ...
        [ExcelIgnore]
        public List<PpEcSlaveMmDto> PpEcSlaveMmNav { get; set; }
        [ExcelColumn(Name = "担当")]
    ...
    /// @Date: 2024/7/31 16:02:20
    /// </summary>
    public class PpEcMasterMmImportTpl
    {
        [ExcelColumn(Name = "SfId")]
        [ExcelColumnName("SfId")]
        public long? EcmSfId { get; set; }
