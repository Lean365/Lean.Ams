...
namespace Ams.Model.Logistics.Dto
{
    ...
    /// </summary>
    public class PpEcMasterPcbaQueryDto : PagerInfo 
    {
    ...
    /// @Date: 2024/7/31 15:49:18
    /// </summary>
    public class PpEcMasterPcbaDto
    {
        ...
        [ExcelIgnore]
        public List<PpEcSlavePcbaDto> PpEcSlavePcbaNav { get; set; }
        [ExcelColumn(Name = "担当")]
    ...
    /// @Date: 2024/7/31 15:49:18
    /// </summary>
    public class PpEcMasterPcbaImportTpl
    {
        [ExcelColumn(Name = "SfId")]
        [ExcelColumnName("SfId")]
        public long? EcmSfId { get; set; }
