...
namespace Ams.Model.Logistics.Dto
{
    ...
    /// </summary>
    public class PpEcMasterPeQueryDto : PagerInfo 
    {
    ...
    public class PpEcMasterPeDto
    {
        ...
        [ExcelIgnore]
        public List<PpEcSlavePeDto> PpEcSlavePeNav { get; set; }
        [ExcelColumn(Name = "担当")]
    ...
    /// @Date: 2024/7/31 15:49:21
    /// </summary>
    public class PpEcMasterPeImportTpl
    {
        [ExcelColumn(Name = "SfId")]
        [ExcelColumnName("SfId")]
        public long? EcmSfId { get; set; }
