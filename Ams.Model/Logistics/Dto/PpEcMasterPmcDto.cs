namespace Ams.Model.Logistics.Dto
{
    ...
    /// </summary>
    public class PpEcMasterPmcQueryDto : PagerInfo
    {
    ...
    public class PpEcMasterPmcDto
    {
        ...
        [ExcelIgnore]
        public List<PpEcSlavePmcDto> PpEcSlavePmcNav { get; set; }
        ...
        [ExcelColumn(Name = "软删除")]
        public string NavIsDeletedLabel { get; set; }
    }
    ...
    /// @Date: 2024/7/24 14:46:21
    /// </summary>
    public class PpEcMasterPmcImportTpl
    {
        [Required(ErrorMessage = "Sfid不能为空")]
        [ExcelColumn(Name = "Sfid")]
        [ExcelColumnName("Sfid")]
