...
namespace Ams.Model.Logistics.Dto
{
    ...
    /// </summary>
    public class PpEcMasterPurQueryDto : PagerInfo 
    {
    ...
    public class PpEcMasterPurDto
    {
        ...
        [ExcelIgnore]
        public List<PpEcSlavePurDto> PpEcSlavePurNav { get; set; }
        [ExcelColumn(Name = "担当")]
    ...
    /// @Date: 2024/7/31 15:49:25
    /// </summary>
    public class PpEcMasterPurImportTpl
    {
        [ExcelColumn(Name = "SfId")]
        [ExcelColumnName("SfId")]
        public long? EcmSfId { get; set; }
