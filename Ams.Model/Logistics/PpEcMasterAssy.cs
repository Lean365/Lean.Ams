namespace Ams.Model.Logistics
{
    ...
    /// </summary>
    [SugarTable("pp_ec_master_assy", "制一")]
    public class PpEcMasterAssy : SysBase
    {
        /// <summary>
        /// ID
        /// </summary>
        ...
        [Navigate(NavigateType.OneToMany, nameof(PpEcSlaveAssy.AssyParentSfId), nameof(EcmSfId))] //自定义关系映射
        public List<PpEcSlaveAssy> PpEcSlaveAssyNav { get; set; }
    }
}