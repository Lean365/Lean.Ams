namespace Ams.Model.Logistics
{
    ...
    /// </summary>
    [SugarTable("pp_ec_master_iqc", "受检")]
    public class PpEcMasterIqc : SysBase
    {
        /// <summary>
        /// ID
        /// </summary>
        ...
        [Navigate(NavigateType.OneToMany, nameof(PpEcSlaveIqc.IqcParentSfId), nameof(EcmSfId))] //自定义关系映射
        public List<PpEcSlaveIqc> PpEcSlaveIqcNav { get; set; }
    }
}