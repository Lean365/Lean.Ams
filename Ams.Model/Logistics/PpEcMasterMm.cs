namespace Ams.Model.Logistics
{
    ...
    /// </summary>
    [SugarTable("pp_ec_master_mm", "部管")]
    public class PpEcMasterMm : SysBase
    {
        /// <summary>
        /// ID
        /// </summary>
        ...
        [Navigate(NavigateType.OneToMany, nameof(PpEcSlaveMm.MmParentSfId), nameof(EcmSfId))] //自定义关系映射
        public List<PpEcSlaveMm> PpEcSlaveMmNav { get; set; }
    }
}