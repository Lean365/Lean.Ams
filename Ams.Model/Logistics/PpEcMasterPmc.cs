namespace Ams.Model.Logistics
{
    ...
    /// </summary>
    [SugarTable("pp_ec_master_pmc", "生管")]
    public class PpEcMasterPmc : SysBase
    {
        /// <summary>
        /// ID
        /// </summary>
        ...
        [Navigate(NavigateType.OneToMany, nameof(PpEcSlavePmc.PmcParentSfId), nameof(EcmSfId))] //自定义关系映射
        public List<PpEcSlavePmc> PpEcSlavePmcNav { get; set; }
    }
}