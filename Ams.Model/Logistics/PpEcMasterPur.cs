namespace Ams.Model.Logistics
{
    ...
    /// </summary>
    [SugarTable("pp_ec_master_pur", "采购")]
    public class PpEcMasterPur : SysBase
    {
        /// <summary>
        /// ID
        /// </summary>
        ...
        [Navigate(NavigateType.OneToMany, nameof(PpEcSlavePur.PurParentSfId), nameof(EcmSfId))] //自定义关系映射
        public List<PpEcSlavePur> PpEcSlavePurNav { get; set; }
    }
}