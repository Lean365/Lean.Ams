...
namespace Ams.Service.Accounting
{
    ...
    /// </summary>
    [AppService(ServiceType = typeof(IFicoAssetService), ServiceLifetime = LifeTime.Transient)]
    public class FicoAssetService : BaseService<FicoAsset>, IFicoAssetService
    {
        /// <summary>
        /// 查询固定资产列表
        /// </summary>
        ...
        /// <returns></returns>
        public PagedInfo<FicoAssetDto> GetList(FicoAssetQueryDto parm)
        {
            var predicate = QueryExp(parm);

            var response = Queryable()
                .Where(predicate.ToExpression())
                .ToPage<FicoAsset, FicoAssetDto>(parm);
        ...
        /// <returns></returns>
        public FicoAsset GetInfo(long FaSFID)
        {
            var response = Queryable()
        ...
        /// <returns></returns>
        public FicoAsset AddFicoAsset(FicoAsset model)
        {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public int UpdateFicoAsset(FicoAsset model)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public (string, object, object) ImportFicoAsset(List<FicoAsset> list)
        {
        ...
        /// <param name="parm"></param>
        /// <returns></returns>
        public PagedInfo<FicoAssetDto> ExportList(FicoAssetQueryDto parm)
        {
            var predicate = QueryExp(parm);

            var response = Queryable()
                .Where(predicate.ToExpression())
                .Select((it) => new FicoAssetDto()
                {
                    ...
                    FaCostCenterLabel = it.FaCostCenter.GetConfigValue<SysDictData>("sql_prctr_list"),
                    ...
                    FaAssetStopLabel = it.FaAssetStop.GetConfigValue<SysDictData>("sys_is_status"),
        ...
        /// <param name="parm"></param>
        /// <returns></returns>
        private static Expressionable<FicoAsset> QueryExp(FicoAssetQueryDto parm)
        {
            var predicate = Expressionable.Create<FicoAsset>();
            ...
            predicate = predicate.AndIF(!string.IsNullOrEmpty(parm.FaLocale), it => it.FaLocale.Contains(parm.FaLocale));
