...
using Ams.Service.DataBase.Extension;
...
namespace Ams.Service.DataBase
{
    ...
    /// 数据库管理
    /// </summary>
    public class DataBaseManageService : IDataBaseManageService
    {
        private readonly ISqlSugarClient _sqlSugarClient;
        private readonly IViewEngine _viewEngine;

        public DataBaseManageService(ISqlSugarClient sqlSugarClient, IViewEngine viewEngine)
        {
        ...
        {
            var templatePath = Path.Combine(Furion.App.WebHostEnvironment.WebRootPath, "Template");
        ...
        {
            var backendPath = Path.Combine(new DirectoryInfo(Furion.App.WebHostEnvironment.ContentRootPath).Parent.FullName, input.Position, "Entity");
