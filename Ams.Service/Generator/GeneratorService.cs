...
namespace Ams.Service.Generator
{
    ...
    /// 代码生成表
    /// </summary>
    [AppService(ServiceType = typeof(IGeneratorService), ServiceLifetime = LifeTime.Transient)]
    public class GeneratorService : BaseService<GenTable>, IGeneratorService
    {
        private IGenTableColumnService GenTableColumnService;

        public GeneratorService(IGenTableColumnService genTableColumnService)
        {
