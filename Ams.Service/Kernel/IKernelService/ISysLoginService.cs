...
{
    public interface ISysLoginService : IBaseService<LoginLog>
    {
        /// <summary>
        /// 登录
        /// </summary>
        ...
        /// <returns></returns>
        SysUser PhoneLogin(PhoneLoginDto loginBody, LoginLog logininfor, SysUser user);

        /// <summary>
        /// 查询操作日志
        /// </summary>
        PagedInfo<LoginLog> GetLoginLog(LoginLogQueryDto logininfoDto);
        ...
        /// <returns></returns>
        public void AddLoginInfo(LoginLog sysLogininfor);
