...
namespace Ams.Service.Logistics
{
    ...
    /// </summary>
    [AppService(ServiceType = typeof(IPpEcMasterIqcService), ServiceLifetime = LifeTime.Transient)]
    public class PpEcMasterIqcService : BaseService<PpEcMasterIqc>, IPpEcMasterIqcService
    {
        /// <summary>
        /// 查询受检列表
        /// </summary>
        ...
        /// <returns></returns>
        public PagedInfo<PpEcMasterIqcDto> GetList(PpEcMasterIqcQueryDto parm)
        {
            var predicate = QueryExp(parm);

            var response = Queryable()
                //.Includes(x => x.PpEcSlaveIqcNav) //填充子对象
                //.OrderBy("EcmIssueDate desc")
                .Where(predicate.ToExpression())
                .ToPage<PpEcMasterIqc, PpEcMasterIqcDto>(parm);
        ...
        /// <returns></returns>
        public PpEcMasterIqc GetInfo(long EcmSfId)
        {
            var response = Queryable()
                .Includes(x => x.PpEcSlaveIqcNav) //填充子对象
        ...
        /// <returns></returns>
        public PpEcMasterIqc AddPpEcMasterIqc(PpEcMasterIqc model)
        {
            return Context.InsertNav(model).Include(s1 => s1.PpEcSlaveIqcNav).ExecuteReturnEntity();
        }
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public int UpdatePpEcMasterIqc(PpEcMasterIqc model)
        {
            return Context.UpdateNav(model).Include(z1 => z1.PpEcSlaveIqcNav).ExecuteCommand() ? 1 : 0;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public (string, object, object) ImportPpEcMasterIqc(List<PpEcMasterIqc> list)
        {
        ...
        /// <param name="parm"></param>
        /// <returns></returns>
        public PagedInfo<PpEcMasterIqcDto> ExportList(PpEcMasterIqcQueryDto parm)
        {
            var predicate = QueryExp(parm);

            var response = Queryable()
                .Where(predicate.ToExpression())
                .Select((it) => new PpEcMasterIqcDto()
                {
        ...
        /// <param name="parm"></param>
        /// <returns></returns>
        private static Expressionable<PpEcMasterIqc> QueryExp(PpEcMasterIqcQueryDto parm)
        {
            var predicate = Expressionable.Create<PpEcMasterIqc>();
