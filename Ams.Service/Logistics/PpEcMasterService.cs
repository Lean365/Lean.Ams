    ...
    public class PpEcMasterService : BaseService<PpEcMaster>, IPpEcMasterService
    {
        ...
        public PagedInfo<PpEcMasterDto> ExportList(PpEcMasterQueryDto parm)
        {
            ...
            var response = Queryable()
                ...
                {
                    EmEcStatusLabel = it.EmEcStatus.GetConfigValue<Kernel.Model.System.SysDictData>("sys_yes_no"),
                    EmEcAssignedLabel = it.EmEcAssigned.GetConfigValue<Kernel.Model.System.SysDictData>("sql_ec_group"),
                    EmEcManageCategoryLabel = it.EmEcManageCategory.GetConfigValue<Kernel.Model.System.SysDictData>("app_ec_mgtype"),
        ...
        private static Expressionable<PpEcMaster> QueryExp(PpEcMasterQueryDto parm)
        {
            ...
            predicate = predicate.AndIF(!string.IsNullOrEmpty(parm.EmEcStatus), it => it.EmEcStatus.Contains(parm.EmEcStatus));
            predicate = predicate.AndIF(!string.IsNullOrEmpty(parm.EmEcTitle), it => it.EmEcTitle.Contains(parm.EmEcTitle));
            predicate = predicate.AndIF(!string.IsNullOrEmpty(parm.EmEcAssigned), it => it.EmEcAssigned.Contains(parm.EmEcAssigned));
