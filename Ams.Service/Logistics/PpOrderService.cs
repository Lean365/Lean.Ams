    ...
    public class PpOrderService : BaseService<PpOrder>, IPpOrderService
    {
        ...
        public PagedInfo<PpOrderDto> ExportList(PpOrderQueryDto parm)
        {
            ...
            var response = Queryable()
                ...
                {
                    MoPlantLabel = it.MoPlant.GetConfigValue<SysDictData>("app_plant_list"),
                    MoOrderTypeLabel = it.MoOrderType.GetConfigValue<SysDictData>("app_mo_type"),
                    IsStateLabel = it.IsState.GetConfigValue<SysDictData>("app_mo_state"),
                }, true)
                .ToPage(parm);
