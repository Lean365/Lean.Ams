...
namespace Ams.Service.Logistics
{
    ...
    public class SdSalesInvoiceService : BaseService<SdSalesInvoice>, ISdSalesInvoiceService
    {
        ...
        /// <returns></returns>
        public SdSalesInvoice GetInfo(long SsiSfid)
        {
            var response = Queryable()
        ...
        /// <param name="parm"></param>
        /// <returns></returns>
        public PagedInfo<SdSalesInvoiceDto> ExportList(SdSalesInvoiceQueryDto parm)
        {
            var predicate = QueryExp(parm);

            var response = Queryable()
                .Where(predicate.ToExpression())
                .Select((it) => new SdSalesInvoiceDto()
                {
                    ...
                    SsiSalesunitLabel = it.SsiSalesunit.GetConfigValue<SysDictData>("sys_unit_list"),
        ...
        private static Expressionable<SdSalesInvoice> QueryExp(SdSalesInvoiceQueryDto parm)
        {
            ...
            predicate = predicate.AndIF(!string.IsNullOrEmpty(parm.SsiSalesunit), it => it.SsiSalesunit == parm.SsiSalesunit);
