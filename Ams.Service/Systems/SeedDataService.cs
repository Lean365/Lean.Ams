...
namespace Ams.Service.Systems
{
    ...
    public class SeedDataService
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public (string, object, object) InitArticleCategoryData(List<ArticleCatalog> data)
        {
            var db = DbScoped.SugarScope;
            var x = db.Storageable(data)
                //.SplitInsert(it => it.NotAny())
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public (string, object, object) InitTaskData(List<Model.Routine.TasksQz> data)
        {
            var db = DbScoped.SugarScope;
            var x = db.Storageable(data)
                .SplitInsert(it => it.NotAny())
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public (string, object, object) InitNoticeData(List<NoticeStorage> data)
        {
            var db = DbScoped.SugarScope;
            var x = db.Storageable(data)
        ...
        public List<string> InitSeedData(string path, bool clean)
        {
            ...
            if (clean)
            {
                ...
                db.DbMaintenance.TruncateTable<NoticeStorage>();
            ...
            var sysArticleCategory = MiniExcel.Query<ArticleCatalog>(path, sheetName: "article_category").ToList();
