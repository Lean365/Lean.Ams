...
namespace Ams.Service.Systems
{
    ...
    public class SysMenuService : BaseService<SysMenu>, ISysMenuService
    {
        ...
        public List<SysMenu> GetMenusByMenuId(int menuId, long userId)
        {
            ...
            var list = GetList(menuExpression.ToExpression()).OrderBy(f => f.SortingNum).ToList();
        ...
        /// <returns></returns>
        public int ChangeSortMenu(SysMenuDto menuDto)
        {
            return Update(new SysMenu() { MenuId = menuDto.MenuId, SortingNum = menuDto.SortingNum }, it => new { it.SortingNum });
        }
        ...
        public List<SysMenu> SelectTreeMenuListByRoles(MenuQueryDto menu, List<long> roles)
        {
            ...
            return Queryable()
                ...
                .OrderBy((c) => new { c.ParentId, c.SortingNum })
                .Select(c => c)
        ...
        private List<SysMenu> SelectMenuList(MenuQueryDto menu)
        {
            ...
            .OrderBy(it => new { it.ParentId, it.SortingNum })
            .ToList();
        }
        ...
        private List<SysMenu> SelectMenuListByRoles(MenuQueryDto sysMenu, List<long> roles)
        {
            ...
            return Queryable()
                ...
                .OrderBy((c, j) => new { c.ParentId, c.SortingNum })
                .Select(c => c)
                .ToList();
        }
            ...
            var router = new List<RouterVo>
            {
                    ...
                    Children = new List<RouterVo>()
                {
                     ...
                     new()
                    {
                        ...
                        Meta = new Meta("任务管理", "hourglass-half-fill"){Permi = "routine:tasks:list"}
                    },
                     new()
                    {
                    ...
                    Children = new List<RouterVo>()
                {
                     ...
                     new()
                    {
                        ...
                        Meta = new Meta("操作日志", "file-text"){ Permi = "monitor:oper:list" }
                    }
                }
                },
            };
