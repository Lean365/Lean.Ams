...
namespace Ams.Statistics
{
    ...
    public class CostStatiControllers : BaseController
    {
        private readonly ICostStatiService _CostStatiService;

        /// <summary>
        /// 月度存货接口
        /// </summary>
        public CostStatiControllers(ICostStatiService CostStatiService)
        {
        ...
        public IActionResult QueryMonthlyProductionCost([FromQuery] FicoBudgetActualCostQueryDto parm)
        {
