...
namespace Ams.Statistics.Logistics.Controllers
{
    ...
    public class AssyDefectStatiControllers : BaseController
    {
        ...
        [ActionPermissionFilter(Permission = "pp:outputmaster:list")]
        public IActionResult QueryListMonthPoor([FromQuery] PpDefectAssyMaQueryDto parm)
        {
        ...
        public IActionResult QueryExportListMonthPoor([FromQuery] PpDefectAssyMaQueryDto parm)
        {
            parm.PageSize = 10000;
        ...
        [ActionPermissionFilter(Permission = "pp:outputmaster:list")]
        public IActionResult QueryListMonthlyPoorBar([FromQuery] PpDefectAssyMaQueryDto parm)
        {
