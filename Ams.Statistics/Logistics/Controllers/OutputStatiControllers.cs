...
namespace Ams.Statistics.Logistics.Controllers
{
    ...
    public class OutputStatiControllers : BaseController
    {
        ...
        [ActionPermissionFilter(Permission = "pp:outputmaster:list")]
        public IActionResult QueryMonthlyOutputQty([FromQuery] PpOutputAssyMasterQueryDto parm)
        {
        ...
        [ActionPermissionFilter(Permission = "pp:outputmaster:list")]
        public IActionResult QueryListMonthOutput([FromQuery] PpOutputAssyMasterQueryDto parm)
        {
        ...
        public IActionResult ExportMonthOutput([FromQuery] PpOutputAssyMasterQueryDto parm)
        {
            parm.PageSize = 10000;
        ...
        [ActionPermissionFilter(Permission = "pp:outputmaster:list")]
        public IActionResult QueryListMonthLineOutput([FromQuery] PpOutputAssyMasterQueryDto parm)
        {
        ...
        [ActionPermissionFilter(Permission = "pp:outputmaster:list")]
        public IActionResult QueryListMonthLineOutputBar([FromQuery] PpOutputAssyMasterQueryDto parm)
        {
        ...
        [ActionPermissionFilter(Permission = "pp:outputmaster:list")]
        public IActionResult QueryListCurrentMonthLineOutputBar([FromQuery] PpOutputAssyMasterQueryDto parm)
        {
            DateTime nowDate = DateTime.Now;
            //parm.BeginPomMfgDate = new DateTime(nowDate.Year, nowDate.Month, 1);   //本月第一天
            //parm.EndPomMfgDate= nowDate.AddDays(1 - nowDate.Day).AddMonths(1).AddDays(-1);  //本月最后一天
        ...
        [ActionPermissionFilter(Permission = "pp:outputmaster:export")]
        public IActionResult ExportMonthLineOutput([FromQuery] PpOutputAssyMasterQueryDto parm)
        {
            parm.PageSize = 10000;
        ...
        [ActionPermissionFilter(Permission = "pp:outputmaster:list")]
        public IActionResult QueryListMonthModelOutput([FromQuery] PpOutputAssyMasterQueryDto parm)
        {
        ...
        [ActionPermissionFilter(Permission = "pp:outputmaster:export")]
        public IActionResult ExportMonthModelOutput([FromQuery] PpOutputAssyMasterQueryDto parm)
        {
            parm.PageSize = 10000;
