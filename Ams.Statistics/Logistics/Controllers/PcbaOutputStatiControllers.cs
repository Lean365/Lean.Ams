...
namespace Ams.Statistics.Logistics.Controllers
{
    ...
    /// </summary>
    [Verify]
    [Route("stat/output/pcba")]
    [ApiExplorerSettings(GroupName = "statistics")]
    public class PcbaOutputStatiControllers : BaseController
    {
        ...
        /// OPH统计接口
        /// </summary>
        public PcbaOutputStatiControllers(IAssyOutputStatiService OutputStatiService)
        {
