...
namespace Ams.Statistics.Logistics.Controllers
{
    ...
    /// </summary>
    [Verify]
    [Route("stat/repair/pcba")]
    [ApiExplorerSettings(GroupName = "statistics")]
    public class PcbaRepairStatiControllers : BaseController
    {
        ...
        /// OPH统计接口
        /// </summary>
        public PcbaRepairStatiControllers(IAssyOutputStatiService OutputStatiService)
        {
