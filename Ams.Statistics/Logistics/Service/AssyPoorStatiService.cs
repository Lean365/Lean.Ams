...
namespace Ams.Statistics.Logistics.Service
{
    ...
    /// Service业务层处理
    /// </summary>
    [AppService(ServiceType = typeof(IAssyPoorStatiService), ServiceLifetime = LifeTime.Transient)]
    public class AssyPoorStatiService : BaseService<PpRepairAssyMa>, IAssyPoorStatiService
    {
        /// <summary>
        /// 本月组立不良台数
        /// </summary>
        /// <returns></returns>
        public int GetMonthlyPoorQty(PpRepairAssyMaQueryDto parm)
        {
            int MonthlyQty;
            var db = Context;
            ...
            var queryableRight = db.Queryable<PpRepairAssySlv>();
        ...
        /// <returns></returns>
        public List<Dictionary<string, object>> GetListMonthPoor(PpRepairAssyMaQueryDto parm)
        {
            var db = Context;
            var predicate = QueryExp(parm);
            var queryableLeft = Queryable()
        ...
        /// <param name="parm"></param>
        /// <returns></returns>
        public dynamic ExportListMonthPoor(PpRepairAssyMaQueryDto parm)
        {
            var db = Context;
            var predicate = QueryExp(parm);
            var queryableLeft = Queryable()
        ...
        /// <param name="parm"></param>
        /// <returns></returns>
        public List<Dictionary<string, object>> GetListMonthlyPoorBar(PpRepairAssyMaQueryDto parm)
        {
