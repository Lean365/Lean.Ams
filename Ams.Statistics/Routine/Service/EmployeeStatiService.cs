...
//            predicate = predicate.AndIF(!string.IsNullOrEmpty(parm.EeEmployeeId), it => it.EeEmployeeId.Substring(0, 2).Contains(parm.EeEmployeeId));
//            return predicate;
//        }
//    }
//}