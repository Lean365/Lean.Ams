...
namespace Ams.Tasks
{
    ...
    public class TaskBase
    {
        ...
        {
            var TasksQzLogService = (ITasksQzLogService)App.GetRequiredService(typeof(ITasksQzLogService));
            ...
            logModel = await TasksQzLogService.AddTaskLog(job.Key.Name, logModel);
            //成功后执行次数+1
