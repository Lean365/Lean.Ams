<template>
  <div :class="$style.particles">
    <div ref="wrapperRef" :style="wrapperStyles" :class="$style.wrapper">
      <div :style="contentStyles" :class="$style.content">
        <slot />
      </div>
    </div>
    <canvas ref="canvasRef" :style="canvasStyles" :class="$style.canvas" />
  </div>
</template>
<script setup>
