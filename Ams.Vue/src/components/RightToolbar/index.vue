<template>
  <div class="top-right-btn">
    <el-tooltip class="item" effect="dark" :content="$t('prightbar.showGridColumns')" placement="top" v-if="data">
    ...
    <el-tooltip class="item" effect="dark"
      :content="showSearch ? $t('prightbar.hideSearch') : $t('prightbar.showSearch')" placement="top">
      <el-button circle icon="Search" @click="toggleSearch()" />
    </el-tooltip>
    <el-tooltip class="item" effect="dark" :content="$t('prightbar.pageRefresh')" placement="top">
