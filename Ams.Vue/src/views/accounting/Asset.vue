...
<template>
  <div>
    ...
    <el-row :gutter="15" class="mb10">
      ...
      <el-col :span="1.5">
        <el-button type="success" :disabled="single" v-hasPermi="['fico:asset:edit']" plain icon="edit" @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" :disabled="multiple" v-hasPermi="['fico:asset:delete']" plain icon="delete" @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData
                  templateUrl="accounting/Asset/importTemplate"
                  importUrl="/accounting/Asset/importData"
    ...
    <el-table
      ...
      <el-table-column prop="faAssetUesd" label="使用年限" align="center" v-if="columns.showColumn('faAssetUesd')"/>
      ...
      <el-table-column :label="$t('btn.operation')" width="150" align="center">
        <template #default="scope">
          <el-button type="success" size="small" icon="edit" :title="$t('btn.edit')" v-hasPermi="['fico:asset:edit']" @click="handleUpdate(scope.row)"></el-button>
          <el-button type="danger" size="small" plain icon="delete" :title="$t('btn.delete')" v-hasPermi="['fico:asset:delete']" @click="handleDelete(scope.row)"></el-button>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
          ...
          <el-col :lg="12">
            <el-form-item label="SFID" prop="faSFID">
              <el-input v-model.number="form.faSFID" :placeholder="$t('btn.enter')+'SFID'" :disabled="opertype != 1"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="公司" prop="faCorp">
              <el-input v-model="form.faCorp" :placeholder="$t('btn.enter')+'公司'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="使用部门" prop="faDept">
              <el-input v-model="form.faDept" :placeholder="$t('btn.enter')+'使用部门'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="资产类别" prop="faClassCode">
              <el-input v-model="form.faClassCode" :placeholder="$t('btn.enter')+'资产类别'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="资产编码" prop="faAssetNo">
              <el-input v-model="form.faAssetNo" :placeholder="$t('btn.enter')+'资产编码'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="成本中心" prop="faCostCenter">
              <el-input v-model="form.faCostCenter" :placeholder="$t('btn.enter')+'成本中心'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="资产简称" prop="faAssetShortName">
              <el-input v-model="form.faAssetShortName" :placeholder="$t('btn.enter')+'资产简称'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="资产全称" prop="faAssetFullName">
              <el-input v-model="form.faAssetFullName" :placeholder="$t('btn.enter')+'资产全称'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="单位" prop="faAssetUnit">
              <el-input v-model="form.faAssetUnit" :placeholder="$t('btn.enter')+'单位'"  />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="数量" prop="faAssetQty">
              <el-input v-model.number="form.faAssetQty" :placeholder="$t('btn.enter')+'数量'"  />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="管理区分" prop="faAssetMana">
              <el-input v-model.number="form.faAssetMana" :placeholder="$t('btn.enter')+'管理区分'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="币种" prop="faAssetCcy">
              <el-input v-model="form.faAssetCcy" :placeholder="$t('btn.enter')+'币种'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="购买价格" prop="faAcquisitionPrice">
              <el-input v-model="form.faAcquisitionPrice" :placeholder="$t('btn.enter')+'购买价格'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="资本化日期" prop="faCapitalizedDate">
              <el-date-picker v-model="form.faCapitalizedDate" type="datetime" :teleported="false" :placeholder="$t('btn.select')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="折旧价值" prop="faDepreciationValue">
              <el-input v-model="form.faDepreciationValue" :placeholder="$t('btn.enter')+'折旧价值'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="报废日期" prop="faScrapDate">
              <el-date-picker v-model="form.faScrapDate" type="datetime" :teleported="false" :placeholder="$t('btn.select')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="报废价值" prop="faScrapValue">
              <el-input v-model="form.faScrapValue" :placeholder="$t('btn.enter')+'报废价值'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="存放位置" prop="faLocale">
              <el-input v-model="form.faLocale" :placeholder="$t('btn.enter')+'存放位置'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="使用年限" prop="faAssetUesd">
              <el-input v-model="form.faAssetUesd" :placeholder="$t('btn.enter')+'使用年限'"  />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="是否停用" prop="faAssetStop">
              <el-input v-model.number="form.faAssetStop" :placeholder="$t('btn.enter')+'是否停用'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="供应商" prop="faAssetVender">
              <el-input v-model="form.faAssetVender" :placeholder="$t('btn.enter')+'供应商'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="制造商" prop="faAssetManufacturer">
              <el-input v-model="form.faAssetManufacturer" :placeholder="$t('btn.enter')+'制造商'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="供应商物料" prop="faAssetVenderItem">
              <el-input v-model="form.faAssetVenderItem" :placeholder="$t('btn.enter')+'供应商物料'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="制造商物料" prop="faAssetManufacturerItem">
              <el-input v-model="form.faAssetManufacturerItem" :placeholder="$t('btn.enter')+'制造商物料'"  />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="资产形态" prop="faEntity">
              <el-input v-model.number="form.faEntity" :placeholder="$t('btn.enter')+'资产形态'"  />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="资产存在否" prop="faHaveorNot">
              <el-input v-model.number="form.faHaveorNot" :placeholder="$t('btn.enter')+'资产存在否'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="盘点人员" prop="faCheckedby">
              <el-input v-model="form.faCheckedby" :placeholder="$t('btn.enter')+'盘点人员'"  />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="盘点日期" prop="faCheckedDate">
              <el-date-picker v-model="form.faCheckedDate" type="datetime" :teleported="false" :placeholder="$t('btn.select')"></el-date-picker>
            </el-form-item>
          </el-col>
...
const columns = ref([
  ...
  { visible: false, prop: 'faAssetUesd', label: '使用年限' },
...
const state = reactive({
  ...
  rules: {
    ...
    faCorp: [{ required: true, message: '公司'+ proxy.$t('btn.empty'), trigger: "blur"     }],
    faDept: [{ required: true, message: '使用部门'+ proxy.$t('btn.empty'), trigger: "blur"     }],
    faClassCode: [{ required: true, message: '资产类别'+ proxy.$t('btn.empty'), trigger: "blur"     }],
    faAssetNo: [{ required: true, message: '资产编码'+ proxy.$t('btn.empty'), trigger: "blur"     }],
    faCostCenter: [{ required: true, message: '成本中心'+ proxy.$t('btn.empty'), trigger: "blur"     }],
    ...
    faAssetUnit: [{ required: true, message: '单位'+ proxy.$t('btn.empty'), trigger: "blur"     }],
    faAssetQty: [{ required: true, message: '数量'+ proxy.$t('btn.empty'), trigger: "blur"    , type: "number"  }],
    faAssetMana: [{ required: true, message: '管理区分'+ proxy.$t('btn.empty'), trigger: "blur"    , type: "number"  }],
    faAssetCcy: [{ required: true, message: '币种'+ proxy.$t('btn.empty'), trigger: "blur"     }],
    ...
    faAssetUesd: [{ required: true, message: '使用年限'+ proxy.$t('btn.empty'), trigger: "blur"     }],
    faAssetStop: [{ required: true, message: '是否停用'+ proxy.$t('btn.empty'), trigger: "blur"    , type: "number"  }],
    faEntity: [{ required: true, message: '资产形态'+ proxy.$t('btn.empty'), trigger: "blur"    , type: "number"  }],
    faHaveorNot: [{ required: true, message: '资产存在否'+ proxy.$t('btn.empty'), trigger: "blur"    , type: "number"  }],
