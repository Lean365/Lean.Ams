<template>
  <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
    ...
    <el-form-item label="状态" prop="isState">
      <el-select v-model="queryParams.isState" placeholder="数据状态" clearable>
        <el-option v-for="dict in statusOptions" :key="parseInt(dict.dictValue)" :label="parseInt(dict.dictLabel)"
  ...
  <el-table :data="dataList">
    ...
    <el-table-column label="状态" align="center" prop="isState">
      <template #default="scope">
      ...
      <el-row :gutter="20">
        ...
        <el-col :lg="24">
          <el-form-item label="数据标签" prop="dictLabel">
            <el-input v-model="form.dictLabel" placeholder="请输入数据标签" @input="assginLangKey($event)" />
          </el-form-item>
        </el-col>

        <el-col :lg="24">
          <el-form-item label="数据键值" prop="dictValue">
            <el-input v-model="form.dictValue" placeholder="请输入数据键值" @input="assginRemark($event)" />
          </el-form-item>
        </el-col>
        <el-col :lg="24">
        ...
        <el-col :lg="24">
          <el-form-item label="状态" prop="isState">
            <el-radio-group v-model="form.isState">
              <el-radio v-for="dict in statusOptions" :key="parseInt(dict.dictValue)"
...
<script setup name="dictData">
  ...
  function assginRemark(val) {
    form.value.remark = '(' + form.value.dictType + '):' + form.value.dictValue
  }
  function assginLangKey(val) {
    form.value.langKey = 'dict.' + form.value.dictType + '.' + pinyin.getCamelChars(form.value.dictLabel).toLowerCase()
