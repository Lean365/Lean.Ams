<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="类型" prop="noticeType">
        <el-radio-group v-model="queryParams.noticeType">
          ...
          <el-radio-button v-for="dict in typeOptions" :key="dict.dictValue" :label="parseInt(dict.dictValue)">{{
    ...
    <el-table v-loading="loading" :data="noticeList" height="650" border @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="序号" align="center" prop="noticeId" width="75" />
      ...
      <el-table-column label="状态" align="center" prop="isState" width="100">
        <template #default="scope">
          <dict-tag :options="statusOptions" :value="scope.row.isState" />
        </template>
      </el-table-column>
      <el-table-column prop="noticeFileurl" align="center" label="预览图" width="80">
        <template #default="{ row }">
          <el-image preview-teleported :src="row.noticeFileurl" :preview-src-list="[row.noticeFileurl]"
    ...
    <zr-dialog :title="title" draggable v-model="open" width="580px">
      <el-form ref="noticeRef" :model="form" :rules="rules" label-width="80px">
          ...
          <el-col :lg="12">
            <el-form-item label="公告类型" prop="noticeType">
              ...
              <el-radio-group v-model="form.noticeType">
                <el-radio v-for="dict in typeOptions" :key="dict.dictValue" :label="parseInt(dict.dictValue)">{{
        ...
        <el-col :lg="24">
          <el-form-item label="关联文件" prop="noticeFileurl">
            <UploadFile v-model="form.noticeFileurl" :data="{ uploadType: 1 }" />
          </el-form-item>
        </el-col>
      </el-form>
      <template #footer>
...
<script setup name="notice">
  ...
  import { listNotice, getNotice, delNotice, addNotice, updateNotice, sendNotice } from '@/api/routine/notices'
