...
<template>
  <div>
    ...
    <el-table :data="dataList" border hight="200">
      ...
      <el-table-column prop="downTime" label="停线"></el-table-column>
      <el-table-column prop="realWorkhours" label="实际"></el-table-column>
      <el-table-column prop="inputsWorkhours" label="投入"></el-table-column>
      <el-table-column prop="timeRate" label="时间稼动率">
