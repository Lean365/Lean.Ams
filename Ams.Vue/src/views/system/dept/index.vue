  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
      ...
      <el-form-item label="状态" prop="isState">
        <el-select v-model="queryParams.isState" placeholder="部门状态" clearable>
    ...
    <el-table v-if="refreshTable" v-loading="loading" :data="deptList" row-key="deptId"
      ...
      <el-table-column label="状态" align="center" prop="isState" width="120">
      ...
      <el-table-column label="操作" align="center" width="200">
        <template #default="scope">
          <el-button size="small" type="success" icon="edit" :title="$t('btn.edit')" @click="handleUpdate(scope.row)"
            v-hasPermi="['system:dept:update']">

          </el-button>
          <el-button size="small" icon="plus" type="primary" :title="$t('btn.add')" @click="handleAdd(scope.row)"
            v-hasPermi="['system:dept:add']">

          </el-button>
          <el-button size="small" type="danger" v-if="scope.row.parentId != 0" icon="delete" :title="$t('btn.delete')"
