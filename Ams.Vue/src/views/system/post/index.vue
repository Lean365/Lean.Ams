  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="状态" prop="isState">
        <el-select v-model="queryParams.isState" placeholder="岗位状态" clearable>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="岗位状态" prop="isState">
          <el-radio-group v-model="form.isState">
            <el-radio v-for="dict in statusOptions" :key="parseInt(dict.dictValue)" :label="parseInt(dict.dictValue)">{{
              dict.dictLabel
              }}</el-radio>
          </el-radio-group>
        </el-form-item>
