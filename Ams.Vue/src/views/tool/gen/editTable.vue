<template>
  <div>
    <el-tabs v-model="activeName" tab-position="top">
      ...
      <el-tab-pane :label="$t('gencode.cloum')" name="cloum">
        <el-table ref="dragTableRef" v-loading="loading" :data="columns" row-key="columnId" min-height="80px"
          ...
          <el-table-column :label="$t('gencode.columnName')" prop="columnName" :show-overflow-tooltip="true" width="100"
            fixed />
          ...
          <el-table-column :label="$t('gencode.columnType')" prop="columnType" :show-overflow-tooltip="true"
            width="120" />
          <el-table-column :label="$t('gencode.csharpType')" width="120">
            <template #default="scope">
          ...
          <el-table-column :label="$t('gencode.csharpField')" width="120">
            <template #default="scope">
              <el-input v-model="scope.row.csharpField"></el-input>
            </template>
          </el-table-column>
          <el-table-column :label="$t('gencode.isRequired')" width="80" align="center">
            <template #header>
              <span>
                <el-tooltip :content="$t('gencode.isRequiredMemo')" placement="top">
                  <el-icon :size="15">
                    <questionFilled />
                  </el-icon>
                </el-tooltip>
                {{$t('gencode.isRequired')}}
              </span>
            </template>
            <template #default="scope">
          ...
          <el-table-column :label="$t('gencode.back')" align="center" label-class-name="text-hotpink">
            ...
            <el-table-column :label="$t('gencode.autoFillType')" width="100" align="center">
              <template #header>
                <span>
            ...
            <el-table-column :label="$t('gencode.isExport')" width="80" align="center">
              <template #header>
                <span>
                  <el-tooltip :content="$t('gencode.isExportMemo')" placement="top">
                    <el-icon :size="15">
                      <questionFilled />
                    </el-icon>
                  </el-tooltip>
          ...
          <el-table-column :label="$t('gencode.query')" align="center" label-class-name="text-green">
            <el-table-column :label="$t('gencode.isQuery')" width="80" align="center">
              <template #header>
                <span>
                  <el-tooltip :content="$t('gencode.isQueryMemo')" placement="top">
                    <el-icon :size="15">
                      <questionFilled />
                    </el-icon>
                  </el-tooltip>
          ...
          <el-table-column :label="$t('gencode.htmlType')" width="120">
            <template #default="scope">
          ...
          <el-table-column :label="$t('gencode.reMarks')" align="center" width="100">
            <template #default="scope">
              <el-input v-model="scope.row.remark"> </el-input>
            </template>
          </el-table-column>
        </el-table>
        <div style="font-size: 12px; color: #8492a6">{{$t('gencode.sortMemo')}}</div>
      </el-tab-pane>
    </el-tabs>
    <footer class="mt20" style="text-align: center">
      ...
      <el-button icon="back" @click="close()">{{$t('gencode.genReturn')}}</el-button>
    </footer>
  </div>
</template>
