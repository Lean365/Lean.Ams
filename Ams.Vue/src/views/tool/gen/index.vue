    ...
    <el-row :gutter="10" class="mb10">
      ...
      <el-col :span="1.5">
        <el-button type="danger" :disabled="multiple" plain icon="delete" @click="handleDelete"
          v-hasPermi="['tool:gen:delete']"> {{$t('btn.delete')}}</el-button>
      </el-col>
    </el-row>
      ...
      <el-table-column :label="$t('btn.operation')" align="center" width="200">
        <template #default="scope">
          <el-button-group class="ml-4">
            <el-button color="#79bbff" size="small" plain icon="view" @click="handlePreview(scope.row)"
              v-hasPermi="['tool:gen:preview']" :title="$t('btn.view')">
            </el-button>
            <el-button type="success" icon="edit" size="small" @click="handleEditTable(scope.row)"
            ...
            <el-dropdown @command="handleCommand($event, scope.row)">
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  ...
                  <div v-hasPermi="['tool:gen:delete']">
