...
export function listOutputSlave(query) {
  return request({
    url: 'logistics/OutputSlave/list',
    method: 'get',
    params: query,
  })
}
...
export function delOutputSlave(pid) {
  return request({
    url: 'logistics/OutputSlave/delete/' + pid,
    method: 'delete'
  })
}
// 导出oph从表
export async function exportOutputSlave(query) {
  await downFile('logistics/OutputSlave/export', { ...query })
}
