...
export function listSdSalesInvoice(query) {
  return request({
    url: 'Logistics/SdSalesInvoice/list',
    method: 'get',
    params: query,
  })
}
...
export function getSdSalesInvoice(id) {
  return request({
    url: 'Logistics/SdSalesInvoice/' + id,
    method: 'get'
  })
}
...
export function delSdSalesInvoice(pid) {
  return request({
    url: 'Logistics/SdSalesInvoice/delete/' + pid,
    method: 'delete'
  })
}
// 导出销售凭证
export async function exportSdSalesInvoice(query) {
  await downFile('Logistics/SdSalesInvoice/export', { ...query })
}
