...
export function listArticleCategory(query) {
  return request({
    url: 'routine/article/category/list',
    method: 'get',
    params: query
  })
}
...
export function treelistArticleCategory(query) {
  return request({
    url: 'routine/article/category/treelist',
    method: 'get',
    params: query
  })
}
...
export function getArticleCategory(id) {
  return request({
    url: 'routine/article/category/' + id,
    method: 'get'
  })
}
...
export function delArticleCategory(pid) {
  return request({
    url: 'routine/article/category/' + pid,
    method: 'delete'
  })
}
...
export function exportArticleCategory(query) {
  return request({
    url: 'routine/article/category/export',
    method: 'get',
    params: query
  })
}
...
export function changeSort(data) {
  return request({
    url: 'routine/article/category/ChangeSort',
    method: 'get',
    params: data
  })
}
