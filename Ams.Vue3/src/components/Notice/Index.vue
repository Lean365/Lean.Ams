          ...
          <div class="content-box">
            <el-scrollbar>
              <div class="content-box-item" v-for="item in noticeList">
                <div class="left">
                  <svg-icon name="m-bell" color="#fff" size="16"></svg-icon>
                </div>
...
<script setup name="noticeIndex">
  import { listMyUserMsg, readUserMsg } from '@/api/system/usermsg'
  ...
  const sysList = ref([])
  function init() {
    listMyUserMsg({ isRead: 0, msgType: 1 }).then((res) => {
