<template>
  <div class="top-right-btn">
    <slot></slot>
    <el-tooltip class="item" effect="dark" :content="$t('common.showhiddenColumns')" placement="top" v-if="data">
    ...
    <el-tooltip class="item" effect="dark" :content="showSearch ? $t('common.hiddenSearch') : $t('common.showSearch')"
      placement="top">
...
<script setup>
  ...
  const value = ref([])
  // 弹出层标题
  const title = ref(proxy.$t('common.showhiddenColumns'))
  // 是否显示弹出层
