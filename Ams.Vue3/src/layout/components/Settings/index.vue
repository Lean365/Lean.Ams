<template>
  <el-drawer v-model="showSettings" title="系统设置" :with-header="false" direction="rtl" size="330px">
    ...
    <el-divider>{{ $t('layout.themeNavMode') }}</el-divider>
    <div class="nav-wrap">
      <el-tooltip :content="$t('layout.themeMenuLeft')" placement="bottom">
      ...
      <el-tooltip :content="$t('layout.themeMenuMix')" placement="bottom">
        <div class="item mix" @click="handleNavType(2)" :class="{ activeItem: navType == 2 }">
          <b></b>
          <b></b>
        </div>
      </el-tooltip>
      <el-tooltip :content="$t('layout.themeTopNav')" placement="bottom">
    ...
    <div class="drawer-item" style="text-align: center">
      ...
      <el-switch v-model="mode" inactive-icon="Sunny" active-icon="Moon" active-value="dark"
        inactive-value="light"></el-switch>
    </div>
    <div class="drawer-item">
      <!-- <div>侧边栏颜色</div> -->
      <el-divider> {{ $t('layout.themeSideColor') }} </el-divider>

      <div class="mt10">
        <span class="color-item" :class="{ sideActive: item.name == sideTheme }"
          :style="{ 'background-color': item.color }" v-for="item in sideColors" @click="handleSideTheme(item.name)">
    ...
    <div class="drawer-item">
      <span>{{ $t('layout.open') }} {{ $t('layout.themeTagsView') }}</span>
    ...
    <div class="drawer-item">
      <span>{{ $t('layout.themeShowWatermark') }}</span>
      <span class="comp-style">
    ...
    <div class="drawer-item">
      <span>{{ $t('layout.themeDynamicTitle') }}</span>
      <span class="comp-style">
    ...
    <div class="drawer-item">
      <span>{{ $t('layout.themeTagsPersist') }}</span>
      <span class="comp-style">
        <el-switch v-model="tabsPersist" class="drawer-switch" />
      </span>
    </div>
    <div class="drawer-item">
      <span>{{ $t('layout.themeTagsShowIcon') }}</span>
      <span class="comp-style">
    ...
    <!-- <el-button type="primary" plain icon="DocumentAdd" @click="saveSetting">{{ $t('layout.themeSaveConfig') }}</el-button> -->
    <el-button plain icon="Refresh" @click="resetSetting">{{ $t('layout.themeResetConfig') }}</el-button>
  </el-drawer>
</template>
