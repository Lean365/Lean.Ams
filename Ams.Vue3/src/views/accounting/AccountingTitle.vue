...
<template>
  <div>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="gvtyp" label="损益类型" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('gvtyp')"/>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="负债科目" prop="xbilk">
              <el-select filterable clearable   v-model="form.xbilk"  :placeholder="$t('btn.selectPrefix')+'负债科目'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="损益类型" prop="gvtyp">
              <el-input v-model="form.gvtyp" :placeholder="$t('btn.enterPrefix')+'损益类型'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
...
sys_crop_list: [],
    // 负债科目 选项列表 格式 eg:{ dictLabel: '标签', dictValue: '0'}
sys_flag_list: [],
