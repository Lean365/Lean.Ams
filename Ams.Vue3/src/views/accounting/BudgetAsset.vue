  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="启用" prop="fbaFlag">
        <el-radio-group v-model="queryParams.fbaFlag">
      ...
      <el-form-item label="审核标志" prop="fbaAudit">
        <el-radio-group v-model="queryParams.fbaAudit">
          <el-radio>{{$t('common.all')}}</el-radio>
          <el-radio v-for="item in  options.sys_audit_flag " :key="item.dictValue" :value="item.dictValue">{{item.dictLabel}}</el-radio>
        </el-radio-group>
      </el-form-item>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="fbaFy" label="财年" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('fbaFy')"/>
      ...
      <el-table-column prop="fbaClass" label="类别" align="center" v-if="columns.showColumn('fbaClass')">
        <template #default="scope">
          <dict-tag :options=" options.sys_exp_type " :value="scope.row.fbaClass"  />
        </template>
      </el-table-column>
      ...
      <el-table-column prop="fbaFlag" label="启用" align="center" v-if="columns.showColumn('fbaFlag')">
        <template #default="scope">
          <dict-tag :options=" options.sys_flag_list " :value="scope.row.fbaFlag"  />
        </template>
      </el-table-column>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="财年" prop="fbaFy">
              <el-input v-model="form.fbaFy" :placeholder="$t('btn.enterPrefix')+'财年'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="启用" prop="fbaFlag">
              <el-radio-group v-model="form.fbaFlag">
          ...
          <el-col :lg="12">
            <el-form-item label="审核标志" prop="fbaAudit">
              <el-radio-group v-model="form.fbaAudit">
                <el-radio v-for="item in options.sys_audit_flag" :key="item.dictValue" :value="parseInt(item.dictValue)">
                  {{item.dictLabel}}
                </el-radio>
              </el-radio-group>
            </el-form-item>
          ...
          <el-col :lg="12">
            <el-form-item label="审核人员" prop="fbaAuditName">
              <el-input v-model="form.fbaAuditName" :placeholder="$t('btn.enterPrefix')+'审核人员'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="撤消人员" prop="fbaUndoName">
              <el-input v-model="form.fbaUndoName" :placeholder="$t('btn.enterPrefix')+'撤消人员'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
...
const state = reactive({
  ...
  rules: {
    ...
    fbaFy: [{ required: true, message: "财年"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    ...
    fbaFlag: [{ required: true, message: "启用"+proxy.$t('btn.isEmpty'), trigger: "blur"    , type: "number"  }],
    fbaAudit: [{ required: true, message: "审核标志"+proxy.$t('btn.isEmpty'), trigger: "blur"    , type: "number"  }],
