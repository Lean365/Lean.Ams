...
<template>
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="年月" prop="fbeFm">
        <el-select filterable clearable   v-model="queryParams.fbeFm" :placeholder="$t('btn.selectSearchPrefix')+'年月'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="科目" prop="fbeTitle">
        <el-select filterable clearable   v-model="queryParams.fbeTitle" :placeholder="$t('btn.selectSearchPrefix')+'科目'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="名称" prop="fbeClass">
        <el-input v-model="queryParams.fbeClass" :placeholder="$t('btn.enterSearchPrefix')+'名称'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="启用标记" prop="fbsFlag">
        <el-select filterable clearable   v-model="queryParams.fbsFlag" :placeholder="$t('btn.selectSearchPrefix')+'启用标记'+$t('btn.selectSearchSuffix')">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData
                  templateUrl="Accounting/BudgetExpense/importTemplate"
                  importUrl="/Accounting/BudgetExpense/importData"
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="fbeSfid" label="SFID" align="center" v-if="columns.showColumn('fbeSfid')"/>
      ...
      <el-table-column prop="fbeDept" label="部门" align="center" v-if="columns.showColumn('fbeDept')">
        <template #default="scope">
          <dict-tag :options=" options.sql_dept_list " :value="scope.row.fbeDept"  />
        </template>
      </el-table-column>
      <el-table-column prop="fbeFy" label="财年" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('fbeFy')"/>
      <el-table-column prop="fbeFm" label="年月" align="center" v-if="columns.showColumn('fbeFm')">
        <template #default="scope">
          <dict-tag :options=" options.sql_ym_list " :value="scope.row.fbeFm"  />
        </template>
      </el-table-column>
      <el-table-column prop="fbeTitle" label="科目" align="center" v-if="columns.showColumn('fbeTitle')">
        <template #default="scope">
          <dict-tag :options=" options.sql_recon_account " :value="scope.row.fbeTitle"  />
        </template>
      </el-table-column>
      <el-table-column prop="fbeClass" label="名称" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('fbeClass')"/>
      <el-table-column prop="fbeTitlesub" label="明细科目" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('fbeTitlesub')"/>
      <el-table-column prop="fbeClasssub" label="明细名称" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('fbeClasssub')"/>
      <el-table-column prop="fbeClassmemo" label="说明" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('fbeClassmemo')"/>
      <el-table-column prop="fbeBudgetAmount" label="预算金额" align="center" v-if="columns.showColumn('fbeBudgetAmount')"/>
      <el-table-column prop="fbeActualAmount" label="实际发生" align="center" v-if="columns.showColumn('fbeActualAmount')"/>
      <el-table-column prop="fbeDifferenceAmount" label="差异" align="center" v-if="columns.showColumn('fbeDifferenceAmount')"/>
      <el-table-column prop="fbsFlag" label="启用标记" align="center" v-if="columns.showColumn('fbsFlag')">
        <template #default="scope">
          <dict-tag :options=" options.sys_flag_list " :value="scope.row.fbsFlag"  />
        </template>
      </el-table-column>
      ...
      <el-table-column prop="fbsAuditName" label="审核人员" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('fbsAuditName')"/>
      <el-table-column prop="fbsAuditDate" label="审核日期" :show-overflow-tooltip="true"  v-if="columns.showColumn('fbsAuditDate')"/>
      <el-table-column prop="fbsUndoName" label="撤消人员" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('fbsUndoName')"/>
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="SFID" prop="fbeSfid">
              <el-input v-model.number="form.fbeSfid" :placeholder="$t('btn.enterPrefix')+'SFID'+$t('btn.enterSuffix')" :disabled="opertype != 1"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="财年" prop="fbeFy">
              <el-input v-model="form.fbeFy" :placeholder="$t('btn.enterPrefix')+'财年'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="年月" prop="fbeFm">
              <el-select filterable clearable   v-model="form.fbeFm"  :placeholder="$t('btn.selectPrefix')+'年月'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="科目" prop="fbeTitle">
              <el-select filterable clearable   v-model="form.fbeTitle"  :placeholder="$t('btn.selectPrefix')+'科目'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="名称" prop="fbeClass">
              <el-input v-model="form.fbeClass" :placeholder="$t('btn.enterPrefix')+'名称'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="明细科目" prop="fbeTitlesub">
              <el-input v-model="form.fbeTitlesub" :placeholder="$t('btn.enterPrefix')+'明细科目'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="明细名称" prop="fbeClasssub">
              <el-input v-model="form.fbeClasssub" :placeholder="$t('btn.enterPrefix')+'明细名称'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="说明" prop="fbeClassmemo">
              <el-input v-model="form.fbeClassmemo" :placeholder="$t('btn.enterPrefix')+'说明'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="预算金额" prop="fbeBudgetAmount">
              <el-input-number v-model.number="form.fbeBudgetAmount" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'预算金额'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="实际发生" prop="fbeActualAmount">
              <el-input-number v-model.number="form.fbeActualAmount" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'实际发生'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="差异" prop="fbeDifferenceAmount">
              <el-input-number v-model.number="form.fbeDifferenceAmount" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'差异'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="启用标记" prop="fbsFlag">
              <el-select filterable clearable   v-model="form.fbsFlag"  :placeholder="$t('btn.selectPrefix')+'启用标记'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="审核人员" prop="fbsAuditName">
              <el-input v-model="form.fbsAuditName" :placeholder="$t('btn.enterPrefix')+'审核人员'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="撤消人员" prop="fbsUndoName">
              <el-input v-model="form.fbsUndoName" :placeholder="$t('btn.enterPrefix')+'撤消人员'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
...
<script setup name="budgetexpense">
  import '@/assets/styles/btn-custom.scss'
//后台操作函数
import { listBudgetExpense,
 addBudgetExpense, delBudgetExpense, 
 updateBudgetExpense,getBudgetExpense, 
 } 
from '@/api/accounting/budgetexpense.js'
...
//字段显示控制
const columns = ref([
  { visible: true, prop: 'fbeSfid', label: 'SFID' },
  { visible: true, prop: 'fbeCorp', label: '公司' },
  { visible: true, prop: 'fbeDept', label: '部门' },
  { visible: true, prop: 'fbeFy', label: '财年' },
  { visible: true, prop: 'fbeFm', label: '年月' },
  { visible: true, prop: 'fbeTitle', label: '科目' },
  { visible: true, prop: 'fbeClass', label: '名称' },
  { visible: true, prop: 'fbeTitlesub', label: '明细科目' },
  { visible: false, prop: 'fbeClasssub', label: '明细名称' },
  { visible: false, prop: 'fbeClassmemo', label: '说明' },
  { visible: false, prop: 'fbeBudgetAmount', label: '预算金额' },
  { visible: false, prop: 'fbeActualAmount', label: '实际发生' },
  { visible: false, prop: 'fbeDifferenceAmount', label: '差异' },
  { visible: false, prop: 'fbsFlag', label: '启用标记' },
...
function getList(){
  ...
  loading.value = true
  listBudgetExpense(queryParams).then(res => {
    const { code, data } = res
    if (code == 200) {
...
const state = reactive({
  ...
  form: {},
  rules: {
    fbeSfid: [{ required: true, message: "SFID"+proxy.$t('btn.isEmpty'), trigger: "blur" }],
    fbeCorp: [{ required: true, message: "公司"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    fbeDept: [{ required: true, message: "部门"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    fbeFy: [{ required: true, message: "财年"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbeFm: [{ required: true, message: "年月"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    fbeTitle: [{ required: true, message: "科目"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    fbeClass: [{ required: true, message: "名称"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbeTitlesub: [{ required: true, message: "明细科目"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbeClasssub: [{ required: true, message: "明细名称"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbeClassmemo: [{ required: true, message: "说明"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbeBudgetAmount: [{ required: true, message: "预算金额"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbeActualAmount: [{ required: true, message: "实际发生"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbeDifferenceAmount: [{ required: true, message: "差异"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbsFlag: [{ required: true, message: "启用标记"+proxy.$t('btn.isEmpty'), trigger: "change"    , type: "number"  }],
...
function handleAdd() {
  ...
  form.value.fbeFm= []
  form.value.fbeTitle= []
  form.value.fbeBudgetAmount= 0
  form.value.fbeActualAmount= 0
  form.value.fbeDifferenceAmount= 0
  ...
  proxy.$refs["formRef"].validate((valid) => {
    if (valid) {
      ...
      if (form.value.fbeSfid != undefined && opertype.value === 2) {
        updateBudgetExpense(form.value).then((res) => {
         proxy.$modal.msgSuccess(proxy.$t('common.tipEditSucceed'))
          open.value = false
          getList()
        })
      } else {
        addBudgetExpense(form.value).then((res) => {
...
function handleExport() {
  proxy
    ...
    .then(async () => {
      await proxy.downFile('/Accounting/BudgetExpense/export', { ...queryParams })
    })
}
