          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData
                  templateUrl="Accounting/ExchangeRate/importTemplate"
                  importUrl="/Accounting/ExchangeRate/importData"
...
const state = reactive({
  ...
  rules: {
    ...
    ferfmCcy: [{ required: true, message: "从币种"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    ferRate: [{ required: true, message: "汇率"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fertoCcy: [{ required: true, message: "到币种"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
