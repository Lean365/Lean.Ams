...
<template>
  <div>
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :lg="24">
          ...
          <el-form-item label="短文本" prop="mb011">
            <el-input v-model="queryParams.mb011"
    ...
    <el-table border height="600px" :data="dataList" v-loading="loading" ref="table"
      ...
      <el-table-column prop="mb005" label="语言Key" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb005')" />
      <el-table-column prop="mb006" label="科目编号" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb006')" />
      <el-table-column prop="mb007" label="科目表" align="center" :show-overflow-tooltip="true"
      ...
      <el-table-column prop="mb011" label="短文本" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb011')" />
      <el-table-column prop="mb012" label="长文本" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb012')" />
      <el-table-column prop="mb013" label="附加文本" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb013')" />
      <el-table-column prop="mb014" label="科目组" align="center" :show-overflow-tooltip="true"
            ...
            <el-row :gutter="20">
              ...
              <el-col :lg="12">
                <el-form-item label="语言Key" prop="mb005">
                  <el-input v-model="form.mb005" :placeholder="$t('btn.enterPrefix')+'语言Key'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="科目编号" prop="mb006">
                  <el-input v-model="form.mb006" :placeholder="$t('btn.enterPrefix')+'科目编号'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="科目表" prop="mb007">
                  <el-input v-model="form.mb007" :placeholder="$t('btn.enterPrefix')+'科目表'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="BS类别" prop="mb008">
                  <el-select filterable clearable v-model="form.mb008"
                    :placeholder="$t('btn.selectPrefix')+'BS类别'+$t('btn.selectSuffix')">
                    <el-option v-for="item in  options.sys_bs_type" :key="item.dictValue" :label="item.dictLabel"
                      :value="item.dictValue"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="PL类别" prop="mb009">
                  <el-select filterable clearable v-model="form.mb009"
              ...
              <el-col :lg="12">
                <el-form-item label="统驭类别" prop="mb010">
                  <el-select filterable clearable v-model="form.mb010"
              ...
              <el-col :lg="12">
                <el-form-item label="短文本" prop="mb011">
                  <el-input v-model="form.mb011" :placeholder="$t('btn.enterPrefix')+'短文本'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="长文本" prop="mb012">
                  <el-input v-model="form.mb012" :placeholder="$t('btn.enterPrefix')+'长文本'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="附加文本" prop="mb013">
                  <el-input v-model="form.mb013" :placeholder="$t('btn.enterPrefix')+'附加文本'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="科目组" prop="mb014">
                  <el-input v-model="form.mb014" :placeholder="$t('btn.enterPrefix')+'科目组'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="8" />
                </el-form-item>
              </el-col>
  ...
  function handleBukrsChange() {
    ...
    if (open.value === true) {
      ...
      if (form.value.mb003 === '0001') {
        ...
        form.value.mb004 = 'EUR'
        //console.log(queryParams.mb004)
      }
      if (form.value.mb003 === '2300') {
        //console.log(state.options.sql_global_currency)
        //filteredSaknr.value = state.options.sql_global_currency.value.filter(item => item.dictValue === 'CNY')
        form.value.mb004 = 'CNY'
        //console.log(queryParams.mb004)
      }
      if (form.value.mb003 === '2400') {
        form.value.mb004 = 'HKD'
      }
      if (form.value.mb003 === '1000') {
        form.value.mb004 = 'JPY'
      }
      if (form.value.mb003 === '2700') {
        form.value.mb004 = 'CNY'
      }
      if (form.value.mb003 === '3000') {
        form.value.mb004 = 'USD'
      }
      if (form.value.mb003 === '4000') {
        form.value.mb004 = 'EUR'
      }
      if (form.value.mb003 === '4100') {
        form.value.mb004 = 'EUR'
      }
      //form.value.mb004 = ''
    }
      ...
      if (queryParams.mb003 === '0001') {
        //console.log(state.options.sql_global_currency)
        //filteredSaknr.value = state.options.sql_global_currency.value.filter(item => item.dictValue === 'CNY')
        queryParams.mb004 = 'EUR'
        //console.log(queryParams.mb004)
      }
      if (queryParams.mb003 === '2300') {
        //console.log(state.options.sql_global_currency)
        //filteredSaknr.value = state.options.sql_global_currency.value.filter(item => item.dictValue === 'CNY')
        queryParams.mb004 = 'CNY'
        //console.log(queryParams.mb004)
      }
      if (queryParams.mb003 === '2400') {
        queryParams.mb004 = 'HKD'
      }
      if (queryParams.mb003 === '1000') {
        queryParams.mb004 = 'JPY'
      }
      if (queryParams.mb003 === '2700') {
        queryParams.mb004 = 'CNY'
      }
      if (queryParams.mb003 === '3000') {
        queryParams.mb004 = 'USD'
      }
      if (queryParams.mb003 === '4000') {
        queryParams.mb004 = 'EUR'
      }
      if (queryParams.mb003 === '4100') {
        queryParams.mb004 = 'EUR'
      }
      //queryParams.mb003 = ''
    }
