        ...
        <el-col :lg="24">
          ...
          <el-form-item label="银行所在国" prop="mc007">
            <el-select
              filterable
              clearable
              v-model="queryParams.mc007"
              :placeholder="$t('btn.selectSearchPrefix') + '银行所在国' + $t('btn.selectSearchSuffix')">
          ...
          <el-form-item label="所在州省" prop="mc008">
            <el-select
              ...
              remote
              remote-show-suffix
              :remote-method="remoteMethod_sql_global_state"
              :loading="loading"
              v-model="queryParams.mc008"
              :placeholder="$t('btn.selectSearchPrefix') + '所在州省' + $t('btn.selectSearchSuffix')">
            ...
            <el-row :gutter="20">
              <el-col :lg="12">
                <el-form-item label="集团" prop="mc002">
                  <el-input
                    v-model="form.mc002"
                    :placeholder="$t('btn.enterPrefix') + '集团' + $t('btn.enterSuffix')"
                    show-word-limit
                    maxlength="6" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="关联对象" prop="mc003">
                  <el-input
                    v-model="form.mc003"
                    :placeholder="$t('btn.enterPrefix') + '关联对象' + $t('btn.enterSuffix')"
                    show-word-limit
                    maxlength="20" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="所在州省" prop="mc008">
                  <el-select
                    ...
                    :loading="loading"
                    v-model="form.mc008"
                    :placeholder="$t('btn.selectPrefix') + '所在州省' + $t('btn.selectSuffix')">
                    <el-option
              ...
              <el-col :lg="12">
                <el-form-item label="所在市" prop="mc009">
                  <el-input
                    v-model="form.mc009"
                    :placeholder="$t('btn.enterPrefix') + '所在市' + $t('btn.enterSuffix')"
                    show-word-limit
                    maxlength="40" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="所在县" prop="mc010">
                  <el-input
                    v-model="form.mc010"
                    :placeholder="$t('btn.enterPrefix') + '所在县' + $t('btn.enterSuffix')"
                    show-word-limit
                    maxlength="40" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="地址1" prop="mc011">
                  <el-input
                    v-model="form.mc011"
                    :placeholder="$t('btn.enterPrefix') + '地址1' + $t('btn.enterSuffix')"
                    show-word-limit
                    maxlength="200" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="地址2" prop="mc012">
                  <el-input
                    v-model="form.mc012"
                    :placeholder="$t('btn.enterPrefix') + '地址2' + $t('btn.enterSuffix')"
                    show-word-limit
                    maxlength="200" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="地址3" prop="mc013">
                  <el-input
                    v-model="form.mc013"
                    :placeholder="$t('btn.enterPrefix') + '地址3' + $t('btn.enterSuffix')"
                    show-word-limit
                    maxlength="200" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="邮政编码" prop="mc014">
                  <el-input
                    v-model="form.mc014"
                    :placeholder="$t('btn.enterPrefix') + '邮政编码' + $t('btn.enterSuffix')"
                    show-word-limit
                    maxlength="20" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="地址号码" prop="mc015">
                  <el-input
                    v-model="form.mc015"
                    :placeholder="$t('btn.enterPrefix') + '地址号码' + $t('btn.enterSuffix')"
                    show-word-limit
                    maxlength="20" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="持有人" prop="mc017">
                  <el-input
                    v-model="form.mc017"
                    :placeholder="$t('btn.enterPrefix') + '持有人' + $t('btn.enterSuffix')"
                    show-word-limit
                    maxlength="200" />
                </el-form-item>
              </el-col>
...
//后台操作函数
import { listFicoBank, addFicoBank, delFicoBank, updateFicoBank, getFicoBank } from '@/api/accounting/ficobank.js'
...
//远程字典参数
var remotedictParams_sql_global_state = [{ dictType: 'sql_global_state' }]
//远程搜索组件实例
onMounted(() => {
...
//字典参数
var dictParams = [{ dictType: 'sql_global_country' }, { dictType: 'sys_freeze_flag' }, { dictType: 'sys_is_deleted' }]
...
function handleDelete(row) {
  ...
  proxy
    .$confirm(
      proxy.$t('common.tipConfirmDel') + Ids + proxy.$t('common.tipConfirmDelDataitems'),
      proxy.$t('btn.delete') + ' ' + proxy.$t('common.tip'),
      {
