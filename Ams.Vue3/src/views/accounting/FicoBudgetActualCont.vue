...
<template>
  <div>
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :lg="24">
          ...
          <el-form-item label="年月" prop="me003">
            <el-select filterable clearable v-model="queryParams.me003"
          ...
          <el-form-item label="公司代码" prop="me004">
            <el-select filterable clearable v-model="queryParams.me004"
          ...
          <el-form-item label="币种" prop="me009">
            <el-select filterable clearable v-model="queryParams.me009"
    ...
    <el-row :gutter="15" class="mb10">
      ...
      <el-col :span="1.5">
        <el-button class="btn-edit" :disabled="single" v-hasPermi="['fico:budgetactualcont:edit']" plain icon="edit"
          @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-deletebatch" :disabled="multiple" v-hasPermi="['fico:budgetactualcont:delete']" plain
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData templateUrl="Accounting/FicoBudgetActualCont/importTemplate"
                  importUrl="/Accounting/FicoBudgetActualCont/importData" @success="handleFileSuccess"></importData>
              </el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
      ...
      <el-col :span="1.5">
        <el-button class="btn-export" plain icon="download" @click="handleExport"
          v-hasPermi="['fico:budgetactualcont:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-table border height="600px" :data="dataList" v-loading="loading" ref="table"
      ...
      <el-table-column prop="me005" label="统计类别" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('me005')" />
      <el-table-column prop="me006" label="成本科目" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('me006')" />
      <el-table-column prop="me007" label="成本分类" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('me007')" />
      <el-table-column prop="me008" label="科目代码" align="center" :show-overflow-tooltip="true"
      ...
      <el-table-column prop="me013" label="核算人员" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('me013')" />
        ...
        <template #default="scope">
          <el-button-group>
            <el-button class="btn-edit" plain size="small" icon="edit" :title="$t('btn.edit')"
              v-hasPermi="['fico:budgetactualcont:edit']" @click="handleUpdate(scope.row)"></el-button>
            <el-button class="btn-delete" plain size="small" icon="delete" :title="$t('btn.delete')"
              v-hasPermi="['fico:budgetactualcont:delete']" @click="handleDelete(scope.row)"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
          <el-tab-pane :label="$t('ptabs.basicInfo')" name="first">
            <el-row :gutter="20">
              ...
              <el-col :lg="12">
                <el-form-item label="年月" prop="me003">
                  <el-select filterable clearable v-model="form.me003"
              ...
              <el-col :lg="12">
                <el-form-item label="公司代码" prop="me004">
                  <el-select filterable clearable v-model="form.me004"
              ...
              <el-col :lg="12">
                <el-form-item label="统计类别" prop="me005">
                  <el-input v-model="form.me005" :placeholder="$t('btn.enterPrefix')+'统计类别'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="成本科目" prop="me006">
                  <el-input v-model="form.me006" :placeholder="$t('btn.enterPrefix')+'成本科目'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="成本分类" prop="me007">
                  <el-input v-model="form.me007" :placeholder="$t('btn.enterPrefix')+'成本分类'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="科目代码" prop="me008">
                  <el-input v-model="form.me008" :placeholder="$t('btn.enterPrefix')+'科目代码'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="10" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="币种" prop="me009">
                  <el-select filterable clearable v-model="form.me009"
              ...
              <el-col :lg="12">
                <el-form-item label="核算人员" prop="me013">
                  <el-input v-model="form.me013" :placeholder="$t('btn.enterPrefix')+'核算人员'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="10" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="核算日期" prop="me014">
                  <el-date-picker v-model="form.me014" type="datetime" :teleported="false"
...
<script setup name="ficobudgetactualcont">
  ...
  function handleLfgjaChange() {
    ...
    if (open.value === true) {
      form.value.me003 = ''
      filteredLfmon.value = state.options.sql_ymdt_list.filter(item => item.extLabel === form.value.me002)
      ...
      queryParams.me003 = ''
      filteredLfmon.value = state.options.sql_ymdt_list.filter(item => item.extLabel === queryParams.me002)
  ...
  function handleBukrsChange() {
    ...
    if (open.value === true) {
      ...
      if (form.value.me004 === '0001') {
        ...
        form.value.me009 = 'EUR'
        //console.log(queryParams.mb004)
      }
      if (form.value.me004 === '2300') {
        //console.log(state.options.sql_global_currency)
        //filteredSaknr.value = state.options.sql_global_currency.value.filter(item => item.dictValue === 'CNY')
        form.value.me009 = 'CNY'
        //console.log(queryParams.mb004)
      }
      if (form.value.me004 === '2400') {
        form.value.me009 = 'HKD'
      }
      if (form.value.me004 === '1000') {
        form.value.me009 = 'JPY'
      }
      if (form.value.me004 === '2700') {
        form.value.me009 = 'CNY'
      }
      if (form.value.me004 === '3000') {
        form.value.me009 = 'USD'
      }
      if (form.value.me004 === '4000') {
        form.value.me009 = 'EUR'
      }
      if (form.value.me004 === '4100') {
        form.value.me009 = 'EUR'
      }
      //form.value.mb004 = ''
    }
      ...
      if (queryParams.me004 === '0001') {
        //console.log(state.options.sql_global_currency)
        //filteredSaknr.value = state.options.sql_global_currency.value.filter(item => item.dictValue === 'CNY')
        queryParams.me009 = 'EUR'
        //console.log(queryParams.mb004)
      }
      if (queryParams.me004 === '2300') {
        //console.log(state.options.sql_global_currency)
        //filteredSaknr.value = state.options.sql_global_currency.value.filter(item => item.dictValue === 'CNY')
        queryParams.me009 = 'CNY'
        //console.log(queryParams.mb004)
      }
      if (queryParams.me004 === '2400') {
        queryParams.me009 = 'HKD'
      }
      if (queryParams.me004 === '1000') {
        queryParams.me009 = 'JPY'
      }
      if (queryParams.me004 === '2700') {
        queryParams.me009 = 'CNY'
      }
      if (queryParams.me004 === '3000') {
        queryParams.me009 = 'USD'
      }
      if (queryParams.me004 === '4000') {
        queryParams.me009 = 'EUR'
      }
      if (queryParams.me004 === '4100') {
        queryParams.me009 = 'EUR'
      }
      //queryParams.mb003 = ''
    }
