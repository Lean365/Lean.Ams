        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="统计类别" prop="fbExpCategory">
              <el-input v-model="form.fbExpCategory" :placeholder="$t('btn.enterPrefix')+'统计类别'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
...
const state = reactive({
  ...
  rules: {
    ...
    fbFy: [{ required: true, message: "期间"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    ...
    fbExpCategory: [{ required: true, message: "统计类别"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
