  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="明细科目" prop="fbeTitlesub">
        <el-select filterable clearable   v-model="queryParams.fbeTitlesub" :placeholder="$t('btn.selectSearchPrefix')+'明细科目'+$t('btn.selectSearchSuffix')">
          <el-option v-for="item in   options.sql_recon_account " :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
            <span class="fl">{{ item.dictLabel }}</span>
            <span class="fr" style="color: var(--el-text-color-secondary);">{{ item.dictValue }}</span>          
          </el-option>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="fbeTitlesub" label="明细科目" align="center" v-if="columns.showColumn('fbeTitlesub')">
        <template #default="scope">
          <dict-tag :options=" options.sql_recon_account " :value="scope.row.fbeTitlesub"  />
        </template>
      </el-table-column>
      ...
      <el-table-column prop="fbsUndoName" label="撤消人员" align="center" v-if="columns.showColumn('fbsUndoName')">
        <template #default="scope">
          <dict-tag :options=" options.sql_sop_group " :value="scope.row.fbsUndoName"  />
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="明细科目" prop="fbeTitlesub">
              <el-select filterable clearable   v-model="form.fbeTitlesub"  :placeholder="$t('btn.selectPrefix')+'明细科目'+$t('btn.selectSuffix')">
                <el-option
                  v-for="item in  options.sql_recon_account" 
                  :key="item.dictValue" 
                  :label="item.dictLabel" 
...
const state = reactive({
  ...
  rules: {
    ...
    fbeTitlesub: [{ required: true, message: "明细科目"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
...
sql_ec_group: [],
    // 撤消人员 选项列表 格式 eg:{ dictLabel: '标签', dictValue: '0'}
sql_sop_group: [],
