  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="启用标记" prop="fbssFlag">
        <el-select filterable clearable   v-model="queryParams.fbssFlag" :placeholder="$t('btn.selectSearchPrefix')+'启用标记'+$t('btn.selectSearchSuffix')">
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="ID" prop="fbesSfid">
              <el-input v-model.number="form.fbesSfid" :placeholder="$t('btn.enterPrefix')+'ID'+$t('btn.enterSuffix')" :disabled="opertype != 1"/>
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="父ID" prop="fbesParentSfid">
              <el-input v-model.number="form.fbesParentSfid" :placeholder="$t('btn.enterPrefix')+'父ID'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="名称" prop="fbesClass">
              <el-input v-model="form.fbesClass" :placeholder="$t('btn.enterPrefix')+'名称'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="明细名称" prop="fbesClasssub">
              <el-input v-model="form.fbesClasssub" :placeholder="$t('btn.enterPrefix')+'明细名称'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="说明" prop="fbesClassmemo">
              <el-input v-model="form.fbesClassmemo" :placeholder="$t('btn.enterPrefix')+'说明'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="启用标记" prop="fbssFlag">
              <el-select filterable clearable   v-model="form.fbssFlag"  :placeholder="$t('btn.selectPrefix')+'启用标记'+$t('btn.selectSuffix')">
                <el-option
...
const columns = ref([
  ...
  { visible: true, prop: 'fbesBudgetAmount', label: '预算金额' },
...
const state = reactive({
  ...
  rules: {
    ...
    fbesParentSfid: [{ required: true, message: "父ID"+proxy.$t('btn.isEmpty'), trigger: "blur"    , type: "number"  }],
    fbesTitle: [{ required: true, message: "科目"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    fbesClass: [{ required: true, message: "名称"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbesTitlesub: [{ required: true, message: "明细科目"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    fbesClasssub: [{ required: true, message: "明细名称"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbesClassmemo: [{ required: true, message: "说明"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbesBudgetAmount: [{ required: true, message: "预算金额"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbesActualAmount: [{ required: true, message: "实际发生"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbesDifferenceAmount: [{ required: true, message: "差异"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbssFlag: [{ required: true, message: "启用标记"+proxy.$t('btn.isEmpty'), trigger: "change"    , type: "number"  }],
