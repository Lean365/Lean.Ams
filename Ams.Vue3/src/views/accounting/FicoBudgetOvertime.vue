        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="加班事由" prop="mi013">
              <el-input   v-model="form.mi013" :placeholder="$t('btn.enterPrefix')+'加班事由'+$t('btn.enterSuffix')"  show-word-limit   maxlength="500"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="启用标记" prop="mi020">
              <el-input-number v-model.number="form.mi020" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'启用标记'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="审核" prop="mi021">
              <el-input-number v-model.number="form.mi021" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'审核'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
