  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="公司" prop="fbsCorp">
        <el-select filterable clearable   v-model="queryParams.fbsCorp" :placeholder="$t('btn.selectSearchPrefix')+'公司'+$t('btn.selectSearchSuffix')">
          <el-option v-for="item in  options.fbsCorpOptions" :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="fbsCorp" label="公司" align="center" v-if="columns.showColumn('fbsCorp')">
        <template #default="scope">
          <dict-tag :options=" options.fbsCorpOptions" :value="scope.row.fbsCorp"  />
        </template>
      </el-table-column>
    ...
    <el-drawer v-model="drawer" size="65%" direction="rtl">
      <el-table :data="ficoBudgetStaffSlvList" header-row-class-name="text-navy">
        ...
        <el-table-column prop="fbssSfid" label="SFID"/>
        <el-table-column prop="fbssParentSfid" label="FbssParentSfid"/>
          ...
          <el-col :lg="12">
            <el-form-item label="公司" prop="fbsCorp">
              <el-select filterable clearable   v-model="form.fbsCorp"  :placeholder="$t('btn.selectPrefix')+'公司'+$t('btn.selectSuffix')">
                <el-option
                  v-for="item in  options.fbsCorpOptions" 
                  :key="item.dictValue" 
...
const state = reactive({
  ...
  rules: {
    ...
    fbsFy: [{ required: true, message: "财年"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
