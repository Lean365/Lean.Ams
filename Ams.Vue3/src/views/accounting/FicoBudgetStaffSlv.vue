  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="启用" prop="fbssFlag">
        <el-select filterable clearable   v-model="queryParams.fbssFlag" :placeholder="$t('btn.selectSearchPrefix')+'启用'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="审核" prop="fbssAudit">
        <el-select filterable clearable   v-model="queryParams.fbssAudit" :placeholder="$t('btn.selectSearchPrefix')+'审核'+$t('btn.selectSearchSuffix')">
          <el-option v-for="item in   options.sys_flag_list " :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
            <span class="fl">{{ item.dictLabel }}</span>
            <span class="fr" style="color: var(--el-text-color-secondary);">{{ item.dictValue }}</span>          
          </el-option>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="fbssSfid" label="SFID" align="center" v-if="columns.showColumn('fbssSfid')"/>
      <el-table-column prop="fbssParentSfid" label="FbssParentSfid" align="center" v-if="columns.showColumn('fbssParentSfid')"/>
      ...
      <el-table-column prop="fbssFlag" label="启用" align="center" v-if="columns.showColumn('fbssFlag')">
        <template #default="scope">
          <dict-tag :options=" options.sys_flag_list " :value="scope.row.fbssFlag"  />
        </template>
      </el-table-column>
      <el-table-column prop="fbssAudit" label="审核" align="center" v-if="columns.showColumn('fbssAudit')">
        <template #default="scope">
          <dict-tag :options=" options.sys_flag_list " :value="scope.row.fbssAudit"  />
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="SFID" prop="fbssSfid">
              <el-input v-model.number="form.fbssSfid" :placeholder="$t('btn.enterPrefix')+'SFID'+$t('btn.enterSuffix')" :disabled="opertype != 1"/>
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="FbssParentSfid" prop="fbssParentSfid">
              <el-input v-model.number="form.fbssParentSfid" :placeholder="$t('btn.enterPrefix')+'FbssParentSfid'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="名称" prop="fbssClass">
              <el-input v-model="form.fbssClass" :placeholder="$t('btn.enterPrefix')+'名称'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="启用" prop="fbssFlag">
              <el-select filterable clearable   v-model="form.fbssFlag"  :placeholder="$t('btn.selectPrefix')+'启用'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="审核" prop="fbssAudit">
              <el-select filterable clearable   v-model="form.fbssAudit"  :placeholder="$t('btn.selectPrefix')+'审核'+$t('btn.selectSuffix')">
                <el-option
                  v-for="item in  options.sys_flag_list" 
                  :key="item.dictValue" 
                  :label="item.dictLabel" 
          ...
          <el-col :lg="12">
            <el-form-item label="审核人员" prop="fbssAuditName">
              <el-input v-model="form.fbssAuditName" :placeholder="$t('btn.enterPrefix')+'审核人员'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="撤消人员" prop="fbssUndoName">
              <el-input v-model="form.fbssUndoName" :placeholder="$t('btn.enterPrefix')+'撤消人员'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
...
//字段显示控制
const columns = ref([
  { visible: true, prop: 'fbssSfid', label: 'SFID' },
  { visible: true, prop: 'fbssParentSfid', label: 'FbssParentSfid' },
  ...
  { visible: true, prop: 'fbssPersonnel', label: '预算' },
...
const state = reactive({
  ...
  form: {},
  rules: {
    fbssSfid: [{ required: true, message: "SFID"+proxy.$t('btn.isEmpty'), trigger: "blur" }],
    fbssParentSfid: [{ required: true, message: "FbssParentSfid"+proxy.$t('btn.isEmpty'), trigger: "blur"    , type: "number"  }],
    fbssTitle: [{ required: true, message: "科目"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    fbssClass: [{ required: true, message: "名称"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fbssCategory: [{ required: true, message: "类别"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    fbssKeepPersonnel: [{ required: true, message: "保有"+proxy.$t('btn.isEmpty'), trigger: "blur"    , type: "number"  }],
    fbssNowPersonnel: [{ required: true, message: "现有"+proxy.$t('btn.isEmpty'), trigger: "blur"    , type: "number"  }],
    fbssPersonnel: [{ required: true, message: "预算"+proxy.$t('btn.isEmpty'), trigger: "blur"    , type: "number"  }],
    fbssFlag: [{ required: true, message: "启用"+proxy.$t('btn.isEmpty'), trigger: "change"    , type: "number"  }],
    fbssAudit: [{ required: true, message: "审核"+proxy.$t('btn.isEmpty'), trigger: "change"    , type: "number"  }],
