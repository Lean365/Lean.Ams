  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="期间" prop="mo002">
        <el-select filterable clearable   v-model="queryParams.mo002" :placeholder="$t('btn.selectSearchPrefix')+'期间'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="年月" prop="mo003">
        <el-select filterable clearable   v-model="queryParams.mo003" :placeholder="$t('btn.selectSearchPrefix')+'年月'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="公司" prop="mo004">
        <el-select filterable clearable   v-model="queryParams.mo004" :placeholder="$t('btn.selectSearchPrefix')+'公司'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="成本中心" prop="mo008">
        <el-select filterable clearable   v-model="queryParams.mo008" :placeholder="$t('btn.selectSearchPrefix')+'成本中心'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="资产简称" prop="mo009">
        <el-input v-model="queryParams.mo009" :placeholder="$t('btn.enterSearchPrefix')+'资产简称'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="资本化日期">
        <el-date-picker
          v-model="dateRangeMo016" 
          type="datetimerange"
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="mo005" label="使用部门" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mo005')"/>
      <el-table-column prop="mo006" label="资产类别" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mo006')"/>
      <el-table-column prop="mo007" label="资产编码" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mo007')"/>
      ...
      <el-table-column prop="mo009" label="资产简称" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mo009')"/>
      <el-table-column prop="mo010" label="资产全称" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mo010')"/>
      <el-table-column prop="mo011" label="单位" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mo011')"/>
      ...
      <el-table-column prop="mo014" label="币种" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mo014')"/>
      ...
      <el-table-column prop="mo020" label="存放位置" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mo020')"/>
      ...
      <el-table-column prop="mo023" label="供应商" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mo023')"/>
      <el-table-column prop="mo024" label="制造商" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mo024')"/>
      <el-table-column prop="mo025" label="供应商物料" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mo025')"/>
      <el-table-column prop="mo026" label="制造商物料" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mo026')"/>
      ...
      <el-table-column prop="mo029" label="盘点人员" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mo029')"/>
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="期间" prop="mo002">
              <el-select filterable clearable   v-model="form.mo002"  :placeholder="$t('btn.selectPrefix')+'期间'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="年月" prop="mo003">
              <el-select filterable clearable   v-model="form.mo003"  :placeholder="$t('btn.selectPrefix')+'年月'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="公司" prop="mo004">
              <el-select filterable clearable   v-model="form.mo004"  :placeholder="$t('btn.selectPrefix')+'公司'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="使用部门" prop="mo005">
              <el-input   v-model="form.mo005" :placeholder="$t('btn.enterPrefix')+'使用部门'+$t('btn.enterSuffix')"  show-word-limit   maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="资产类别" prop="mo006">
              <el-input   v-model="form.mo006" :placeholder="$t('btn.enterPrefix')+'资产类别'+$t('btn.enterSuffix')"  show-word-limit   maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="资产编码" prop="mo007">
              <el-input   v-model="form.mo007" :placeholder="$t('btn.enterPrefix')+'资产编码'+$t('btn.enterSuffix')"  show-word-limit   maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="成本中心" prop="mo008">
              <el-select filterable clearable   v-model="form.mo008"  :placeholder="$t('btn.selectPrefix')+'成本中心'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="资产简称" prop="mo009">
              <el-input   v-model="form.mo009" :placeholder="$t('btn.enterPrefix')+'资产简称'+$t('btn.enterSuffix')"  show-word-limit   maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="资产全称" prop="mo010">
              <el-input   v-model="form.mo010" :placeholder="$t('btn.enterPrefix')+'资产全称'+$t('btn.enterSuffix')"  show-word-limit   maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="单位" prop="mo011">
              <el-input   v-model="form.mo011" :placeholder="$t('btn.enterPrefix')+'单位'+$t('btn.enterSuffix')"  show-word-limit   maxlength="255"/>
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="数量" prop="mo012">
              <el-input-number v-model.number="form.mo012" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'数量'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="管理区分" prop="mo013">
              <el-input-number v-model.number="form.mo013" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'管理区分'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="币种" prop="mo014">
              <el-input   v-model="form.mo014" :placeholder="$t('btn.enterPrefix')+'币种'+$t('btn.enterSuffix')"  show-word-limit   maxlength="3"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="购买价格" prop="mo015">
              <el-input-number v-model.number="form.mo015" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'购买价格'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="资本化日期" prop="mo016">
              <el-date-picker v-model="form.mo016" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="折旧价值" prop="mo017">
              <el-input-number v-model.number="form.mo017" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'折旧价值'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="报废日期" prop="mo018">
              <el-date-picker v-model="form.mo018" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="残值" prop="mo019">
              <el-input-number v-model.number="form.mo019" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'残值'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="存放位置" prop="mo020">
              <el-input   v-model="form.mo020" :placeholder="$t('btn.enterPrefix')+'存放位置'+$t('btn.enterSuffix')"  show-word-limit   maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="使用年限" prop="mo021">
              <el-input-number v-model.number="form.mo021" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'使用年限'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="是否停用" prop="mo022">
              <el-radio-group v-model="form.mo022">
                <el-radio v-for="item in options.sys_is_flag" :key="item.dictValue" :value="parseInt(item.dictValue)">
                  {{item.dictLabel}}
                </el-radio>
              </el-radio-group>
            </el-form-item>
          ...
          <el-col :lg="12">
            <el-form-item label="供应商" prop="mo023">
              <el-input   v-model="form.mo023" :placeholder="$t('btn.enterPrefix')+'供应商'+$t('btn.enterSuffix')"  show-word-limit   maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="制造商" prop="mo024">
              <el-input   v-model="form.mo024" :placeholder="$t('btn.enterPrefix')+'制造商'+$t('btn.enterSuffix')"  show-word-limit   maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="供应商物料" prop="mo025">
              <el-input   v-model="form.mo025" :placeholder="$t('btn.enterPrefix')+'供应商物料'+$t('btn.enterSuffix')"  show-word-limit   maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="制造商物料" prop="mo026">
              <el-input   v-model="form.mo026" :placeholder="$t('btn.enterPrefix')+'制造商物料'+$t('btn.enterSuffix')"  show-word-limit   maxlength="255"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="盘点人员" prop="mo029">
              <el-input   v-model="form.mo029" :placeholder="$t('btn.enterPrefix')+'盘点人员'+$t('btn.enterSuffix')"  show-word-limit   maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="周期盘点日期" prop="mo030">
              <el-date-picker v-model="form.mo030" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>
