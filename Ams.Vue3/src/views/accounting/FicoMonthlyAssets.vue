  ...
  <div>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="faCostCenter" label="成本中心 " align="center" v-if="columns.showColumn('faCostCenter')">
        <template #default="scope">
          <dict-tag :options=" options.sql_cost_center " :value="scope.row.faCostCenter"  />
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="ID" prop="faSfId">
              <el-input v-model.number="form.faSfId" :placeholder="$t('btn.enterPrefix')+'ID'+$t('btn.enterSuffix')" :disabled="opertype != 1"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="资产编码 " prop="faAssetNo">
              <el-input v-model="form.faAssetNo" :placeholder="$t('btn.enterPrefix')+'资产编码 '+$t('btn.enterSuffix')"  show-word-limit maxlength="255"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="资产简称 " prop="faAssetShortName">
              <el-input v-model="form.faAssetShortName" :placeholder="$t('btn.enterPrefix')+'资产简称 '+$t('btn.enterSuffix')"  show-word-limit maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="资产全称 " prop="faAssetFullName">
              <el-input v-model="form.faAssetFullName" :placeholder="$t('btn.enterPrefix')+'资产全称 '+$t('btn.enterSuffix')"  show-word-limit maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="单位 " prop="faAssetUnit">
              <el-input v-model="form.faAssetUnit" :placeholder="$t('btn.enterPrefix')+'单位 '+$t('btn.enterSuffix')"  show-word-limit maxlength="255"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="存放位置 " prop="faLocale">
              <el-input v-model="form.faLocale" :placeholder="$t('btn.enterPrefix')+'存放位置 '+$t('btn.enterSuffix')"  show-word-limit maxlength="255"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="供应商 " prop="faAssetVender">
              <el-input v-model="form.faAssetVender" :placeholder="$t('btn.enterPrefix')+'供应商 '+$t('btn.enterSuffix')"  show-word-limit maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="制造商 " prop="faAssetManufacturer">
              <el-input v-model="form.faAssetManufacturer" :placeholder="$t('btn.enterPrefix')+'制造商 '+$t('btn.enterSuffix')"  show-word-limit maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="供应商物料 " prop="faAssetVenderItem">
              <el-input v-model="form.faAssetVenderItem" :placeholder="$t('btn.enterPrefix')+'供应商物料 '+$t('btn.enterSuffix')"  show-word-limit maxlength="255"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="制造商物料 " prop="faAssetManufacturerItem">
              <el-input v-model="form.faAssetManufacturerItem" :placeholder="$t('btn.enterPrefix')+'制造商物料 '+$t('btn.enterSuffix')"  show-word-limit maxlength="255"/>
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="资产形态 " prop="faEntity">
              <el-input-number v-model.number="form.faEntity" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'资产形态 '+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="资产存在否 " prop="faHaveorNot">
              <el-input-number v-model.number="form.faHaveorNot" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'资产存在否 '+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="盘点人员 " prop="faCheckedby">
              <el-input v-model="form.faCheckedby" :placeholder="$t('btn.enterPrefix')+'盘点人员 '+$t('btn.enterSuffix')"  show-word-limit maxlength="255"/>
            </el-form-item>
          </el-col>
