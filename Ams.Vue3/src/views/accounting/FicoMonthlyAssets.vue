  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="是否停用" prop="faAssetStop">
        <el-select filterable clearable   v-model="queryParams.faAssetStop" :placeholder="$t('btn.selectSearchPrefix')+'是否停用'+$t('btn.selectSearchSuffix')">
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="是否停用" prop="faAssetStop">
              <el-select filterable clearable   v-model="form.faAssetStop"  :placeholder="$t('btn.selectPrefix')+'是否停用'+$t('btn.selectSuffix')">
                <el-option
