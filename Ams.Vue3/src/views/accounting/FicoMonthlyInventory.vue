  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="期间" prop="mp002">
        <el-select filterable clearable   v-model="queryParams.mp002" :placeholder="$t('btn.selectSearchPrefix')+'期间'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="年月" prop="mp003">
        <el-select filterable clearable   v-model="queryParams.mp003" :placeholder="$t('btn.selectSearchPrefix')+'年月'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="工厂" prop="mp004">
        <el-select filterable clearable   v-model="queryParams.mp004" :placeholder="$t('btn.selectSearchPrefix')+'工厂'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="物料" prop="mp005">
        <el-input v-model="queryParams.mp005" :placeholder="$t('btn.enterSearchPrefix')+'物料'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
        </el-col>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="mp005" label="物料" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mp005')"/>
      <el-table-column prop="mp006" label="评估类" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mp006')"/>
      <el-table-column prop="mp007" label="价格控制" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mp007')"/>
      ...
      <el-table-column prop="mp010" label="币种" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mp010')"/>
      ...
      <el-table-column prop="mp013" label="核算人员" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mp013')"/>
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="期间" prop="mp002">
              <el-select filterable clearable   v-model="form.mp002"  :placeholder="$t('btn.selectPrefix')+'期间'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="年月" prop="mp003">
              <el-select filterable clearable   v-model="form.mp003"  :placeholder="$t('btn.selectPrefix')+'年月'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="工厂" prop="mp004">
              <el-select filterable clearable   v-model="form.mp004"  :placeholder="$t('btn.selectPrefix')+'工厂'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="物料" prop="mp005">
              <el-input   v-model="form.mp005" :placeholder="$t('btn.enterPrefix')+'物料'+$t('btn.enterSuffix')"  show-word-limit   maxlength="20"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="评估类" prop="mp006">
              <el-input   v-model="form.mp006" :placeholder="$t('btn.enterPrefix')+'评估类'+$t('btn.enterSuffix')"  show-word-limit   maxlength="4"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="价格控制" prop="mp007">
              <el-input   v-model="form.mp007" :placeholder="$t('btn.enterPrefix')+'价格控制'+$t('btn.enterSuffix')"  show-word-limit   maxlength="1"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="移动平均价" prop="mp008">
              <el-input-number v-model.number="form.mp008" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'移动平均价'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="Per单位" prop="mp009">
              <el-input-number v-model.number="form.mp009" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'Per单位'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="币种" prop="mp010">
              <el-input   v-model="form.mp010" :placeholder="$t('btn.enterPrefix')+'币种'+$t('btn.enterSuffix')"  show-word-limit   maxlength="3"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="库存" prop="mp011">
              <el-input-number v-model.number="form.mp011" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'库存'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="金额" prop="mp012">
              <el-input-number v-model.number="form.mp012" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'金额'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="核算人员" prop="mp013">
              <el-input   v-model="form.mp013" :placeholder="$t('btn.enterPrefix')+'核算人员'+$t('btn.enterSuffix')"  show-word-limit   maxlength="10"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="核算日期" prop="mp014">
              <el-date-picker v-model="form.mp014" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>
