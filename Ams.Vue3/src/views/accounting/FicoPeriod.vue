  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="财年" prop="fpFy">
        <el-input v-model="queryParams.fpFy" :placeholder="$t('btn.enterSearchPrefix')+'财年'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="年月" prop="fpYm">
        <el-input v-model="queryParams.fpYm" :placeholder="$t('btn.enterSearchPrefix')+'年月'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="年" prop="fpYear">
        <el-input v-model="queryParams.fpYear" :placeholder="$t('btn.enterSearchPrefix')+'年'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="月" prop="fpMonth">
        <el-input v-model="queryParams.fpMonth" :placeholder="$t('btn.enterSearchPrefix')+'月'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="季度" prop="fpQuarter">
        <el-input v-model="queryParams.fpQuarter" :placeholder="$t('btn.enterSearchPrefix')+'季度'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
        </el-col>
    ...
    <el-row :gutter="15" class="mb10">
      <el-col :span="1.5">
        <el-button class="btn-add" v-hasPermi="['fico:period:add']" plain icon="plus" @click="handleAdd">
          {{ $t('btn.add') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-edit" :disabled="single" v-hasPermi="['fico:period:edit']" plain icon="edit" @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-deletebatch" :disabled="multiple" v-hasPermi="['fico:period:delete']" plain icon="delete" @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData
                  templateUrl="Accounting/FicoPeriod/importTemplate"
                  importUrl="/Accounting/FicoPeriod/importData"
      ...
      <el-col :span="1.5">
        <el-button class="btn-export" plain icon="download" @click="handleExport" v-hasPermi="['fico:period:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-table border height="600px"
      ...
      <el-table-column :label="$t('btn.operation')" width="160" align="center">
        <template #default="scope">
          <el-button-group>
          <el-button class="btn-edit" plain size="small" icon="edit" :title="$t('btn.edit')" v-hasPermi="['fico:period:edit']" @click="handleUpdate(scope.row)"></el-button>
          <el-button class="btn-delete" plain size="small" icon="delete" :title="$t('btn.delete')" v-hasPermi="['fico:period:delete']" @click="handleDelete(scope.row)"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="SFID" prop="fpSFID">
              <el-input v-model.number="form.fpSFID" :placeholder="$t('btn.enterPrefix')+'SFID'+$t('btn.enterSuffix')" :disabled="opertype != 1"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="财年" prop="fpFy">
              <el-input v-model="form.fpFy" :placeholder="$t('btn.enterPrefix')+'财年'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="年月" prop="fpYm">
              <el-input v-model="form.fpYm" :placeholder="$t('btn.enterPrefix')+'年月'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
...
//后台操作函数
import { listFicoPeriod,
 addFicoPeriod, delFicoPeriod, 
 updateFicoPeriod,getFicoPeriod, 
 } 
from '@/api/accounting/ficoperiod.js'
...
const state = reactive({
  ...
  form: {},
  rules: {
    fpSFID: [{ required: true, message: "SFID"+proxy.$t('btn.isEmpty'), trigger: "blur" }],
    fpFy: [{ required: true, message: "财年"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fpYm: [{ required: true, message: "年月"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fpYear: [{ required: true, message: "年"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fpMonth: [{ required: true, message: "月"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    fpQuarter: [{ required: true, message: "季度"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
...
function handleExport() {
  proxy
    ...
    .then(async () => {
      await proxy.downFile('/Accounting/FicoPeriod/export', { ...queryParams })
    })
}
