  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="权益类型" prop="etype">
        <el-select filterable clearable   v-model="queryParams.etype" :placeholder="$t('btn.selectSearchPrefix')+'权益类型'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="锁定标记" prop="lockInd">
        <el-select filterable clearable   v-model="queryParams.lockInd" :placeholder="$t('btn.selectSearchPrefix')+'锁定标记'+$t('btn.selectSearchSuffix')">
          <el-option v-for="item in   options.sys_locked_flag " :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
            <span class="fl">{{ item.dictLabel }}</span>
            <span class="fr" style="color: var(--el-text-color-secondary);">{{ item.dictValue }}</span>          
          </el-option>
        </el-select>
      ...
      <el-form-item label="状态" prop="tstate">
        <el-radio-group v-model="queryParams.tstate">
          ...
          <el-radio v-for="item in  options.sys_activate_flag " :key="item.dictValue" :value="item.dictValue">{{item.dictLabel}}</el-radio>
        </el-radio-group>
      </el-form-item>
        </el-col>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="etype" label="权益类型" align="center" v-if="columns.showColumn('etype')">
        <template #default="scope">
          <dict-tag :options=" options.sys_exp_type " :value="scope.row.etype"  />
        </template>
      </el-table-column>
      ...
      <el-table-column prop="lockInd" label="锁定标记" align="center" v-if="columns.showColumn('lockInd')">
        <template #default="scope">
          <dict-tag :options=" options.sys_locked_flag " :value="scope.row.lockInd"  />
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="权益类型" prop="etype">
              <el-select filterable clearable   v-model="form.etype"  :placeholder="$t('btn.selectPrefix')+'权益类型'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="锁定标记" prop="lockInd">
              <el-select filterable clearable   v-model="form.lockInd"  :placeholder="$t('btn.selectPrefix')+'锁定标记'+$t('btn.selectSuffix')">
                <el-option
...
const state = reactive({
  ...
  rules: {
    ...
    lockInd: [{ required: true, message: "锁定标记"+proxy.$t('btn.isEmpty'), trigger: "change"    , type: "number"  }],
