 ...
 * @Version: 0.24.654.26622
 * @Author: Lean365(Davis.Ching)
 * @Date: 2024/10/15 14:57:54
 * @column：38
...
<template>
  <div>
    ...
    <el-table v-if="refreshTable" :data="dataList" v-loading="loading" ref="tableRef" border height="600px"
      ...
      <el-table-column prop="md008" label="会计科目" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('md008')">
        <!-- <template #default="scope">
          <dict-tag :options=" filteredParamsSaknr " :value="scope.row.md008" />
        </template> -->
      </el-table-column>
...
<script setup name="ficobudgetaccounting">
  ...
  const columns = ref([
    ...
    { visible: true, prop: 'md012', label: '费用类型' },
    { visible: true, prop: 'md013', label: '统驭科目' },
