...
import { getListCurrentMonthLineOutputBar } from '@/api/statistics/pcbaoutput.js'
...
const getBarList = () => {
  getListCurrentMonthLineOutputBar(queryParams).then((response) => {
    ...
    for (let i = 0; i < obj.length; i++) {
      ...
      mfgLine.push(MapList[i].mfgLine + '班')
    }
    //动态插入数据时，数据在这里设置更新
    chart.setOption({
      xAxis: {
