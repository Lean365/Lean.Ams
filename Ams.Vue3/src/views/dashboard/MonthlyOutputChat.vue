...
<script setup name="monthlineoutputbar">
import * as echarts from 'echarts'

import { getListMonthOutput, getExportMonthOutput } from '@/api/statistics/assyoutput.js'
...
const getBarList = () => {
  getListMonthOutput(queryParams).then((response) => {
      ...
      feature: {
        ...
        dataView: {
          ...
          optionToContent: function (opt) {
            ...
            var table =
              '<table border="1" style="user-select: text;color:#FF9D6F;margin-left:20px;border-collapse:collapse;font-size:14px;text-align:center"><tbody><tr>' +
              tdHeads +
              '</tr>'
            var tdBodys = ''
