...
<script setup name="monthlypoorchat">
  import * as echarts from 'echarts'

  import {
    getMonthlyPoorQty, getListMonthPoor, getExportListMonthPoor, getListMonthlyPoorBar
  }
