  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="工厂" prop="werks">
        <el-select filterable clearable   v-model="queryParams.werks" :placeholder="$t('btn.selectSearchPrefix')+'工厂'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="行业领域" prop="mbrsh">
        <el-select filterable clearable   v-model="queryParams.mbrsh" :placeholder="$t('btn.selectSearchPrefix')+'行业领域'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="物料类型" prop="mtart">
        <el-select filterable clearable   v-model="queryParams.mtart" :placeholder="$t('btn.selectSearchPrefix')+'物料类型'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="基本计量单位" prop="meins">
        <el-select filterable clearable   v-model="queryParams.meins" :placeholder="$t('btn.selectSearchPrefix')+'基本计量单位'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="物料组" prop="matkl">
        <el-select filterable clearable   v-model="queryParams.matkl" :placeholder="$t('btn.selectSearchPrefix')+'物料组'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="采购组" prop="ekgrp">
        <el-select filterable clearable   v-model="queryParams.ekgrp" :placeholder="$t('btn.selectSearchPrefix')+'采购组'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="采购类型" prop="beskz">
        <el-select filterable clearable   v-model="queryParams.beskz" :placeholder="$t('btn.selectSearchPrefix')+'采购类型'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="特殊采购类型" prop="sobsl">
        <el-select filterable clearable   v-model="queryParams.sobsl" :placeholder="$t('btn.selectSearchPrefix')+'特殊采购类型'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="利润中心" prop="prctr">
        <el-select filterable clearable   v-model="queryParams.prctr" :placeholder="$t('btn.selectSearchPrefix')+'利润中心'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="币种" prop="waers">
        <el-select filterable clearable   v-model="queryParams.waers" :placeholder="$t('btn.selectSearchPrefix')+'币种'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="发货库存地点" prop="lgpro">
        <el-select filterable clearable   v-model="queryParams.lgpro" :placeholder="$t('btn.selectSearchPrefix')+'发货库存地点'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="外部采购的缺省仓储位置" prop="lgfsb">
        <el-select filterable clearable   v-model="queryParams.lgfsb" :placeholder="$t('btn.selectSearchPrefix')+'外部采购的缺省仓储位置'+$t('btn.selectSearchSuffix')">
          <el-option v-for="item in   options.sys_sloc_list " :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
            <span class="fl">{{ item.dictLabel }}</span>
            <span class="fr" style="color: var(--el-text-color-secondary);">{{ item.dictValue }}</span>          
          </el-option>
      ...
      <el-form-item label="在工厂级标记要删除的物料" prop="lvorm">
        <el-select filterable clearable   v-model="queryParams.lvorm" :placeholder="$t('btn.selectSearchPrefix')+'在工厂级标记要删除的物料'+$t('btn.selectSearchSuffix')">
    ...
    <el-row :gutter="15" class="mb10">
      ...
      <el-col :span="1.5">
        <el-button class="btn-edit" :disabled="single" v-hasPermi="['mm:marb:edit']" plain icon="edit" @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-deletebatch" :disabled="multiple" v-hasPermi="['mm:marb:delete']" plain icon="delete" @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData
                  templateUrl="Logistics/MmMarb/importTemplate"
                  importUrl="/Logistics/MmMarb/importData"
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="maktx" label="物料描述（短文本）" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('maktx')"/>
      ...
      <el-table-column prop="bstme" label="基本计量单位" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('bstme')"/>
      <el-table-column prop="bstrf" label="采购订单数量的舍入值" align="center" v-if="columns.showColumn('bstrf')"/>
      <el-table-column prop="kzwsm" label="基本计量单位" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('kzwsm')"/>
      ...
      <el-table-column prop="awsls" label="差异码" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('awsls')"/>
      ...
      <el-table-column prop="mfrnr" label="制造商编号" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mfrnr')"/>
      ...
      <el-table-column prop="lgpbe" label="库存仓位" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('lgpbe')"/>
      ...
      <el-table-column :label="$t('btn.operation')" width="160" align="center">
        <template #default="scope">
          <el-button-group>
          <el-button class="btn-edit" plain size="small" icon="edit" :title="$t('btn.edit')" v-hasPermi="['mm:marb:edit']" @click="handleUpdate(scope.row)"></el-button>
          <el-button class="btn-delete" plain size="small" icon="delete" :title="$t('btn.delete')" v-hasPermi="['mm:marb:delete']" @click="handleDelete(scope.row)"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="工厂" prop="werks">
              <el-select filterable clearable   v-model="form.werks"  :placeholder="$t('btn.selectPrefix')+'工厂'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="行业领域" prop="mbrsh">
              <el-select filterable clearable   v-model="form.mbrsh"  :placeholder="$t('btn.selectPrefix')+'行业领域'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="物料类型" prop="mtart">
              <el-select filterable clearable   v-model="form.mtart"  :placeholder="$t('btn.selectPrefix')+'物料类型'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="物料描述（短文本）" prop="maktx">
              <el-input v-model="form.maktx" :placeholder="$t('btn.enterPrefix')+'物料描述（短文本）'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="基本计量单位" prop="meins">
              <el-select filterable clearable   v-model="form.meins"  :placeholder="$t('btn.selectPrefix')+'基本计量单位'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="物料组" prop="matkl">
              <el-select filterable clearable   v-model="form.matkl"  :placeholder="$t('btn.selectPrefix')+'物料组'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="采购组" prop="ekgrp">
              <el-select filterable clearable   v-model="form.ekgrp"  :placeholder="$t('btn.selectPrefix')+'采购组'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="采购类型" prop="beskz">
              <el-select filterable clearable   v-model="form.beskz"  :placeholder="$t('btn.selectPrefix')+'采购类型'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="特殊采购类型" prop="sobsl">
              <el-select filterable clearable   v-model="form.sobsl"  :placeholder="$t('btn.selectPrefix')+'特殊采购类型'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="标识：散装物料" prop="schgt">
              <el-select filterable clearable   v-model="form.schgt"  :placeholder="$t('btn.selectPrefix')+'标识：散装物料'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="最小批量" prop="bstmi">
              <el-input-number v-model.number="form.bstmi" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'最小批量'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="采购订单数量的舍入值" prop="bstrf">
              <el-input-number v-model.number="form.bstrf" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'采购订单数量的舍入值'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="计划的天数内交货" prop="plifz">
              <el-input-number v-model.number="form.plifz" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'计划的天数内交货'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="厂内生产时间" prop="dzeit">
              <el-input-number v-model.number="form.dzeit" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'厂内生产时间'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="利润中心" prop="prctr">
              <el-select filterable clearable   v-model="form.prctr"  :placeholder="$t('btn.selectPrefix')+'利润中心'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="发货库存地点" prop="lgpro">
              <el-select filterable clearable   v-model="form.lgpro"  :placeholder="$t('btn.selectPrefix')+'发货库存地点'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="外部采购的缺省仓储位置" prop="lgfsb">
              <el-select filterable clearable   v-model="form.lgfsb"  :placeholder="$t('btn.selectPrefix')+'外部采购的缺省仓储位置'+$t('btn.selectSuffix')">
                <el-option
                  v-for="item in  options.sys_sloc_list" 
                  :key="item.dictValue" 
                  :label="item.dictLabel" 
          ...
          <el-col :lg="12">
            <el-form-item label="在工厂级标记要删除的物料" prop="lvorm">
              <el-select filterable clearable   v-model="form.lvorm"  :placeholder="$t('btn.selectPrefix')+'在工厂级标记要删除的物料'+$t('btn.selectSuffix')">
                <el-option
