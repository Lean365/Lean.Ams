  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="购买组织" prop="veOrg">
        <el-select filterable clearable   v-model="queryParams.veOrg" :placeholder="$t('btn.selectSearchPrefix')+'购买组织'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="行业类别" prop="veIndustryType">
        <el-select filterable clearable   v-model="queryParams.veIndustryType" :placeholder="$t('btn.selectSearchPrefix')+'行业类别'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="企业性质" prop="veEnterpriseNature">
        <el-select filterable clearable   v-model="queryParams.veEnterpriseNature" :placeholder="$t('btn.selectSearchPrefix')+'企业性质'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="供应商代码" prop="veCode">
        <el-input v-model="queryParams.veCode" :placeholder="$t('btn.enterSearchPrefix')+'供应商代码'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="供应商简称" prop="veAbbr">
        <el-input v-model="queryParams.veAbbr" :placeholder="$t('btn.enterSearchPrefix')+'供应商简称'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="供应商名称" prop="veName">
        <el-input v-model="queryParams.veName" :placeholder="$t('btn.enterSearchPrefix')+'供应商名称'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="税别" prop="veTaxType">
        <el-select filterable clearable   v-model="queryParams.veTaxType" :placeholder="$t('btn.selectSearchPrefix')+'税别'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="交易币种" prop="veCcy">
        <el-select filterable clearable   v-model="queryParams.veCcy" :placeholder="$t('btn.selectSearchPrefix')+'交易币种'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="付款条件" prop="vePayTerms">
        <el-select filterable clearable   v-model="queryParams.vePayTerms" :placeholder="$t('btn.selectSearchPrefix')+'付款条件'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="付款方式" prop="vePayMethod">
        <el-select filterable clearable   v-model="queryParams.vePayMethod" :placeholder="$t('btn.selectSearchPrefix')+'付款方式'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="统驭科目" prop="veRecAccount">
        <el-select filterable clearable   v-model="queryParams.veRecAccount" :placeholder="$t('btn.selectSearchPrefix')+'统驭科目'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="贸易条件" prop="veTradeTerms">
        <el-select filterable clearable   v-model="queryParams.veTradeTerms" :placeholder="$t('btn.selectSearchPrefix')+'贸易条件'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="装运条件" prop="veShippingTerms">
        <el-select filterable clearable   v-model="queryParams.veShippingTerms" :placeholder="$t('btn.selectSearchPrefix')+'装运条件'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="供应商等级" prop="veSupplierGrade">
        <el-select filterable clearable   v-model="queryParams.veSupplierGrade" :placeholder="$t('btn.selectSearchPrefix')+'供应商等级'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="供应商信用" prop="veSupplierCredit">
        <el-select filterable clearable   v-model="queryParams.veSupplierCredit" :placeholder="$t('btn.selectSearchPrefix')+'供应商信用'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="首次交易">
        <el-date-picker
          v-model="dateRangeVeFirstTransDate" 
          type="datetimerange"
      ...
      <el-form-item label="国家地区" prop="veRegionCode">
        <el-select filterable clearable   v-model="queryParams.veRegionCode" :placeholder="$t('btn.selectSearchPrefix')+'国家地区'+$t('btn.selectSearchSuffix')">
    ...
    <el-row :gutter="15" class="mb10">
      <el-col :span="1.5">
        <el-button class="btn-add" v-hasPermi="['mm:vendor:add']" plain icon="plus" @click="handleAdd">
          {{ $t('btn.add') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-edit" :disabled="single" v-hasPermi="['mm:vendor:edit']" plain icon="edit" @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-deletebatch" :disabled="multiple" v-hasPermi="['mm:vendor:delete']" plain icon="delete" @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData
                  templateUrl="Logistics/MmVendor/importTemplate"
                  importUrl="/Logistics/MmVendor/importData"
      ...
      <el-col :span="1.5">
        <el-button class="btn-export" plain icon="download" @click="handleExport" v-hasPermi="['mm:vendor:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="veOrg" label="购买组织" align="center" v-if="columns.showColumn('veOrg')">
        <template #default="scope">
          <dict-tag :options=" options.sys_plant_list " :value="scope.row.veOrg"  />
        </template>
      </el-table-column>
      ...
      <el-table-column prop="veTaxType" label="税别" align="center" v-if="columns.showColumn('veTaxType')">
        <template #default="scope">
          <dict-tag :options=" options.sys_tax_list " :value="scope.row.veTaxType"  />
        </template>
      </el-table-column>
      ...
      <el-table-column prop="veTradeTerms" label="贸易条件" align="center" v-if="columns.showColumn('veTradeTerms')">
        <template #default="scope">
          <dict-tag :options=" options.sys_terms_trade " :value="scope.row.veTradeTerms"  />
        </template>
      </el-table-column>
      <el-table-column prop="veShippingTerms" label="装运条件" align="center" v-if="columns.showColumn('veShippingTerms')">
        <template #default="scope">
          <dict-tag :options=" options.sys_cond_shipment " :value="scope.row.veShippingTerms"  />
        </template>
      </el-table-column>
      ...
      <el-table-column prop="veBankCountry" label="银行所在国" align="center" v-if="columns.showColumn('veBankCountry')">
        <template #default="scope">
          <dict-tag :options=" options.sys_country_list " :value="scope.row.veBankCountry"  />
        </template>
      </el-table-column>
      ...
      <el-table-column prop="veRegionCode" label="国家地区" align="center" v-if="columns.showColumn('veRegionCode')">
        <template #default="scope">
          <dict-tag :options=" options.sys_country_list " :value="scope.row.veRegionCode"  />
        </template>
      </el-table-column>
      ...
      <el-table-column :label="$t('btn.operation')" width="160" align="center">
        <template #default="scope">
          <el-button-group>
          <el-button class="btn-edit" plain size="small" icon="edit" :title="$t('btn.edit')" v-hasPermi="['mm:vendor:edit']" @click="handleUpdate(scope.row)"></el-button>
          <el-button class="btn-delete" plain size="small" icon="delete" :title="$t('btn.delete')" v-hasPermi="['mm:vendor:delete']" @click="handleDelete(scope.row)"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="SFID" prop="veSFID">
              <el-input v-model.number="form.veSFID" :placeholder="$t('btn.enterPrefix')+'SFID'+$t('btn.enterSuffix')" :disabled="opertype != 1"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="购买组织" prop="veOrg">
              <el-select filterable clearable   v-model="form.veOrg"  :placeholder="$t('btn.selectPrefix')+'购买组织'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="行业类别" prop="veIndustryType">
              <el-select filterable clearable   v-model="form.veIndustryType"  :placeholder="$t('btn.selectPrefix')+'行业类别'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="企业性质" prop="veEnterpriseNature">
              <el-select filterable clearable   v-model="form.veEnterpriseNature"  :placeholder="$t('btn.selectPrefix')+'企业性质'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="供应商代码" prop="veCode">
              <el-input v-model="form.veCode" :placeholder="$t('btn.enterPrefix')+'供应商代码'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="供应商简称" prop="veAbbr">
              <el-input v-model="form.veAbbr" :placeholder="$t('btn.enterPrefix')+'供应商简称'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="供应商名称" prop="veName">
              <el-input v-model="form.veName" :placeholder="$t('btn.enterPrefix')+'供应商名称'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="企业法人" prop="veEbe">
              <el-input v-model="form.veEbe" :placeholder="$t('btn.enterPrefix')+'企业法人'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="营业执照" prop="veBusinessNo">
              <el-input v-model="form.veBusinessNo" :placeholder="$t('btn.enterPrefix')+'营业执照'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="税号" prop="veTaxNo">
              <el-input v-model="form.veTaxNo" :placeholder="$t('btn.enterPrefix')+'税号'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="税别" prop="veTaxType">
              <el-select filterable clearable   v-model="form.veTaxType"  :placeholder="$t('btn.selectPrefix')+'税别'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="主营业务" prop="veMainBusiness">
              <el-input v-model="form.veMainBusiness" :placeholder="$t('btn.enterPrefix')+'主营业务'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="交易币种" prop="veCcy">
              <el-select filterable clearable   v-model="form.veCcy"  :placeholder="$t('btn.selectPrefix')+'交易币种'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="付款条件" prop="vePayTerms">
              <el-select filterable clearable   v-model="form.vePayTerms"  :placeholder="$t('btn.selectPrefix')+'付款条件'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="付款方式" prop="vePayMethod">
              <el-select filterable clearable   v-model="form.vePayMethod"  :placeholder="$t('btn.selectPrefix')+'付款方式'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="统驭科目" prop="veRecAccount">
              <el-select filterable clearable   v-model="form.veRecAccount"  :placeholder="$t('btn.selectPrefix')+'统驭科目'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="贸易条件" prop="veTradeTerms">
              <el-select filterable clearable   v-model="form.veTradeTerms"  :placeholder="$t('btn.selectPrefix')+'贸易条件'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="装运条件" prop="veShippingTerms">
              <el-select filterable clearable   v-model="form.veShippingTerms"  :placeholder="$t('btn.selectPrefix')+'装运条件'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="供应商等级" prop="veSupplierGrade">
              <el-select filterable clearable   v-model="form.veSupplierGrade"  :placeholder="$t('btn.selectPrefix')+'供应商等级'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="供应商信用" prop="veSupplierCredit">
              <el-select filterable clearable   v-model="form.veSupplierCredit"  :placeholder="$t('btn.selectPrefix')+'供应商信用'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="首次交易" prop="veFirstTransDate">
              <el-date-picker v-model="form.veFirstTransDate" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="末次交易" prop="veLastTransDate">
              <el-date-picker v-model="form.veLastTransDate" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行代码" prop="veBankCode">
              <el-input v-model="form.veBankCode" :placeholder="$t('btn.enterPrefix')+'银行代码'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行名称" prop="veBankName">
              <el-input v-model="form.veBankName" :placeholder="$t('btn.enterPrefix')+'银行名称'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="分行名称" prop="veBranchName">
              <el-input v-model="form.veBranchName" :placeholder="$t('btn.enterPrefix')+'分行名称'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行所在国" prop="veBankCountry">
              <el-select filterable clearable   v-model="form.veBankCountry"  :placeholder="$t('btn.selectPrefix')+'银行所在国'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="所在州省" prop="veBankState">
              <el-input v-model="form.veBankState" :placeholder="$t('btn.enterPrefix')+'所在州省'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="所在市" prop="veBankCity">
              <el-input v-model="form.veBankCity" :placeholder="$t('btn.enterPrefix')+'所在市'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="所在县" prop="veBankCounty">
              <el-input v-model="form.veBankCounty" :placeholder="$t('btn.enterPrefix')+'所在县'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行地址" prop="veBankAddr">
              <el-input v-model="form.veBankAddr" :placeholder="$t('btn.enterPrefix')+'银行地址'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行地址1" prop="veBankAddr1">
              <el-input v-model="form.veBankAddr1" :placeholder="$t('btn.enterPrefix')+'银行地址1'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行地址2" prop="veBankAddr2">
              <el-input v-model="form.veBankAddr2" :placeholder="$t('btn.enterPrefix')+'银行地址2'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行账号" prop="veBankAccount">
              <el-input v-model="form.veBankAccount" :placeholder="$t('btn.enterPrefix')+'银行账号'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="SWIFT代码" prop="veBankSwiftNo">
              <el-input v-model="form.veBankSwiftNo" :placeholder="$t('btn.enterPrefix')+'SWIFT代码'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="国家地区" prop="veRegionCode">
              <el-select filterable clearable   v-model="form.veRegionCode"  :placeholder="$t('btn.selectPrefix')+'国家地区'+$t('btn.selectSuffix')">
                <el-option
                  v-for="item in  options.sys_country_list" 
                  :key="item.dictValue" 
                  :label="item.dictLabel" 
          ...
          <el-col :lg="12">
            <el-form-item label="州省" prop="veState">
              <el-input v-model="form.veState" :placeholder="$t('btn.enterPrefix')+'州省'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="市" prop="veCity">
              <el-input v-model="form.veCity" :placeholder="$t('btn.enterPrefix')+'市'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="县" prop="veCounty">
              <el-input v-model="form.veCounty" :placeholder="$t('btn.enterPrefix')+'县'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="地址" prop="veAddr">
              <el-input v-model="form.veAddr" :placeholder="$t('btn.enterPrefix')+'地址'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="地址1" prop="veAddr1">
              <el-input v-model="form.veAddr1" :placeholder="$t('btn.enterPrefix')+'地址1'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="地址2" prop="veAddr2">
              <el-input v-model="form.veAddr2" :placeholder="$t('btn.enterPrefix')+'地址2'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="联系人" prop="veContacts">
              <el-input v-model="form.veContacts" :placeholder="$t('btn.enterPrefix')+'联系人'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="邮件" prop="veEmail">
              <el-input v-model="form.veEmail" :placeholder="$t('btn.enterPrefix')+'邮件'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="电话" prop="veTelNo">
              <el-input v-model="form.veTelNo" :placeholder="$t('btn.enterPrefix')+'电话'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="传真" prop="veFaxNp">
              <el-input v-model="form.veFaxNp" :placeholder="$t('btn.enterPrefix')+'传真'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="手机" prop="vePhoneNo">
              <el-input v-model="form.vePhoneNo" :placeholder="$t('btn.enterPrefix')+'手机'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
...
<script setup name="mmvendor">
  import '@/assets/styles/btn-custom.scss'
//后台操作函数
import { listMmVendor,
 addMmVendor, delMmVendor, 
 updateMmVendor,getMmVendor, 
 } 
from '@/api/logistics/mmvendor.js'
...
//是否查询（1是）
  veRecAccount: undefined,
//是否查询（1是）
  veTradeTerms: undefined,
//是否查询（1是）
  veShippingTerms: undefined,
//是否查询（1是）
  veSupplierGrade: undefined,
//是否查询（1是）
  veSupplierCredit: undefined,
//是否查询（1是）
  veFirstTransDate: undefined,
//是否查询（1是）
  veRegionCode: undefined,
//是否查询（1是）
  isFroze: undefined,
})
//字段显示控制
...
// 首次交易时间范围
const dateRangeVeFirstTransDate = ref([])
...
function getList(){
  proxy.addDateRange(queryParams, dateRangeVeFirstTransDate.value, 'VeFirstTransDate');
  loading.value = true
  listMmVendor(queryParams).then(res => {
    const { code, data } = res
    if (code == 200) {
...
function resetQuery(){
  // 首次交易时间范围
  dateRangeVeFirstTransDate.value = []
...
const state = reactive({
  ...
  form: {},
  rules: {
    veSFID: [{ required: true, message: "SFID"+proxy.$t('btn.isEmpty'), trigger: "blur" }],
    veOrg: [{ required: true, message: "购买组织"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    veIndustryType: [{ required: true, message: "行业类别"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    veEnterpriseNature: [{ required: true, message: "企业性质"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    veCode: [{ required: true, message: "供应商代码"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veAbbr: [{ required: true, message: "供应商简称"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veName: [{ required: true, message: "供应商名称"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veEbe: [{ required: true, message: "企业法人"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veBusinessNo: [{ required: true, message: "营业执照"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veTaxNo: [{ required: true, message: "税号"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veTaxType: [{ required: true, message: "税别"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    veMainBusiness: [{ required: true, message: "主营业务"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veCcy: [{ required: true, message: "交易币种"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    vePayTerms: [{ required: true, message: "付款条件"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    vePayMethod: [{ required: true, message: "付款方式"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    veRecAccount: [{ required: true, message: "统驭科目"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    veTradeTerms: [{ required: true, message: "贸易条件"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    veShippingTerms: [{ required: true, message: "装运条件"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    veBankCode: [{ required: true, message: "银行代码"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veBankName: [{ required: true, message: "银行名称"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veBankCountry: [{ required: true, message: "银行所在国"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    veBankState: [{ required: true, message: "所在州省"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veBankCity: [{ required: true, message: "所在市"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veBankCounty: [{ required: true, message: "所在县"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veBankAddr: [{ required: true, message: "银行地址"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veBankAccount: [{ required: true, message: "银行账号"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    veAddr: [{ required: true, message: "地址"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
...
function handleAdd() {
  ...
  form.value.veBankCountry= []
  form.value.veRegionCode= []
  ...
  proxy.$refs["formRef"].validate((valid) => {
    if (valid) {
      ...
      if (form.value.veSFID != undefined && opertype.value === 2) {
        updateMmVendor(form.value).then((res) => {
         proxy.$modal.msgSuccess(proxy.$t('common.tipEditSucceed'))
          open.value = false
          getList()
        })
      } else {
        addMmVendor(form.value).then((res) => {
...
function handleExport() {
  proxy
    .$confirm(proxy.$t('common.tipConfirmExport')+"<厂商信息.xlsx>", proxy.$t('btn.export')+' '+proxy.$t('common.tip'), {
      confirmButtonText: proxy.$t('btn.submit'),
      cancelButtonText: proxy.$t('btn.cancel'),
      type: "warning",
    })
    .then(async () => {
      await proxy.downFile('/Logistics/MmVendor/export', { ...queryParams })
    })
}
