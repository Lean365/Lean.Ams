...
<template>
  <div>
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :lg="24">
          ...
          <el-form-item label="生产批次" prop="mea004">
            <el-input v-model="queryParams.mea004"
              :placeholder="$t('btn.enterSearchPrefix')+'生产批次'+$t('btn.enterSearchSuffix')" />
          </el-form-item>
          <el-form-item label="生产机种" prop="mea005">
            <el-input v-model="queryParams.mea005"
              :placeholder="$t('btn.enterSearchPrefix')+'生产机种'+$t('btn.enterSearchSuffix')" />
          </el-form-item>
          <el-form-item label="生产日期">
            <el-date-picker v-model="dateRangeMea006" type="datetimerange" :start-placeholder="$t('btn.dateStart')"
          ...
          <el-form-item label="生产班组" prop="mea007">
            <el-input v-model="queryParams.mea007"
              :placeholder="$t('btn.enterSearchPrefix')+'生产班组'+$t('btn.enterSearchSuffix')" />
          </el-form-item>
        </el-col>
    ...
    <el-row :gutter="15" class="mb10">
      ...
      <el-col :span="1.5">
        <el-button class="btn-edit" :disabled="single" v-hasPermi="['pp:defectassyma:edit']" plain icon="edit"
          @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-deletebatch" :disabled="multiple" v-hasPermi="['pp:defectassyma:delete']" plain
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData templateUrl="Logistics/PpDefectAssyMa/importTemplate"
                  importUrl="/Logistics/PpDefectAssyMa/importData" @success="handleFileSuccess"></importData>
              </el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
      ...
      <el-col :span="1.5">
        <el-button class="btn-export" plain icon="download" @click="handleExport"
          v-hasPermi="['pp:defectassyma:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-table border height="600px" :data="dataList" v-loading="loading" ref="table"
      ...
      <el-table-column prop="mea004" label="生产批次" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mea004')" />
      <el-table-column prop="mea005" label="生产机种" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mea005')" />
      <el-table-column prop="mea006" label="生产日期" :show-overflow-tooltip="true" v-if="columns.showColumn('mea006')" />
      <el-table-column prop="mea007" label="生产班组" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mea007')" />
        ...
        <template #default="scope">
          <el-button-group>
            <el-button class="btn-edit" plain size="small" icon="edit" :title="$t('btn.edit')"
              v-hasPermi="['pp:defectassyma:edit']" @click="handleUpdate(scope.row)"></el-button>
            <el-button class="btn-delete" plain size="small" icon="delete" :title="$t('btn.delete')"
              v-hasPermi="['pp:defectassyma:delete']" @click="handleDelete(scope.row)"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" :fullscreen="fullScreen">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
        <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
          <el-tab-pane :label="$t('ptabs.basicInfo')" name="first">
            <el-row :gutter="20">
              ...
              <el-col :lg="12">
                <el-form-item label="生产订单" prop="mea002">
                  <el-select-v2 filterable clearable v-model="form.mea002"
                    :placeholder="$t('btn.selectPrefix')+'生产订单'+$t('btn.selectSuffix')"
                    :options="options.sql_moc_oph.map(item =>({label: item.dictLabel, value: item.dictValue}))">
                  </el-select-v2>
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="订单数量" prop="mea003">
                  <el-input-number v-model.number="form.mea003" :controls="true" controls-position="right"
                    :placeholder="$t('btn.enterPrefix')+'订单数量'+$t('btn.enterSuffix')" />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="生产批次" prop="mea004">
                  <el-input v-model="form.mea004" :placeholder="$t('btn.enterPrefix')+'生产批次'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="生产机种" prop="mea005">
                  <el-input v-model="form.mea005" :placeholder="$t('btn.enterPrefix')+'生产机种'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="20" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="生产日期" prop="mea006">
                  <el-date-picker v-model="form.mea006" type="datetime" :teleported="false"
              ...
              <el-col :lg="12">
                <el-form-item label="生产班组" prop="mea007">
                  <el-input v-model="form.mea007" :placeholder="$t('btn.enterPrefix')+'生产班组'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="20" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="生产实绩" prop="mea008">
                  <el-input-number v-model.number="form.mea008" :controls="true" controls-position="right"
                    :placeholder="$t('btn.enterPrefix')+'生产实绩'+$t('btn.enterSuffix')" />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="无不良数" prop="mea009">
                  <el-input-number v-model.number="form.mea009" :controls="true" controls-position="right"
                    :placeholder="$t('btn.enterPrefix')+'无不良数'+$t('btn.enterSuffix')" />
                </el-form-item>
              </el-col>
        ...
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button class="btn-delete" icon="Delete" @click="handleDeletePpDefectAssySlv">{{ $t('btn.delete')
              }}</el-button>
          </el-col>
          <el-col :span="1.5">
        ...
        <el-table :data="ppDefectAssySlvList" :row-class-name="rowPpDefectAssySlvIndex"
          @selection-change="handlePpDefectAssySlvSelectionChange" ref="PpDefectAssySlvRef">
          <el-table-column type="selection" width="40" align="center" />
          <el-table-column :label="$t('layout.indexNo')" align="center" prop="index" width="50" />
          <el-table-column label="不良类别" prop="mfa003">
            <template #default="scope">
              <el-select filterable clearable v-model="scope.row.mfa003"
                :placeholder="$t('btn.enterPrefix')+'不良类别'+$t('btn.enterSuffix')">
                <el-option v-for="item in options.sql_bad_dist" :key="item.dictValue" :label="item.dictLabel"
          ...
          <el-table-column label="不良数量" align="center" prop="mfa004" width="140">
            <template #default="scope">
              <el-input-number v-model="scope.row.mfa004" controls-position="right"
                :placeholder="$t('btn.enterPrefix')+'不良数量'+$t('btn.enterSuffix')" />
            </template>
          </el-table-column>
          <el-table-column label="不良总数" align="center" prop="mfa005" width="140">
            <template #default="scope">
              <el-input-number v-model="scope.row.mfa005" controls-position="right"
                :placeholder="$t('btn.enterPrefix')+'不良总数'+$t('btn.enterSuffix')" />
            </template>
          </el-table-column>
