...
<template>
  <div>
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :lg="24">
          <el-form-item label="班组类别" prop="plLineType">
            <el-select filterable clearable v-model="queryParams.plLineType"
              :placeholder="$t('btn.selectSearchPrefix')+'班组类别'+$t('btn.selectSearchSuffix')">
          ...
          <el-form-item label="班组代码" prop="plLineCode">
            <el-input v-model="queryParams.plLineCode"
              :placeholder="$t('btn.enterSearchPrefix')+'班组代码'+$t('btn.enterSearchSuffix')" />
          </el-form-item>
          <el-form-item label="班组名称" prop="plLineName">
            <el-input v-model="queryParams.plLineName"
              :placeholder="$t('btn.enterSearchPrefix')+'班组名称'+$t('btn.enterSearchSuffix')" />
          </el-form-item>
        </el-col>
    ...
    <el-row :gutter="15" class="mb10">
      ...
      <el-col :span="1.5">
        <el-button class="btn-edit" :disabled="single" v-hasPermi="['pp:line:edit']" plain icon="edit"
          @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-deletebatch" :disabled="multiple" v-hasPermi="['pp:line:delete']" plain icon="delete"
          @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData templateUrl="Logistics/PpLine/importTemplate" importUrl="/Logistics/PpLine/importData"
        ...
        <template #default="scope">
          <el-button-group>
            <el-button class="btn-edit" plain size="small" icon="edit" :title="$t('btn.edit')"
              v-hasPermi="['pp:line:edit']" @click="handleUpdate(scope.row)"></el-button>
            ...
            <el-row :gutter="20">
              ...
              <!-- <el-col :lg="12">
                <el-form-item label="SFID" prop="plSFID">
                  <el-input v-model.number="form.plSFID"
              ...
              <el-col :lg="12">
                <el-form-item label="班组类别" prop="plLineType">
                  <el-select filterable clearable v-model="form.plLineType"
                    :placeholder="$t('btn.selectPrefix')+'班组类别'+$t('btn.selectSuffix')">
                    <el-option v-for="item in  options.sys_line_type" :key="item.dictValue" :label="item.dictLabel"
              ...
              <el-col :lg="12">
                <el-form-item label="班组代码" prop="plLineCode">
                  <el-input v-model="form.plLineCode"
                    :placeholder="$t('btn.enterPrefix')+'班组代码'+$t('btn.enterSuffix')" />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="语言Key" prop="plLineLangCode">
                  <el-input v-model="form.plLineLangCode"
              ...
              <el-col :lg="12">
                <el-form-item label="班组名称" prop="plLineName">
                  <el-input v-model="form.plLineName"
                    :placeholder="$t('btn.enterPrefix')+'班组名称'+$t('btn.enterSuffix')" />
                </el-form-item>
              </el-col>
  ...
  const state = reactive({
    ...
    rules: {
      ...
      plLineLangCode: [
        ...
        { required: true, message: "语言Key" + proxy.$t('btn.isEmpty'), trigger: "blur" }
      ],
