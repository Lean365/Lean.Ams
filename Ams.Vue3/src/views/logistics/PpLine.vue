    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent
      ...
      <el-form-item label="班组类别" prop="plLineType">
        <el-select filterable clearable remote remote-show-suffix :remote-method="remoteMethod" :loading="loading "
          v-model="queryParams.plLineType" :placeholder="$t('btn.select')+'班组类别'">
          <el-option v-for="item in   remotequery_sys_line_type " :key="item.dictValue" :label="item.dictLabel"
            ...
            <el-row :gutter="20">
              ...
              <el-col :lg="12">
                <el-form-item label="SFID" prop="plSFID">
                  <el-input v-model.number="form.plSFID" :placeholder="$t('btn.enter')+'SFID'"
                    :disabled="opertype != 1" />
                </el-form-item>
              </el-col>
