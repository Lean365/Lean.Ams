  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      <el-form-item label="生产工厂" prop="moPlant">
        <el-select filterable clearable   v-model="queryParams.moPlant" :placeholder="$t('btn.selectPrefix')+'生产工厂'+$t('btn.selectSuffix')">
      ...
      <el-form-item label="订单类型" prop="moOrderType">
        <el-select filterable clearable   v-model="queryParams.moOrderType" :placeholder="$t('btn.selectPrefix')+'订单类型'+$t('btn.selectSuffix')">
      ...
      <el-form-item label="生产订单" prop="moOrderNo">
        <el-input v-model="queryParams.moOrderNo" :placeholder="$t('btn.enterPrefix')+'生产订单'+$t('btn.enterSuffix')" />
      </el-form-item>
      <el-form-item label="物料" prop="moOrderItem">
        <el-select filterable clearable   remote remote-show-suffix :remote-method="remoteMethod" :loading="loading " v-model="queryParams.moOrderItem" :placeholder="$t('btn.selectPrefix')+'物料'+$t('btn.selectSuffix')">
      ...
      <el-form-item label="批次" prop="moOrderlot">
        <el-input v-model="queryParams.moOrderlot" :placeholder="$t('btn.enterPrefix')+'批次'+$t('btn.enterSuffix')" />
      </el-form-item>
    ...
    <el-row :gutter="15" class="mb10">
      <el-col :span="1.5">
        <el-button type="add" v-hasPermi="['pp:order:add']" plain icon="plus" @click="handleAdd">
          {{ $t('btn.add') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="edit" :disabled="single" v-hasPermi="['pp:order:edit']" plain icon="edit" @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="deletebatch" :disabled="multiple" v-hasPermi="['pp:order:delete']" plain icon="delete" @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-button type="export" plain icon="download" @click="handleExport" v-hasPermi="['pp:order:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-table border height="650"
      ...
      <el-table-column :label="$t('btn.operation')" width="160" align="center">
        <template #default="scope">
          <el-button-group>
          <el-button type="edit" plain size="small" icon="edit" :title="$t('btn.edit')" v-hasPermi="['pp:order:edit']" @click="handleUpdate(scope.row)"></el-button>
          <el-button type="delete" plain size="small" icon="delete" :title="$t('btn.delete')" v-hasPermi="['pp:order:delete']" @click="handleDelete(scope.row)"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="物料" prop="moOrderItem">
              ...
              :loading="loading " v-model="form.moOrderItem"  :placeholder="$t('btn.selectPrefix')+'物料'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="状态" prop="isStated">
              <el-input-number v-model.number="form.isStated" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'状态'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
...
const state = reactive({
  ...
  rules: {
    ...
    isStated: [{ required: true, message: "状态"+proxy.$t('btn.isEmpty'), trigger: "blur"    , type: "number"  }],
  },
  options: {
