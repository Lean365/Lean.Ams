...
<template>
  <div>
    ...
    <el-row :gutter="15" class="mb10">
      ...
      <el-col :span="1.5">
        <el-button class="btn-edit" :disabled="single" v-hasPermi="['pp:outputassyma:edit']" plain icon="edit" @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-deletebatch" :disabled="multiple" v-hasPermi="['pp:outputassyma:delete']" plain icon="delete" @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData
                  templateUrl="Logistics/PpOutputAssyMa/importTemplate"
                  importUrl="/Logistics/PpOutputAssyMa/importData"
      ...
      <el-col :span="1.5">
        <el-button class="btn-export" plain icon="download" @click="handleExport" v-hasPermi="['pp:outputassyma:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-table border height="600px"
      ...
      <el-table-column :label="$t('btn.operation')" width="160" align="center">
        <template #default="scope">
          <el-button-group>
          <el-button class="btn-edit" plain size="small" icon="edit" :title="$t('btn.edit')" v-hasPermi="['pp:outputassyma:edit']" @click="handleUpdate(scope.row)"></el-button>
          <el-button class="btn-delete" plain size="small" icon="delete" :title="$t('btn.delete')" v-hasPermi="['pp:outputassyma:delete']" @click="handleDelete(scope.row)"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
    ...
    <!-- 子表信息 -->
        ...
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button class="btn-delete" icon="Delete" @click="handleDeletePpOutputAssySlv">{{ $t('btn.delete') }}</el-button>
          </el-col>
          <el-col :span="1.5">
        ...
        <el-table :data="ppOutputAssySlvList" :row-class-name="rowPpOutputAssySlvIndex" @selection-change="handlePpOutputAssySlvSelectionChange" ref="PpOutputAssySlvRef">
          ...
          <el-table-column label="停线" prop="mmb005">
            <template #default="scope">
              <el-select filterable clearable multiple collapse-tags collapse-tags-tooltip v-model="scope.row.mmb005" :placeholder="$t('btn.enterPrefix')+'停线'+$t('btn.enterSuffix')">
                <el-option
          ...
          <el-table-column label="未达成" prop="mmb007">
            <template #default="scope">
              <el-select filterable clearable multiple collapse-tags collapse-tags-tooltip v-model="scope.row.mmb007" :placeholder="$t('btn.enterPrefix')+'未达成'+$t('btn.enterSuffix')">
                <el-option
