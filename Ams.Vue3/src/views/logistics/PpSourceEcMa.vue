  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="设变No." prop="zpabdz001">
        <el-input v-model="queryParams.zpabdz001" :placeholder="$t('btn.enterSearchPrefix')+'设变No.'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="标题" prop="zpabdz003">
        <el-input v-model="queryParams.zpabdz003" :placeholder="$t('btn.enterSearchPrefix')+'标题'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="状态" prop="zpabdz004">
        <el-select filterable clearable   v-model="queryParams.zpabdz004" :placeholder="$t('btn.selectSearchPrefix')+'状态'+$t('btn.selectSearchSuffix')">
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="zpabdz001" label="设变No." align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz001')"/>
      <el-table-column prop="zpabdz002" label="机种" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz002')"/>
      <el-table-column prop="zpabdz003" label="标题" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz003')"/>
      ...
      <el-table-column prop="zpabdz005" label="发行日" :show-overflow-tooltip="true"  v-if="columns.showColumn('zpabdz005')"/>
      <el-table-column prop="zpabdz006" label="担当" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz006')"/>
      <el-table-column prop="zpabdz007" label="依赖" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz007')"/>
      <el-table-column prop="zpabdz008" label="会议" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz008')"/>
      <el-table-column prop="zpabdz009" label="PP番号" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz009')"/>
      <el-table-column prop="zpabdz010" label="联络书" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz010')"/>
      <el-table-column prop="zpabdz011" label="实施" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz011')"/>
      <el-table-column prop="zpabdz012" label="主理由" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz012')"/>
      <el-table-column prop="zpabdz013" label="次理由" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz013')"/>
      <el-table-column prop="zpabdz014" label="安规" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz014')"/>
      <el-table-column prop="zpabdz015" label="状况" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz015')"/>
      <el-table-column prop="zpabdz016" label="机番" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz016')"/>
      <el-table-column prop="zpabdz017" label="承认" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz017')"/>
      <el-table-column prop="zpabdz018" label="服务手册订正" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz018')"/>
      <el-table-column prop="zpabdz019" label="用户手册订正" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz019')"/>
      <el-table-column prop="zpabdz020" label="宣传手册订正" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz020')"/>
      <el-table-column prop="zpabdz021" label="SOP订正" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz021')"/>
      <el-table-column prop="zpabdz022" label="信息发行" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz022')"/>
      <el-table-column prop="zpabdz023" label="成本变动" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz023')"/>
      ...
      <el-table-column prop="zpabdz026" label="图纸" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz026')"/>
      <el-table-column prop="zpabdz027" label="设变内容" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabdz027')"/>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12" v-if="opertype != 1">
            <el-form-item label="SFID" prop="sfid">
              <el-input-number v-model.number="form.sfid" controls-position="right" :placeholder="$t('btn.enterPrefix')+'SFID'+$t('btn.enterSuffix')" :disabled="true"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="设变No." prop="zpabdz001">
              <el-input v-model="form.zpabdz001" :placeholder="$t('btn.enterPrefix')+'设变No.'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="状态" prop="zpabdz004">
              <el-select filterable clearable   v-model="form.zpabdz004"  :placeholder="$t('btn.selectPrefix')+'状态'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="发行日" prop="zpabdz005">
              <el-date-picker v-model="form.zpabdz005" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="PP番号" prop="zpabdz009">
              <el-input v-model="form.zpabdz009" :placeholder="$t('btn.enterPrefix')+'PP番号'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="服务手册订正" prop="zpabdz018">
              <el-input v-model="form.zpabdz018" :placeholder="$t('btn.enterPrefix')+'服务手册订正'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="用户手册订正" prop="zpabdz019">
              <el-input v-model="form.zpabdz019" :placeholder="$t('btn.enterPrefix')+'用户手册订正'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="宣传手册订正" prop="zpabdz020">
              <el-input v-model="form.zpabdz020" :placeholder="$t('btn.enterPrefix')+'宣传手册订正'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="SOP订正" prop="zpabdz021">
              <el-input v-model="form.zpabdz021" :placeholder="$t('btn.enterPrefix')+'SOP订正'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="信息发行" prop="zpabdz022">
              <el-input v-model="form.zpabdz022" :placeholder="$t('btn.enterPrefix')+'信息发行'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="成本变动" prop="zpabdz023">
              <el-input v-model="form.zpabdz023" :placeholder="$t('btn.enterPrefix')+'成本变动'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="单位成本" prop="zpabdz024">
              <el-input-number v-model.number="form.zpabdz024" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'单位成本'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="模具改造费" prop="zpabdz025">
              <el-input-number v-model.number="form.zpabdz025" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'模具改造费'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="24">
            <el-form-item label="设变内容" prop="zpabdz027">
              <el-input type="textarea" v-model="form.zpabdz027" :placeholder="$t('btn.enterPrefix')+'设变内容'+$t('btn.enterSuffix')"/>
            </el-form-item>
          </el-col>
    ...
    <!-- 子表信息 -->
        ...
        <el-table :data="ppSourceEcSlvList" :row-class-name="rowPpSourceEcSlvIndex" @selection-change="handlePpSourceEcSlvSelectionChange" ref="PpSourceEcSlvRef">
          ...
          <el-table-column label="设变No." align="center" prop="zpabds001">
            <template #default="scope">
              <el-input v-model="scope.row.zpabds001" :placeholder="$t('btn.enterPrefix')+'设变No.'+$t('btn.enterSuffix')" />
            </template>
          </el-table-column>
          <el-table-column label="完成品" align="center" prop="zpabds002">
            <template #default="scope">
              <el-input v-model="scope.row.zpabds002" :placeholder="$t('btn.enterPrefix')+'完成品'+$t('btn.enterSuffix')" />
            </template>
          </el-table-column>
          ...
          <el-table-column label="旧物料" align="center" prop="zpabds004">
            <template #default="scope">
              <el-input v-model="scope.row.zpabds004" :placeholder="$t('btn.enterPrefix')+'旧物料'+$t('btn.enterSuffix')" />
            </template>
          </el-table-column>
          ...
          <el-table-column label="数量" align="center" prop="zpabds006" width="140">
            <template #default="scope">
              <el-input-number v-model="scope.row.zpabds006" controls-position="right" :placeholder="$t('btn.enterPrefix')+'数量'+$t('btn.enterSuffix')" />
            </template>
          </el-table-column>
          ...
          <el-table-column label="新物料" align="center" prop="zpabds008">
            <template #default="scope">
              <el-input v-model="scope.row.zpabds008" :placeholder="$t('btn.enterPrefix')+'新物料'+$t('btn.enterSuffix')" />
            </template>
          </el-table-column>
          ...
          <el-table-column label="数量" align="center" prop="zpabds010" width="140">
            <template #default="scope">
              <el-input-number v-model="scope.row.zpabds010" controls-position="right" :placeholder="$t('btn.enterPrefix')+'数量'+$t('btn.enterSuffix')" />
            </template>
          </el-table-column>
          ...
          <el-table-column label="BOM番号" align="center" prop="zpabds012">
            <template #default="scope">
              <el-input v-model="scope.row.zpabds012" :placeholder="$t('btn.enterPrefix')+'BOM番号'+$t('btn.enterSuffix')" />
            </template>
          </el-table-column>
          <el-table-column label="互换性" align="center" prop="zpabds013">
            <template #default="scope">
              <el-input v-model="scope.row.zpabds013" :placeholder="$t('btn.enterPrefix')+'互换性'+$t('btn.enterSuffix')" />
            </template>
          </el-table-column>
          ...
          <el-table-column label="安排指示" align="center" prop="zpabds015">
            <template #default="scope">
              <el-input v-model="scope.row.zpabds015" :placeholder="$t('btn.enterPrefix')+'安排指示'+$t('btn.enterSuffix')" />
            </template>
          </el-table-column>
          <el-table-column label="旧品处理" align="center" prop="zpabds016">
            <template #default="scope">
              <el-input v-model="scope.row.zpabds016" :placeholder="$t('btn.enterPrefix')+'旧品处理'+$t('btn.enterSuffix')" />
            </template>
          </el-table-column>
          <el-table-column label="BOM生效" align="center" prop="zpabds017">
            <template #default="scope">
              <el-date-picker clearable v-model="scope.row.zpabds017" type="date" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </template>
          </el-table-column>
          <el-table-column label="处理标记" prop="isSolved">
            <template #default="scope">
              <el-select filterable clearable  v-model="scope.row.isSolved" :placeholder="$t('btn.enterPrefix')+'处理标记'+$t('btn.enterSuffix')">
                <el-option
