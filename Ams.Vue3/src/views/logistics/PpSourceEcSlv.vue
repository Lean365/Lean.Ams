  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="设变No." prop="zpabds001">
        <el-input v-model="queryParams.zpabds001" :placeholder="$t('btn.enterSearchPrefix')+'设变No.'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="完成品" prop="zpabds002">
        <el-input v-model="queryParams.zpabds002" :placeholder="$t('btn.enterSearchPrefix')+'完成品'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="上阶" prop="zpabds003">
        <el-input v-model="queryParams.zpabds003" :placeholder="$t('btn.enterSearchPrefix')+'上阶'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="旧物料" prop="zpabds004">
        <el-input v-model="queryParams.zpabds004" :placeholder="$t('btn.enterSearchPrefix')+'旧物料'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="新物料" prop="zpabds008">
        <el-input v-model="queryParams.zpabds008" :placeholder="$t('btn.enterSearchPrefix')+'新物料'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="zpabds001" label="设变No." align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds001')"/>
      <el-table-column prop="zpabds002" label="完成品" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds002')"/>
      <el-table-column prop="zpabds003" label="上阶" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds003')"/>
      <el-table-column prop="zpabds004" label="旧物料" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds004')"/>
      <el-table-column prop="zpabds005" label="品名" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds005')"/>
      <el-table-column prop="zpabds006" label="数量" align="center" v-if="columns.showColumn('zpabds006')"/>
      <el-table-column prop="zpabds007" label="位置" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds007')"/>
      <el-table-column prop="zpabds008" label="新物料" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds008')"/>
      <el-table-column prop="zpabds009" label="品名" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds009')"/>
      <el-table-column prop="zpabds010" label="数量" align="center" v-if="columns.showColumn('zpabds010')"/>
      <el-table-column prop="zpabds011" label="位置" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds011')"/>
      <el-table-column prop="zpabds012" label="BOM番号" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds012')"/>
      <el-table-column prop="zpabds013" label="互换性" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds013')"/>
      <el-table-column prop="zpabds014" label="区分" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds014')"/>
      <el-table-column prop="zpabds015" label="安排指示" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds015')"/>
      <el-table-column prop="zpabds016" label="旧品处理" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpabds016')"/>
      <el-table-column prop="zpabds017" label="BOM生效" :show-overflow-tooltip="true"  v-if="columns.showColumn('zpabds017')"/>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="父ID" prop="parentSfid">
              <el-input v-model.number="form.parentSfid" :placeholder="$t('btn.enterPrefix')+'父ID'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="设变No." prop="zpabds001">
              <el-input v-model="form.zpabds001" :placeholder="$t('btn.enterPrefix')+'设变No.'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="数量" prop="zpabds006">
              <el-input-number v-model.number="form.zpabds006" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'数量'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="数量" prop="zpabds010">
              <el-input-number v-model.number="form.zpabds010" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'数量'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="BOM番号" prop="zpabds012">
              <el-input v-model="form.zpabds012" :placeholder="$t('btn.enterPrefix')+'BOM番号'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="安排指示" prop="zpabds015">
              <el-input v-model="form.zpabds015" :placeholder="$t('btn.enterPrefix')+'安排指示'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="旧品处理" prop="zpabds016">
              <el-input v-model="form.zpabds016" :placeholder="$t('btn.enterPrefix')+'旧品处理'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="BOM生效" prop="zpabds017">
              <el-date-picker v-model="form.zpabds017" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>
