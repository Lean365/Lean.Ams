  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="工厂" prop="zpbldz001">
        <el-select filterable clearable   v-model="queryParams.zpbldz001" :placeholder="$t('btn.selectSearchPrefix')+'工厂'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="物料" prop="zpbldz002">
        <el-select filterable clearable   remote remote-show-suffix :remote-method="remoteMethod" :loading="loading " v-model="queryParams.zpbldz002" :placeholder="$t('btn.selectSearchPrefix')+'物料'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="工作中心" prop="zpbldz003">
        <el-select filterable clearable   v-model="queryParams.zpbldz003" :placeholder="$t('btn.selectSearchPrefix')+'工作中心'+$t('btn.selectSearchSuffix')">
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="zpbldz004" label="工作中心描述" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpbldz004')"/>
      <el-table-column prop="zpbldz005" label="标准值" align="center" v-if="columns.showColumn('zpbldz005')"/>
      <el-table-column prop="zpbldz006" label="单位" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpbldz006')"/>
      <el-table-column prop="zpbldz007" label="标准值" align="center" v-if="columns.showColumn('zpbldz007')"/>
      <el-table-column prop="zpbldz008" label="单位" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zpbldz008')"/>
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="工厂" prop="zpbldz001">
              <el-select filterable clearable   v-model="form.zpbldz001"  :placeholder="$t('btn.selectPrefix')+'工厂'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="物料" prop="zpbldz002">
              ...
              :loading="loading " v-model="form.zpbldz002"  :placeholder="$t('btn.selectPrefix')+'物料'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="工作中心" prop="zpbldz003">
              <el-select filterable clearable   v-model="form.zpbldz003"  :placeholder="$t('btn.selectPrefix')+'工作中心'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="工作中心描述" prop="zpbldz004">
              <el-input v-model="form.zpbldz004" :placeholder="$t('btn.enterPrefix')+'工作中心描述'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="标准值" prop="zpbldz005">
              <el-input-number v-model.number="form.zpbldz005" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'标准值'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="标准值" prop="zpbldz007">
              <el-input-number v-model.number="form.zpbldz007" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'标准值'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
