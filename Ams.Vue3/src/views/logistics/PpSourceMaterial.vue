  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="品目" prop="zcadz002">
        <el-input v-model="queryParams.zcadz002" :placeholder="$t('btn.enterSearchPrefix')+'品目'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="行业领域" prop="zcadz003">
        <el-select filterable clearable   v-model="queryParams.zcadz003" :placeholder="$t('btn.selectSearchPrefix')+'行业领域'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="物料类型" prop="zcadz004">
        <el-select filterable clearable   v-model="queryParams.zcadz004" :placeholder="$t('btn.selectSearchPrefix')+'物料类型'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="物料描述（短文本）" prop="zcadz005">
        <el-input v-model="queryParams.zcadz005" :placeholder="$t('btn.enterSearchPrefix')+'物料描述（短文本）'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="基本单位" prop="zcadz006">
        <el-select filterable clearable   v-model="queryParams.zcadz006" :placeholder="$t('btn.selectSearchPrefix')+'基本单位'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="物料组" prop="zcadz008">
        <el-select filterable clearable   v-model="queryParams.zcadz008" :placeholder="$t('btn.selectSearchPrefix')+'物料组'+$t('btn.selectSearchSuffix')">
          <el-option v-for="item in   options.sys_matl_group " :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
            <span class="fl">{{ item.dictLabel }}</span>
            <span class="fr" style="color: var(--el-text-color-secondary);">{{ item.dictValue }}</span>          
          </el-option>
        </el-select>
      ...
      <el-form-item label="采购组" prop="zcadz009">
        <el-select filterable clearable   v-model="queryParams.zcadz009" :placeholder="$t('btn.selectSearchPrefix')+'采购组'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="采购类型" prop="zcadz010">
        <el-select filterable clearable   v-model="queryParams.zcadz010" :placeholder="$t('btn.selectSearchPrefix')+'采购类型'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="特殊采购类" prop="zcadz011">
        <el-select filterable clearable   v-model="queryParams.zcadz011" :placeholder="$t('btn.selectSearchPrefix')+'特殊采购类'+$t('btn.selectSearchSuffix')">
          <el-option v-for="item in   options.sys_pur_spec " :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
            <span class="fl">{{ item.dictLabel }}</span>
            <span class="fr" style="color: var(--el-text-color-secondary);">{{ item.dictValue }}</span>          
          </el-option>
        </el-select>
      ...
      <el-form-item label="过账检验" prop="zcadz019">
        <el-radio-group v-model="queryParams.zcadz019">
          ...
          <el-radio v-for="item in  options.sys_normal_whether " :key="item.dictValue" :value="item.dictValue">{{item.dictLabel}}</el-radio>
        </el-radio-group>
      </el-form-item>
      ...
      <el-form-item label="评估类" prop="zcadz025">
        <el-select filterable clearable   v-model="queryParams.zcadz025" :placeholder="$t('btn.selectSearchPrefix')+'评估类'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="币种" prop="zcadz027">
        <el-select filterable clearable   v-model="queryParams.zcadz027" :placeholder="$t('btn.selectSearchPrefix')+'币种'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="生产仓储" prop="zcadz030">
        <el-select filterable clearable   v-model="queryParams.zcadz030" :placeholder="$t('btn.selectSearchPrefix')+'生产仓储'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="采购仓储" prop="zcadz031">
        <el-select filterable clearable   v-model="queryParams.zcadz031" :placeholder="$t('btn.selectSearchPrefix')+'采购仓储'+$t('btn.selectSearchSuffix')">
          <el-option v-for="item in   options.sys_sloc_list " :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
            <span class="fl">{{ item.dictLabel }}</span>
            <span class="fr" style="color: var(--el-text-color-secondary);">{{ item.dictValue }}</span>          
          </el-option>
      ...
      <el-form-item label="库存仓位" prop="zcadz032">
        <el-input v-model="queryParams.zcadz032" :placeholder="$t('btn.enterSearchPrefix')+'库存仓位'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="状态" prop="zcadz034">
        <el-radio-group v-model="queryParams.zcadz034">
          <el-radio>{{$t('common.all')}}</el-radio>
          <el-radio v-for="item in  options.sys_eol_list " :key="item.dictValue" :value="item.dictValue">{{item.dictLabel}}</el-radio>
        </el-radio-group>
      </el-form-item>
        </el-col>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="zcadz002" label="品目" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zcadz002')"/>
      ...
      <el-table-column prop="zcadz005" label="物料描述（短文本）" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zcadz005')"/>
      ...
      <el-table-column prop="zcadz007" label="产品层次" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zcadz007')"/>
      ...
      <el-table-column prop="zcadz014" label="基本单位" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zcadz014')"/>
      <el-table-column prop="zcadz015" label="舍入值" align="center" v-if="columns.showColumn('zcadz015')"/>
      <el-table-column prop="zcadz016" label="基本单位" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zcadz016')"/>
      <el-table-column prop="zcadz017" label="计划交货" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zcadz017')"/>
      ...
      <el-table-column prop="zcadz020" label="利润中心" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zcadz020')"/>
      <el-table-column prop="zcadz021" label="差异码" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zcadz021')"/>
      ...
      <el-table-column prop="zcadz023" label="制造商零件编号" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zcadz023')"/>
      <el-table-column prop="zcadz024" label="制造商编号" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zcadz024')"/>
      ...
      <el-table-column prop="zcadz028" label="价格控制" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zcadz028')"/>
      <el-table-column prop="zcadz029" label="价格单位" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zcadz029')"/>
      ...
      <el-table-column prop="zcadz032" label="库存仓位" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('zcadz032')"/>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="Sfid" prop="sfid">
              <el-input v-model.number="form.sfid" :placeholder="$t('btn.enterPrefix')+'Sfid'+$t('btn.enterSuffix')" :disabled="opertype != 1"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="Plnt" prop="zcadz001">
              <el-select filterable clearable   v-model="form.zcadz001"  :placeholder="$t('btn.selectPrefix')+'Plnt'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="行业领域" prop="zcadz003">
              <el-select filterable clearable   v-model="form.zcadz003"  :placeholder="$t('btn.selectPrefix')+'行业领域'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="物料类型" prop="zcadz004">
              <el-select filterable clearable   v-model="form.zcadz004"  :placeholder="$t('btn.selectPrefix')+'物料类型'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="物料描述（短文本）" prop="zcadz005">
              <el-input v-model="form.zcadz005" :placeholder="$t('btn.enterPrefix')+'物料描述（短文本）'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="基本单位" prop="zcadz006">
              <el-select filterable clearable   v-model="form.zcadz006"  :placeholder="$t('btn.selectPrefix')+'基本单位'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="物料组" prop="zcadz008">
              <el-select filterable clearable   v-model="form.zcadz008"  :placeholder="$t('btn.selectPrefix')+'物料组'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="采购组" prop="zcadz009">
              <el-select filterable clearable   v-model="form.zcadz009"  :placeholder="$t('btn.selectPrefix')+'采购组'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="采购类型" prop="zcadz010">
              <el-select filterable clearable   v-model="form.zcadz010"  :placeholder="$t('btn.selectPrefix')+'采购类型'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="特殊采购类" prop="zcadz011">
              <el-select filterable clearable   v-model="form.zcadz011"  :placeholder="$t('btn.selectPrefix')+'特殊采购类'+$t('btn.selectSuffix')">
                <el-option
                  v-for="item in  options.sys_pur_spec" 
                  :key="item.dictValue" 
                  :label="item.dictLabel" 
                  :value="item.dictValue"></el-option>
              </el-select>
          ...
          <el-col :lg="12">
            <el-form-item label="散装物料" prop="zcadz012">
              <el-select filterable clearable   v-model="form.zcadz012"  :placeholder="$t('btn.selectPrefix')+'散装物料'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="最小起订量" prop="zcadz013">
              <el-input-number v-model.number="form.zcadz013" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'最小起订量'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="舍入值" prop="zcadz015">
              <el-input-number v-model.number="form.zcadz015" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'舍入值'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="自制天数" prop="zcadz018">
              <el-input-number v-model.number="form.zcadz018" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'自制天数'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="制造商零件编号" prop="zcadz023">
              <el-input v-model="form.zcadz023" :placeholder="$t('btn.enterPrefix')+'制造商零件编号'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="制造商编号" prop="zcadz024">
              <el-input v-model="form.zcadz024" :placeholder="$t('btn.enterPrefix')+'制造商编号'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="评估类" prop="zcadz025">
              <el-select filterable clearable   v-model="form.zcadz025"  :placeholder="$t('btn.selectPrefix')+'评估类'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="移动平均价格/周期单价" prop="zcadz026">
              <el-input-number v-model.number="form.zcadz026" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'移动平均价格/周期单价'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="币种" prop="zcadz027">
              <el-select filterable clearable   v-model="form.zcadz027"  :placeholder="$t('btn.selectPrefix')+'币种'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="生产仓储" prop="zcadz030">
              <el-select filterable clearable   v-model="form.zcadz030"  :placeholder="$t('btn.selectPrefix')+'生产仓储'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="采购仓储" prop="zcadz031">
              <el-select filterable clearable   v-model="form.zcadz031"  :placeholder="$t('btn.selectPrefix')+'采购仓储'+$t('btn.selectSuffix')">
                <el-option
                  v-for="item in  options.sys_sloc_list" 
                  :key="item.dictValue" 
                  :label="item.dictLabel" 
          ...
          <el-col :lg="12">
            <el-form-item label="库存" prop="zcadz033">
              <el-input-number v-model.number="form.zcadz033" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'库存'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="24">
            <el-form-item label="备注说明" prop="remark">
              <el-input type="textarea" v-model="form.remark" :placeholder="$t('btn.enterPrefix')+'备注说明'+$t('btn.enterSuffix')"/>
            </el-form-item>
          </el-col>
...
const columns = ref([
  ...
  { visible: false, prop: 'zcadz009', label: '采购组' },
  ...
  { visible: false, prop: 'zcadz031', label: '采购仓储' },
  { visible: false, prop: 'zcadz032', label: '库存仓位' },
  { visible: false, prop: 'zcadz033', label: '库存' },
