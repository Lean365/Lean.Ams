  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="查检水平" prop="qcaLevel">
        <el-input v-model="queryParams.qcaLevel" :placeholder="$t('btn.enterSearchPrefix')+'查检水平'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
        </el-col>
    ...
    <el-row :gutter="15" class="mb10">
      ...
      <el-col :span="1.5">
        <el-button class="btn-edit" :disabled="single" v-hasPermi="['qm:checkaql:edit']" plain icon="edit" @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-deletebatch" :disabled="multiple" v-hasPermi="['qm:checkaql:delete']" plain icon="delete" @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData
                  templateUrl="Logistics/QmCheckAql/importTemplate"
                  importUrl="/Logistics/QmCheckAql/importData"
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="qcaLevel" label="查检水平" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('qcaLevel')"/>
      <el-table-column prop="qcaRange" label="批量范围" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('qcaRange')"/>
      ...
      <el-table-column prop="qcaSamplesCode" label="样本码" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('qcaSamplesCode')"/>
      ...
      <el-table-column :label="$t('btn.operation')" width="160" align="center">
        <template #default="scope">
          <el-button-group>
          <el-button class="btn-edit" plain size="small" icon="edit" :title="$t('btn.edit')" v-hasPermi="['qm:checkaql:edit']" @click="handleUpdate(scope.row)"></el-button>
          <el-button class="btn-delete" plain size="small" icon="delete" :title="$t('btn.delete')" v-hasPermi="['qm:checkaql:delete']" @click="handleDelete(scope.row)"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="SFID" prop="qcaSFID">
              <el-input v-model.number="form.qcaSFID" :placeholder="$t('btn.enterPrefix')+'SFID'+$t('btn.enterSuffix')" :disabled="opertype != 1"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="最小值" prop="qcaRangeMinmum">
              <el-input-number v-model.number="form.qcaRangeMinmum" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'最小值'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="最大值" prop="qcaRangeMaximum">
              <el-input-number v-model.number="form.qcaRangeMaximum" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'最大值'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="样本码" prop="qcaSamplesCode">
              <el-input v-model="form.qcaSamplesCode" :placeholder="$t('btn.enterPrefix')+'样本码'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="抽样数" prop="qcaSamplesQty">
              <el-input-number v-model.number="form.qcaSamplesQty" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'抽样数'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="合格项" prop="qcaAcQty">
              <el-input-number v-model.number="form.qcaAcQty" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'合格项'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="不合格项" prop="qcaReQty">
              <el-input-number v-model.number="form.qcaReQty" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'不合格项'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
