  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="项目代码" prop="qminsItemCode">
        <el-input v-model="queryParams.qminsItemCode" :placeholder="$t('btn.enterSearchPrefix')+'项目代码'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="项目名称" prop="qminsItemName">
        <el-input v-model="queryParams.qminsItemName" :placeholder="$t('btn.enterSearchPrefix')+'项目名称'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="项目类别" prop="qminsItemType">
        <el-select filterable clearable   v-model="queryParams.qminsItemType" :placeholder="$t('btn.selectSearchPrefix')+'项目类别'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="检查工具" prop="qminsItemQcTool">
        <el-select filterable clearable   v-model="queryParams.qminsItemQcTool" :placeholder="$t('btn.selectSearchPrefix')+'检查工具'+$t('btn.selectSearchSuffix')">
          <el-option v-for="item in   options.sys_insp_means " :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
            <span class="fl">{{ item.dictLabel }}</span>
            <span class="fr" style="color: var(--el-text-color-secondary);">{{ item.dictValue }}</span>          
          </el-option>
        </el-select>
    ...
    <el-row :gutter="15" class="mb10">
      ...
      <el-col :span="1.5">
        <el-button class="btn-edit" :disabled="single" v-hasPermi="['qm:inspectingitem:edit']" plain icon="edit" @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-deletebatch" :disabled="multiple" v-hasPermi="['qm:inspectingitem:delete']" plain icon="delete" @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData
                  templateUrl="Logistics/QmInspectingItem/importTemplate"
                  importUrl="/Logistics/QmInspectingItem/importData"
      ...
      <el-col :span="1.5">
        <el-button class="btn-export" plain icon="download" @click="handleExport" v-hasPermi="['qm:inspectingitem:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="qminsItemCode" label="项目代码" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('qminsItemCode')"/>
      <el-table-column prop="qminsItemName" label="项目名称" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('qminsItemName')"/>
      ...
      <el-table-column :label="$t('btn.operation')" width="160" align="center">
        <template #default="scope">
          <el-button-group>
          <el-button class="btn-edit" plain size="small" icon="edit" :title="$t('btn.edit')" v-hasPermi="['qm:inspectingitem:edit']" @click="handleUpdate(scope.row)"></el-button>
          <el-button class="btn-delete" plain size="small" icon="delete" :title="$t('btn.delete')" v-hasPermi="['qm:inspectingitem:delete']" @click="handleDelete(scope.row)"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="SFID" prop="qminsItemSFID">
              <el-input v-model.number="form.qminsItemSFID" :placeholder="$t('btn.enterPrefix')+'SFID'+$t('btn.enterSuffix')" :disabled="opertype != 1"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="项目代码" prop="qminsItemCode">
              <el-input v-model="form.qminsItemCode" :placeholder="$t('btn.enterPrefix')+'项目代码'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="项目名称" prop="qminsItemName">
              <el-input v-model="form.qminsItemName" :placeholder="$t('btn.enterPrefix')+'项目名称'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="项目类别" prop="qminsItemType">
              <el-select filterable clearable   v-model="form.qminsItemType"  :placeholder="$t('btn.selectPrefix')+'项目类别'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="检查工具" prop="qminsItemQcTool">
              <el-select filterable clearable   v-model="form.qminsItemQcTool"  :placeholder="$t('btn.selectPrefix')+'检查工具'+$t('btn.selectSuffix')">
                <el-option
                  v-for="item in  options.sys_insp_means" 
                  :key="item.dictValue" 
                  :label="item.dictLabel" 
                  :value="item.dictValue"></el-option>
              </el-select>
