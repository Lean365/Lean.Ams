  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="税别" prop="ma012">
        <el-select filterable clearable  v-model="queryParams.ma012" :placeholder="$t('btn.selectSearchPrefix')+'税别'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="付款方式" prop="ma016">
        <el-select filterable clearable  v-model="queryParams.ma016" :placeholder="$t('btn.selectSearchPrefix')+'付款方式'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="统驭科目" prop="ma017">
        <el-select filterable clearable  v-model="queryParams.ma017" :placeholder="$t('btn.selectSearchPrefix')+'统驭科目'+$t('btn.selectSearchSuffix')">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="州省" prop="ma026">
              <el-select-v2 filterable clearable   v-model="form.ma026"  :placeholder="$t('btn.selectPrefix')+'州省'+$t('btn.selectSuffix')"
		:options="options.sql_global_state.map(item =>({label: item.dictLabel, value: item.dictValue}))">
          ...
          <el-col :lg="12">
            <el-form-item label="市" prop="ma027">
              <el-select-v2 filterable clearable   v-model="form.ma027"  :placeholder="$t('btn.selectPrefix')+'市'+$t('btn.selectSuffix')"
