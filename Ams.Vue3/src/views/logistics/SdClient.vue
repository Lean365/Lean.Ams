  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="销售组织" prop="scOrg">
        <el-select filterable clearable   v-model="queryParams.scOrg" :placeholder="$t('btn.selectSearchPrefix')+'销售组织'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="行业类别" prop="scIndustryType">
        <el-select filterable clearable   v-model="queryParams.scIndustryType" :placeholder="$t('btn.selectSearchPrefix')+'行业类别'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="企业性质" prop="scEnterpriseNature">
        <el-select filterable clearable   v-model="queryParams.scEnterpriseNature" :placeholder="$t('btn.selectSearchPrefix')+'企业性质'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="客户代码" prop="scCode">
        <el-input v-model="queryParams.scCode" :placeholder="$t('btn.enterSearchPrefix')+'客户代码'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="客户简称" prop="scAbbr">
        <el-input v-model="queryParams.scAbbr" :placeholder="$t('btn.enterSearchPrefix')+'客户简称'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="客户名称" prop="scName">
        <el-input v-model="queryParams.scName" :placeholder="$t('btn.enterSearchPrefix')+'客户名称'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="税别" prop="scTaxType">
        <el-select filterable clearable   v-model="queryParams.scTaxType" :placeholder="$t('btn.selectSearchPrefix')+'税别'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="交易币种" prop="scCcy">
        <el-select filterable clearable   v-model="queryParams.scCcy" :placeholder="$t('btn.selectSearchPrefix')+'交易币种'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="付款条件" prop="scPayTerms">
        <el-select filterable clearable   v-model="queryParams.scPayTerms" :placeholder="$t('btn.selectSearchPrefix')+'付款条件'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="付款方式" prop="scPayMethod">
        <el-select filterable clearable   v-model="queryParams.scPayMethod" :placeholder="$t('btn.selectSearchPrefix')+'付款方式'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="统驭科目" prop="scRecAccount">
        <el-select filterable clearable   v-model="queryParams.scRecAccount" :placeholder="$t('btn.selectSearchPrefix')+'统驭科目'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="贸易条件" prop="scTradeTerms">
        <el-select filterable clearable   v-model="queryParams.scTradeTerms" :placeholder="$t('btn.selectSearchPrefix')+'贸易条件'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="装运条件" prop="scShippingTerms">
        <el-select filterable clearable   v-model="queryParams.scShippingTerms" :placeholder="$t('btn.selectSearchPrefix')+'装运条件'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="客户等级" prop="scCustomerGrade">
        <el-select filterable clearable   v-model="queryParams.scCustomerGrade" :placeholder="$t('btn.selectSearchPrefix')+'客户等级'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="客户信用" prop="scCustomerCredit">
        <el-select filterable clearable   v-model="queryParams.scCustomerCredit" :placeholder="$t('btn.selectSearchPrefix')+'客户信用'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="首次交易">
        <el-date-picker
          v-model="dateRangeScFirstTransDate" 
          type="datetimerange"
      ...
      <el-form-item label="国家地区" prop="scRegionCode">
        <el-select filterable clearable   v-model="queryParams.scRegionCode" :placeholder="$t('btn.selectSearchPrefix')+'国家地区'+$t('btn.selectSearchSuffix')">
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="scFirstTransDate" label="首次交易" :show-overflow-tooltip="true"  v-if="columns.showColumn('scFirstTransDate')"/>
      <el-table-column prop="scLastTransDate" label="最近交易" :show-overflow-tooltip="true"  v-if="columns.showColumn('scLastTransDate')"/>
      ...
      <el-table-column prop="scLicenseAnnex" label="营业执照附件" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('scLicenseAnnex')"/>
      <el-table-column prop="scOtherAnnex" label="其它附件" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('scOtherAnnex')"/>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="SFID" prop="scSFID">
              <el-input v-model.number="form.scSFID" :placeholder="$t('btn.enterPrefix')+'SFID'+$t('btn.enterSuffix')" :disabled="opertype != 1"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="销售组织" prop="scOrg">
              <el-select filterable clearable   v-model="form.scOrg"  :placeholder="$t('btn.selectPrefix')+'销售组织'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="行业类别" prop="scIndustryType">
              <el-select filterable clearable   v-model="form.scIndustryType"  :placeholder="$t('btn.selectPrefix')+'行业类别'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="企业性质" prop="scEnterpriseNature">
              <el-select filterable clearable   v-model="form.scEnterpriseNature"  :placeholder="$t('btn.selectPrefix')+'企业性质'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="营业执照" prop="scBusinessNo">
              <el-input v-model="form.scBusinessNo" :placeholder="$t('btn.enterPrefix')+'营业执照'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="税别" prop="scTaxType">
              <el-select filterable clearable   v-model="form.scTaxType"  :placeholder="$t('btn.selectPrefix')+'税别'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="主营业务" prop="scMainBusiness">
              <el-input v-model="form.scMainBusiness" :placeholder="$t('btn.enterPrefix')+'主营业务'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="交易币种" prop="scCcy">
              <el-select filterable clearable   v-model="form.scCcy"  :placeholder="$t('btn.selectPrefix')+'交易币种'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="付款条件" prop="scPayTerms">
              <el-select filterable clearable   v-model="form.scPayTerms"  :placeholder="$t('btn.selectPrefix')+'付款条件'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="付款方式" prop="scPayMethod">
              <el-select filterable clearable   v-model="form.scPayMethod"  :placeholder="$t('btn.selectPrefix')+'付款方式'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="统驭科目" prop="scRecAccount">
              <el-select filterable clearable   v-model="form.scRecAccount"  :placeholder="$t('btn.selectPrefix')+'统驭科目'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="贸易条件" prop="scTradeTerms">
              <el-select filterable clearable   v-model="form.scTradeTerms"  :placeholder="$t('btn.selectPrefix')+'贸易条件'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="装运条件" prop="scShippingTerms">
              <el-select filterable clearable   v-model="form.scShippingTerms"  :placeholder="$t('btn.selectPrefix')+'装运条件'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="客户等级" prop="scCustomerGrade">
              <el-select filterable clearable   v-model="form.scCustomerGrade"  :placeholder="$t('btn.selectPrefix')+'客户等级'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="客户信用" prop="scCustomerCredit">
              <el-select filterable clearable   v-model="form.scCustomerCredit"  :placeholder="$t('btn.selectPrefix')+'客户信用'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="银行代码" prop="scBankCode">
              <el-input v-model="form.scBankCode" :placeholder="$t('btn.enterPrefix')+'银行代码'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行名称" prop="scBankName">
              <el-input v-model="form.scBankName" :placeholder="$t('btn.enterPrefix')+'银行名称'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="分行名称" prop="scBranchName">
              <el-input v-model="form.scBranchName" :placeholder="$t('btn.enterPrefix')+'分行名称'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行所在国" prop="scBankCountry">
              <el-select filterable clearable   v-model="form.scBankCountry"  :placeholder="$t('btn.selectPrefix')+'银行所在国'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="银行所在州省" prop="scBankState">
              <el-select filterable clearable   v-model="form.scBankState"  :placeholder="$t('btn.selectPrefix')+'银行所在州省'+$t('btn.selectSuffix')">
                <el-option
                  v-for="item in  options.scBankStateOptions" 
                  :key="item.dictValue" 
                  :label="item.dictLabel" 
                  :value="item.dictValue"></el-option>
              </el-select>
          ...
          <el-col :lg="12">
            <el-form-item label="银行所在市" prop="scBankCity">
              <el-input v-model="form.scBankCity" :placeholder="$t('btn.enterPrefix')+'银行所在市'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行所在县" prop="scBankCounty">
              <el-input v-model="form.scBankCounty" :placeholder="$t('btn.enterPrefix')+'银行所在县'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行地址" prop="scBankAddr">
              <el-input v-model="form.scBankAddr" :placeholder="$t('btn.enterPrefix')+'银行地址'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行地址1" prop="scBankAddr1">
              <el-input v-model="form.scBankAddr1" :placeholder="$t('btn.enterPrefix')+'银行地址1'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行地址2" prop="scBankAddr2">
              <el-input v-model="form.scBankAddr2" :placeholder="$t('btn.enterPrefix')+'银行地址2'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="银行账号" prop="scBankAccount">
              <el-input v-model="form.scBankAccount" :placeholder="$t('btn.enterPrefix')+'银行账号'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="SWIFT代码" prop="scBankSwiftNo">
              <el-input v-model="form.scBankSwiftNo" :placeholder="$t('btn.enterPrefix')+'SWIFT代码'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="国家地区" prop="scRegionCode">
              <el-select filterable clearable   v-model="form.scRegionCode"  :placeholder="$t('btn.selectPrefix')+'国家地区'+$t('btn.selectSuffix')">
                <el-option
                  v-for="item in  options.sys_country_list" 
                  :key="item.dictValue" 
                  :label="item.dictLabel" 
          ...
          <el-col :lg="12">
            <el-form-item label="州省" prop="scState">
              <el-input v-model="form.scState" :placeholder="$t('btn.enterPrefix')+'州省'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="市" prop="scCity">
              <el-input v-model="form.scCity" :placeholder="$t('btn.enterPrefix')+'市'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="县" prop="scCounty">
              <el-input v-model="form.scCounty" :placeholder="$t('btn.enterPrefix')+'县'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="联系人" prop="scContacts">
              <el-input v-model="form.scContacts" :placeholder="$t('btn.enterPrefix')+'联系人'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
...
// 首次交易时间范围
const dateRangeScFirstTransDate = ref([])
...
function getList(){
  proxy.addDateRange(queryParams, dateRangeScFirstTransDate.value, 'ScFirstTransDate');
  loading.value = true
...
function resetQuery(){
  // 首次交易时间范围
  dateRangeScFirstTransDate.value = []
...
const state = reactive({
  ...
  rules: {
    ...
    scBankCity: [{ required: true, message: "银行所在市"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    scBankCounty: [{ required: true, message: "银行所在县"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
...
function handleAdd() {
  ...
  form.value.scBankCountry= []
  form.value.scBankState= []
  form.value.scRegionCode= []
