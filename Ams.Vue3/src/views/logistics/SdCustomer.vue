  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="税别" prop="mb012">
        <el-select filterable clearable  v-model="queryParams.mb012" :placeholder="$t('btn.selectSearchPrefix')+'税别'+$t('btn.selectSearchSuffix')">
          <el-option v-for="item in   options.sys_tax_type " :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
            <span class="fl">{{ item.dictLabel }}</span>
            <span class="fr" style="color: var(--el-text-color-secondary);">{{ item.dictValue }}</span>          
          </el-option>
        </el-select>
      ...
      <el-form-item label="付款方式" prop="mb016">
        <el-select filterable clearable  v-model="queryParams.mb016" :placeholder="$t('btn.selectSearchPrefix')+'付款方式'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="统驭科目" prop="mb017">
        <el-select filterable clearable  v-model="queryParams.mb017" :placeholder="$t('btn.selectSearchPrefix')+'统驭科目'+$t('btn.selectSearchSuffix')">
          <el-option v-for="item in   options.sql_mitkz_list " :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
            <span class="fl">{{ item.dictLabel }}</span>
            <span class="fr" style="color: var(--el-text-color-secondary);">{{ item.dictValue }}</span>          
          </el-option>
        </el-select>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="州省" prop="mb026">
              <el-select-v2 filterable clearable   v-model="form.mb026"  :placeholder="$t('btn.selectPrefix')+'州省'+$t('btn.selectSuffix')"
		:options="options.sql_global_state.map(item =>({label: item.dictLabel, value: item.dictValue}))">
          ...
          <el-col :lg="12">
            <el-form-item label="市" prop="mb027">
              <el-select-v2 filterable clearable   v-model="form.mb027"  :placeholder="$t('btn.selectPrefix')+'市'+$t('btn.selectSuffix')"
