        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="银行所在州省" prop="scBankState">
              <el-input v-model="form.scBankState" :placeholder="$t('btn.enterPrefix')+'银行所在州省'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="营业执照附件" prop="scLicenseAnnex">
              <el-input v-model="form.scLicenseAnnex" :placeholder="$t('btn.enterPrefix')+'营业执照附件'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="其它附件" prop="scOtherAnnex">
              <el-input v-model="form.scOtherAnnex" :placeholder="$t('btn.enterPrefix')+'其它附件'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
...
const state = reactive({
  ...
  rules: {
    ...
    scBankState: [{ required: true, message: "银行所在州省"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
