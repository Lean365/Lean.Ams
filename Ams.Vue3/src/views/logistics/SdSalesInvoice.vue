  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="工厂" prop="ssiPlnt">
        <el-select filterable clearable   v-model="queryParams.ssiPlnt" :placeholder="$t('btn.selectSearchPrefix')+'工厂'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="年月" prop="ssiYm">
        <el-select filterable clearable   v-model="queryParams.ssiYm" :placeholder="$t('btn.selectSearchPrefix')+'年月'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="客户" prop="ssiCustomercode">
        <el-select filterable clearable   v-model="queryParams.ssiCustomercode" :placeholder="$t('btn.selectSearchPrefix')+'客户'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="利润中心" prop="ssiPrctr">
        <el-select filterable clearable   v-model="queryParams.ssiPrctr" :placeholder="$t('btn.selectSearchPrefix')+'利润中心'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="物料" prop="ssiSalesitem">
        <el-input v-model="queryParams.ssiSalesitem" :placeholder="$t('btn.enterSearchPrefix')+'物料'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="销售单位" prop="ssiSalesunit">
        <el-select filterable clearable   v-model="queryParams.ssiSalesunit" :placeholder="$t('btn.selectSearchPrefix')+'销售单位'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="原币币种" prop="ssiOriginalccy">
        <el-select filterable clearable   v-model="queryParams.ssiOriginalccy" :placeholder="$t('btn.selectSearchPrefix')+'原币币种'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="过账日期">
        <el-date-picker
          v-model="dateRangeSsiPostingdate" 
          type="datetimerange"
    ...
    <el-row :gutter="15" class="mb10">
      <el-col :span="1.5">
        <el-button class="btn-add" v-hasPermi="['sd:salesinvoice:add']" plain icon="plus" @click="handleAdd">
          {{ $t('btn.add') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-edit" :disabled="single" v-hasPermi="['sd:salesinvoice:edit']" plain icon="edit" @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-deletebatch" :disabled="multiple" v-hasPermi="['sd:salesinvoice:delete']" plain icon="delete" @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData
                  templateUrl="Logistics/SdSalesInvoice/importTemplate"
                  importUrl="/Logistics/SdSalesInvoice/importData"
      ...
      <el-col :span="1.5">
        <el-button class="btn-export" plain icon="download" @click="handleExport" v-hasPermi="['sd:salesinvoice:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="ssiFy" label="期间" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('ssiFy')"/>
      ...
      <el-table-column prop="ssiSalesunit" label="销售单位" align="center" v-if="columns.showColumn('ssiSalesunit')">
        <template #default="scope">
          <dict-tag :options=" options.sys_unit_list " :value="scope.row.ssiSalesunit"  />
        </template>
      </el-table-column>
      ...
      <el-table-column :label="$t('btn.operation')" width="160" align="center">
        <template #default="scope">
          <el-button-group>
          <el-button class="btn-edit" plain size="small" icon="edit" :title="$t('btn.edit')" v-hasPermi="['sd:salesinvoice:edit']" @click="handleUpdate(scope.row)"></el-button>
          <el-button class="btn-delete" plain size="small" icon="delete" :title="$t('btn.delete')" v-hasPermi="['sd:salesinvoice:delete']" @click="handleDelete(scope.row)"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="SFID" prop="ssiSfid">
              <el-input v-model.number="form.ssiSfid" :placeholder="$t('btn.enterPrefix')+'SFID'+$t('btn.enterSuffix')" :disabled="opertype != 1"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="工厂" prop="ssiPlnt">
              <el-select filterable clearable   v-model="form.ssiPlnt"  :placeholder="$t('btn.selectPrefix')+'工厂'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="期间" prop="ssiFy">
              <el-input v-model="form.ssiFy" :placeholder="$t('btn.enterPrefix')+'期间'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="年月" prop="ssiYm">
              <el-select filterable clearable   v-model="form.ssiYm"  :placeholder="$t('btn.selectPrefix')+'年月'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="销售凭证" prop="ssiAccdocno">
              <el-input v-model="form.ssiAccdocno" :placeholder="$t('btn.enterPrefix')+'销售凭证'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="凭证明细" prop="ssiAccdoclineno">
              <el-input v-model="form.ssiAccdoclineno" :placeholder="$t('btn.enterPrefix')+'凭证明细'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="客户" prop="ssiCustomercode">
              <el-select filterable clearable   v-model="form.ssiCustomercode"  :placeholder="$t('btn.selectPrefix')+'客户'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="利润中心" prop="ssiPrctr">
              <el-select filterable clearable   v-model="form.ssiPrctr"  :placeholder="$t('btn.selectPrefix')+'利润中心'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="物料" prop="ssiSalesitem">
              <el-input v-model="form.ssiSalesitem" :placeholder="$t('btn.enterPrefix')+'物料'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="科目" prop="ssiAccountcode">
              <el-input v-model="form.ssiAccountcode" :placeholder="$t('btn.enterPrefix')+'科目'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="销售数量" prop="ssiSalesqty">
              <el-input-number v-model.number="form.ssiSalesqty" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'销售数量'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="销售单位" prop="ssiSalesunit">
              <el-select filterable clearable   v-model="form.ssiSalesunit"  :placeholder="$t('btn.selectPrefix')+'销售单位'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="原币销售额" prop="ssiOriginalamount">
              <el-input-number v-model.number="form.ssiOriginalamount" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'原币销售额'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="原币币种" prop="ssiOriginalccy">
              <el-select filterable clearable   v-model="form.ssiOriginalccy"  :placeholder="$t('btn.selectPrefix')+'原币币种'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="本币销售额" prop="ssiLocalamount">
              <el-input-number v-model.number="form.ssiLocalamount" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'本币销售额'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="本币币种" prop="ssiLocalccy">
              <el-select filterable clearable   v-model="form.ssiLocalccy"  :placeholder="$t('btn.selectPrefix')+'本币币种'+$t('btn.selectSuffix')">
                <el-option
                  v-for="item in  options.sys_ccy_type" 
                  :key="item.dictValue" 
                  :label="item.dictLabel" 
          ...
          <el-col :lg="12">
            <el-form-item label="参考凭证" prop="ssiRefdocno">
              <el-input v-model="form.ssiRefdocno" :placeholder="$t('btn.enterPrefix')+'参考凭证'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="参考明细" prop="ssiRefdoclineno">
              <el-input v-model="form.ssiRefdoclineno" :placeholder="$t('btn.enterPrefix')+'参考明细'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="过账日期" prop="ssiPostingdate">
              <el-date-picker v-model="form.ssiPostingdate" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="用户" prop="ssiPostinguser">
              <el-input v-model="form.ssiPostinguser" :placeholder="$t('btn.enterPrefix')+'用户'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="输入日期" prop="ssiEntrydate">
              <el-date-picker v-model="form.ssiEntrydate" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="输入时间" prop="ssiEntrytime">
              <el-input v-model="form.ssiEntrytime" :placeholder="$t('btn.enterPrefix')+'输入时间'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="凭证类型" prop="ssiAccdoctype">
              <el-input v-model="form.ssiAccdoctype" :placeholder="$t('btn.enterPrefix')+'凭证类型'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="凭证名称" prop="ssiAccdoctext">
              <el-input v-model="form.ssiAccdoctext" :placeholder="$t('btn.enterPrefix')+'凭证名称'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
...
from '@/api/logistics/sdsalesinvoice.js'
...
const state = reactive({
  ...
  rules: {
    ...
    ssiFy: [{ required: true, message: "期间"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    ...
    ssiSalesunit: [{ required: true, message: "销售单位"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
    ...
    ssiLocalccy: [{ required: true, message: "本币币种"+proxy.$t('btn.isEmpty'), trigger: "change"     }],
...
sql_prctr_list: [],
    // 销售单位 选项列表 格式 eg:{ dictLabel: '标签', dictValue: '0'}
sys_unit_list: [],
...
function handleExport() {
  proxy
    ...
    .then(async () => {
      await proxy.downFile('/Logistics/SdSalesInvoice/export', { ...queryParams })
    })
}
