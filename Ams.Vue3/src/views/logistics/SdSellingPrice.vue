  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="工厂" prop="sspPlnt">
        <el-select filterable clearable   v-model="queryParams.sspPlnt" :placeholder="$t('btn.selectSearchPrefix')+'工厂'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="年月" prop="sspYm">
        <el-select filterable clearable   v-model="queryParams.sspYm" :placeholder="$t('btn.selectSearchPrefix')+'年月'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="物料" prop="sspItem">
        <el-input v-model="queryParams.sspItem" :placeholder="$t('btn.enterSearchPrefix')+'物料'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
      <el-form-item label="原币种" prop="sspOriginalccy">
        <el-select filterable clearable   v-model="queryParams.sspOriginalccy" :placeholder="$t('btn.selectSearchPrefix')+'原币种'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="本币种" prop="sspLocalccy">
        <el-select filterable clearable   v-model="queryParams.sspLocalccy" :placeholder="$t('btn.selectSearchPrefix')+'本币种'+$t('btn.selectSearchSuffix')">
          <el-option v-for="item in   options.sys_ccy_type " :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
            <span class="fl">{{ item.dictLabel }}</span>
            <span class="fr" style="color: var(--el-text-color-secondary);">{{ item.dictValue }}</span>          
          </el-option>
      ...
      <el-form-item label="本币利润中心" prop="sspLocalprctr">
        <el-select filterable clearable   v-model="queryParams.sspLocalprctr" :placeholder="$t('btn.selectSearchPrefix')+'本币利润中心'+$t('btn.selectSearchSuffix')">
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="sspFy" label="期间" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('sspFy')"/>
      ...
      <el-table-column prop="sspItem" label="物料" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('sspItem')"/>
      <el-table-column prop="sspItemtext" label="物料文本" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('sspItemtext')"/>
      ...
      <el-table-column prop="sspOriginalperunit" label="原币Per单位" align="center" v-if="columns.showColumn('sspOriginalperunit')"/>
      <el-table-column prop="sspOriginalprctr" label="原币利润中心" align="center" v-if="columns.showColumn('sspOriginalprctr')">
        <template #default="scope">
      ...
      <el-table-column prop="sspLocalperunit" label="本币Per单位" align="center" v-if="columns.showColumn('sspLocalperunit')"/>
      ...
      <el-table-column prop="sspEffdate" label="生效日期" :show-overflow-tooltip="true"  v-if="columns.showColumn('sspEffdate')"/>
      <el-table-column prop="sspExpdate" label="失效日期" :show-overflow-tooltip="true"  v-if="columns.showColumn('sspExpdate')"/>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="SFID" prop="sspSfid">
              <el-input v-model.number="form.sspSfid" :placeholder="$t('btn.enterPrefix')+'SFID'+$t('btn.enterSuffix')" :disabled="opertype != 1"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="工厂" prop="sspPlnt">
              <el-select filterable clearable   v-model="form.sspPlnt"  :placeholder="$t('btn.selectPrefix')+'工厂'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="期间" prop="sspFy">
              <el-input v-model="form.sspFy" :placeholder="$t('btn.enterPrefix')+'期间'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="年月" prop="sspYm">
              <el-select filterable clearable   v-model="form.sspYm"  :placeholder="$t('btn.selectPrefix')+'年月'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="物料" prop="sspItem">
              <el-input v-model="form.sspItem" :placeholder="$t('btn.enterPrefix')+'物料'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="物料文本" prop="sspItemtext">
              <el-input v-model="form.sspItemtext" :placeholder="$t('btn.enterPrefix')+'物料文本'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="原币价格" prop="sspOriginalfob">
              <el-input-number v-model.number="form.sspOriginalfob" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'原币价格'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="原币种" prop="sspOriginalccy">
              <el-select filterable clearable   v-model="form.sspOriginalccy"  :placeholder="$t('btn.selectPrefix')+'原币种'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="原币Per单位" prop="sspOriginalperunit">
              <el-input-number v-model.number="form.sspOriginalperunit" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'原币Per单位'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="原币利润中心" prop="sspOriginalprctr">
              <el-select filterable clearable   v-model="form.sspOriginalprctr"  :placeholder="$t('btn.selectPrefix')+'原币利润中心'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="本币价格" prop="sspLocalfob">
              <el-input-number v-model.number="form.sspLocalfob" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'本币价格'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="本币种" prop="sspLocalccy">
              <el-select filterable clearable   v-model="form.sspLocalccy"  :placeholder="$t('btn.selectPrefix')+'本币种'+$t('btn.selectSuffix')">
                <el-option
                  v-for="item in  options.sys_ccy_type" 
                  :key="item.dictValue" 
                  :label="item.dictLabel" 
          ...
          <el-col :lg="12">
            <el-form-item label="本币Per单位" prop="sspLocalperunit">
              <el-input-number v-model.number="form.sspLocalperunit" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'本币Per单位'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="本币利润中心" prop="sspLocalprctr">
              <el-select filterable clearable   v-model="form.sspLocalprctr"  :placeholder="$t('btn.selectPrefix')+'本币利润中心'+$t('btn.selectSuffix')">
                <el-option
                  v-for="item in  options.sql_prctr_list" 
                  :key="item.dictValue" 
                  :label="item.dictLabel" 
          ...
          <el-col :lg="12">
            <el-form-item label="生效日期" prop="sspEffdate">
              <el-date-picker v-model="form.sspEffdate" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="失效日期" prop="sspExpdate">
              <el-date-picker v-model="form.sspExpdate" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>
...
//是否查询（1是）
  sspLocalccy: undefined,
//是否查询（1是）
  sspLocalprctr: undefined,
//是否查询（1是）
  sspEffdate: undefined,
//是否查询（1是）
...
function getList(){
  proxy.addDateRange(queryParams, dateRangeSspEffdate.value, 'SspEffdate');
...
const state = reactive({
  ...
  rules: {
    ...
    sspFy: [{ required: true, message: "期间"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
