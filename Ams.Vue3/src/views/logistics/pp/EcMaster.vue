        ...
        <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
          ...
          <el-tab-pane :label="$t('ptabs.subMore')" name="17th">
            <el-row :gutter="20">
              ...
              <el-table :data="paginatedData" :row-class-name="rowPpEcSlaveIndex"
