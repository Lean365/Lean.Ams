...
<template>
  <div>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="mc009" label="特记说明" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mc009')"/>
      ...
      <el-table-column prop="mc013" label="特记" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mc013')"/>
      ...
      <el-table-column prop="mc018" label="特记" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mc018')"/>
      ...
      <el-table-column prop="mc022" label="特记" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mc022')"/>
      <el-table-column prop="mc023" label="附件1" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mc023')"/>
      <el-table-column prop="mc024" label="IQC品质问题対応记录者" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mc024')"/>
      ...
      <el-table-column prop="mc028" label="特记" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mc028')"/>
      ...
      <el-table-column prop="mc032" label="特记" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mc032')"/>
      ...
      <el-table-column prop="mc036" label="特记" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mc036')"/>
      ...
      <el-table-column prop="mc040" label="特记" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mc040')"/>
      <el-table-column prop="mc041" label="附件2" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mc041')"/>
      <el-table-column prop="mc042" label="QA品质问题対応记录者" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mc042')"/>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="日期" prop="mc003">
              <el-date-picker v-model="form.mc003" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="间接赁率" prop="mc004">
              <el-input-number v-model.number="form.mc004" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'间接赁率'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="IQC检查费用" prop="mc005">
              <el-input-number v-model.number="form.mc005" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'IQC检查费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="检查时间" prop="mc006">
              <el-input-number v-model.number="form.mc006" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'检查时间'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="差旅费" prop="mc007">
              <el-input-number v-model.number="form.mc007" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'差旅费'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="其他费用" prop="mc008">
              <el-input-number v-model.number="form.mc008" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'其他费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="特记说明" prop="mc009">
              <el-input   v-model="form.mc009" :placeholder="$t('btn.enterPrefix')+'特记说明'+$t('btn.enterSuffix')"  show-word-limit   maxlength="500"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="初期检定.定期检定业务费用" prop="mc010">
              <el-input-number v-model.number="form.mc010" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'初期检定.定期检定业务费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="作业时间" prop="mc011">
              <el-input-number v-model.number="form.mc011" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'作业时间'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="其他费用" prop="mc012">
              <el-input-number v-model.number="form.mc012" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'其他费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="特记" prop="mc013">
              <el-input   v-model="form.mc013" :placeholder="$t('btn.enterPrefix')+'特记'+$t('btn.enterSuffix')"  show-word-limit   maxlength="500"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="测定器校正业务费用" prop="mc014">
              <el-input-number v-model.number="form.mc014" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'测定器校正业务费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="校正时间" prop="mc015">
              <el-input-number v-model.number="form.mc015" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'校正时间'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="外部委托，搬运费" prop="mc016">
              <el-input-number v-model.number="form.mc016" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'外部委托，搬运费'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="其他费用" prop="mc017">
              <el-input-number v-model.number="form.mc017" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'其他费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="特记" prop="mc018">
              <el-input   v-model="form.mc018" :placeholder="$t('btn.enterPrefix')+'特记'+$t('btn.enterSuffix')"  show-word-limit   maxlength="500"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="其他通常费用" prop="mc019">
              <el-input-number v-model.number="form.mc019" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'其他通常费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="通常作业时间" prop="mc020">
              <el-input-number v-model.number="form.mc020" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'通常作业时间'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="通常其他费用" prop="mc021">
              <el-input-number v-model.number="form.mc021" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'通常其他费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="特记" prop="mc022">
              <el-input   v-model="form.mc022" :placeholder="$t('btn.enterPrefix')+'特记'+$t('btn.enterSuffix')"  show-word-limit   maxlength="500"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="IQC品质问题対応记录者" prop="mc024">
              <el-input   v-model="form.mc024" :placeholder="$t('btn.enterPrefix')+'IQC品质问题対応记录者'+$t('btn.enterSuffix')"  show-word-limit   maxlength="50"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="出货检查费用" prop="mc025">
              <el-input-number v-model.number="form.mc025" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'出货检查费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="检查时间" prop="mc026">
              <el-input-number v-model.number="form.mc026" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'检查时间'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="其他费用" prop="mc027">
              <el-input-number v-model.number="form.mc027" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'其他费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="特记" prop="mc028">
              <el-input   v-model="form.mc028" :placeholder="$t('btn.enterPrefix')+'特记'+$t('btn.enterSuffix')"  show-word-limit   maxlength="500"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="信赖性评价.ORT业务费用" prop="mc029">
              <el-input-number v-model.number="form.mc029" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'信赖性评价.ORT业务费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="评价时间" prop="mc030">
              <el-input-number v-model.number="form.mc030" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'评价时间'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="其他费用" prop="mc031">
              <el-input-number v-model.number="form.mc031" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'其他费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="特记" prop="mc032">
              <el-input   v-model="form.mc032" :placeholder="$t('btn.enterPrefix')+'特记'+$t('btn.enterSuffix')"  show-word-limit   maxlength="500"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="顾客品质要求对应业务费用" prop="mc033">
              <el-input-number v-model.number="form.mc033" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'顾客品质要求对应业务费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="评价作业时间" prop="mc034">
              <el-input-number v-model.number="form.mc034" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'评价作业时间'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="评价其他费用" prop="mc035">
              <el-input-number v-model.number="form.mc035" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'评价其他费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="特记" prop="mc036">
              <el-input   v-model="form.mc036" :placeholder="$t('btn.enterPrefix')+'特记'+$t('btn.enterSuffix')"  show-word-limit   maxlength="500"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="其他通常业务费用" prop="mc037">
              <el-input-number v-model.number="form.mc037" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'其他通常业务费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="通常业务作业时间" prop="mc038">
              <el-input-number v-model.number="form.mc038" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'通常业务作业时间'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="通常业务其他费用" prop="mc039">
              <el-input-number v-model.number="form.mc039" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'通常业务其他费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="特记" prop="mc040">
              <el-input   v-model="form.mc040" :placeholder="$t('btn.enterPrefix')+'特记'+$t('btn.enterSuffix')"  show-word-limit   maxlength="500"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="QA品质问题対応记录者" prop="mc042">
              <el-input   v-model="form.mc042" :placeholder="$t('btn.enterPrefix')+'QA品质问题対応记录者'+$t('btn.enterSuffix')"  show-word-limit   maxlength="50"/>
            </el-form-item>
          </el-col>
