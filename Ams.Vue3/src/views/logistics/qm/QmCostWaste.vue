  ...
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="机种" prop="me004">
        <el-select filterable clearable   v-model="queryParams.me004" :placeholder="$t('btn.selectSearchPrefix')+'机种'+$t('btn.selectSearchSuffix')">
      ...
      <el-form-item label="物料" prop="me006">
        <el-select filterable clearable   remote remote-show-suffix :remote-method="remoteMethod_sql_mats_list" :loading="loading" v-model="queryParams.me006" :placeholder="$t('btn.selectSearchPrefix')+'物料'+$t('btn.selectSearchSuffix')">
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="me004" label="机种" align="center" v-if="columns.showColumn('me004')">
        <template #default="scope">
          <dict-tag :options=" options.sql_sap_model " :value="scope.row.me004"  />
        </template>
      </el-table-column>
      <el-table-column prop="me005" label="间接人员赁率" align="center" v-if="columns.showColumn('me005')"/>
      <el-table-column prop="me006" label="物料" align="center" v-if="columns.showColumn('me006')">
        <template #default="scope">
          <dict-tag :options=" options.sql_mats_list " :value="scope.row.me006"  />
        </template>
      </el-table-column>
      <el-table-column prop="me007" label="描述" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('me007')"/>
      <el-table-column prop="me008" label="事故内容" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('me008')"/>
      ...
      <el-table-column prop="me018" label="设变" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('me018')"/>
      <el-table-column prop="me019" label="担当" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('me019')"/>
      <el-table-column prop="me020" label="附件" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('me020')"/>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="日期" prop="me003">
              <el-date-picker v-model="form.me003" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="机种" prop="me004">
              <el-select filterable clearable   v-model="form.me004"  :placeholder="$t('btn.selectPrefix')+'机种'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="间接人员赁率" prop="me005">
              <el-input-number v-model.number="form.me005" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'间接人员赁率'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="物料" prop="me006">
              ...
              :loading="loading" v-model="form.me006"  :placeholder="$t('btn.selectPrefix')+'物料'+$t('btn.selectSuffix')">
                <el-option
          ...
          <el-col :lg="12">
            <el-form-item label="描述" prop="me007">
              <el-input   v-model="form.me007" :placeholder="$t('btn.enterPrefix')+'描述'+$t('btn.enterSuffix')"  show-word-limit   maxlength="40"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="事故内容" prop="me008">
              <el-input   v-model="form.me008" :placeholder="$t('btn.enterPrefix')+'事故内容'+$t('btn.enterSuffix')"  show-word-limit   maxlength="300"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="废弃费用" prop="me009">
              <el-input-number v-model.number="form.me009" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'废弃费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="废弃数量" prop="me010">
              <el-input-number v-model.number="form.me010" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'废弃数量'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="部品单价" prop="me011">
              <el-input-number v-model.number="form.me011" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'部品单价'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="废弃处理费用" prop="me012">
              <el-input-number v-model.number="form.me012" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'废弃处理费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="运费" prop="me013">
              <el-input-number v-model.number="form.me013" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'运费'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="其他费用" prop="me014">
              <el-input-number v-model.number="form.me014" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'其他费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
            
          <el-col :lg="12">
            <el-form-item label="处理作业时间(分)" prop="me015">
              <el-input-number v-model.number="form.me015" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'处理作业时间(分)'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="关税" prop="me016">
              <el-input-number v-model.number="form.me016" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'关税'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="处理发生其他费用" prop="me017">
              <el-input-number v-model.number="form.me017" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'处理发生其他费用'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="设变" prop="me018">
              <el-input   v-model="form.me018" :placeholder="$t('btn.enterPrefix')+'设变'+$t('btn.enterSuffix')"  show-word-limit   maxlength="200"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="担当" prop="me019">
              <el-input   v-model="form.me019" :placeholder="$t('btn.enterPrefix')+'担当'+$t('btn.enterSuffix')"  show-word-limit   maxlength="40"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="附件" prop="me020">
              <el-input   v-model="form.me020" :placeholder="$t('btn.enterPrefix')+'附件'+$t('btn.enterSuffix')"  show-word-limit   maxlength="255"/>
            </el-form-item>
          </el-col>
...
//正则表达式
  rules: {
    ...
    me003: [{ required: true, message: "日期"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
