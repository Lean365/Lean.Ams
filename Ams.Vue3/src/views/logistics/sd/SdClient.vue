...
<template>
  <div>
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :lg="24">
          <el-form-item label="销售组织" prop="ma003">
            <el-select filterable clearable v-model="queryParams.ma003"
          ...
          <el-form-item label="企业性质" prop="ma005">
            <el-select filterable clearable v-model="queryParams.ma005"
          ...
          <el-form-item label="交易币种" prop="ma014">
            <el-select filterable clearable v-model="queryParams.ma014"
          ...
          <el-form-item label="付款条件" prop="ma015">
            <el-select filterable clearable v-model="queryParams.ma015"
          ...
          <el-form-item label="付款方式" prop="ma016">
            <el-select filterable clearable v-model="queryParams.ma016"
          ...
          <el-form-item label="统驭科目" prop="ma017">
            <el-select filterable clearable v-model="queryParams.ma017"
          ...
          <el-form-item label="客户等级" prop="ma020">
            <el-select filterable clearable v-model="queryParams.ma020"
          ...
          <el-form-item label="冻结标记" prop="ma039">
            <el-radio-group v-model="queryParams.ma039">
    ...
    <el-table border height="600px" :data="dataList" v-loading="loading" ref="table"
      ...
      <el-table-column prop="ma006" label="客户代码" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma006')" />
      <el-table-column prop="ma007" label="客户简称" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma007')" />
      <el-table-column prop="ma008" label="客户名称" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma008')" />
      <el-table-column prop="ma009" label="企业法人" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma009')" />
      <el-table-column prop="ma010" label="税号" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma010')" />
      <el-table-column prop="ma011" label="营业执照" align="center" :show-overflow-tooltip="true"
      ...
      <el-table-column prop="ma013" label="主营业务" align="center" :show-overflow-tooltip="true"
      ...
      <el-table-column prop="ma024" label="供应商" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma024')" />
      ...
      <el-table-column prop="ma028" label="县" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma028')" />
      <el-table-column prop="ma029" label="地址" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma029')" />
      <el-table-column prop="ma030" label="地址1" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma030')" />
      <el-table-column prop="ma031" label="地址2" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma031')" />
      <el-table-column prop="ma032" label="邮政编码" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma032')" />
      <el-table-column prop="ma033" label="地址号码" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma033')" />
      <el-table-column prop="ma034" label="联系人" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma034')" />
      <el-table-column prop="ma035" label="电邮" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma035')" />
      <el-table-column prop="ma036" label="电话" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma036')" />
      <el-table-column prop="ma037" label="传真" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma037')" />
      <el-table-column prop="ma038" label="手机" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma038')" />
      ...
      <el-table-column prop="ma040" label="营业执照附件" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma040')" />
      <el-table-column prop="ma041" label="其它附件" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('ma041')" />
        ...
        <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
          <el-tab-pane :label="$t('ptabs.basicInfo')" name="first">
            <el-row :gutter="20">
              ...
              <el-col :lg="12">
                <el-form-item label="销售组织" prop="ma003">
                  <el-select filterable clearable v-model="form.ma003"
              ...
              <el-col :lg="12">
                <el-form-item label="企业性质" prop="ma005">
                  <el-select filterable clearable v-model="form.ma005"
              ...
              <el-col :lg="12">
                <el-form-item label="客户代码" prop="ma006">
                  <el-input v-model="form.ma006" :placeholder="$t('btn.enterPrefix')+'客户代码'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="客户简称" prop="ma007">
                  <el-input v-model="form.ma007" :placeholder="$t('btn.enterPrefix')+'客户简称'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="客户名称" prop="ma008">
                  <el-input v-model="form.ma008" :placeholder="$t('btn.enterPrefix')+'客户名称'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="企业法人" prop="ma009">
                  <el-input v-model="form.ma009" :placeholder="$t('btn.enterPrefix')+'企业法人'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="税号" prop="ma010">
                  <el-input v-model="form.ma010" :placeholder="$t('btn.enterPrefix')+'税号'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="营业执照" prop="ma011">
                  <el-input v-model="form.ma011" :placeholder="$t('btn.enterPrefix')+'营业执照'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="100" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="税别" prop="ma012">
                  <el-select filterable clearable v-model="form.ma012"
              ...
              <el-col :lg="12">
                <el-form-item label="主营业务" prop="ma013">
                  <el-input v-model="form.ma013" :placeholder="$t('btn.enterPrefix')+'主营业务'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="200" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="交易币种" prop="ma014">
                  <el-select filterable clearable v-model="form.ma014"
              ...
              <el-col :lg="12">
                <el-form-item label="付款条件" prop="ma015">
                  <el-select filterable clearable v-model="form.ma015"
              ...
              <el-col :lg="12">
                <el-form-item label="付款方式" prop="ma016">
                  <el-select filterable clearable v-model="form.ma016"
              ...
              <el-col :lg="12">
                <el-form-item label="统驭科目" prop="ma017">
                  <el-select filterable clearable v-model="form.ma017"
              ...
              <el-col :lg="12">
                <el-form-item label="贸易条件" prop="ma018">
                  <el-select filterable clearable v-model="form.ma018"
              ...
              <el-col :lg="12">
                <el-form-item label="装运条件" prop="ma019">
                  <el-select filterable clearable v-model="form.ma019"
              ...
              <el-col :lg="12">
                <el-form-item label="客户等级" prop="ma020">
                  <el-select filterable clearable v-model="form.ma020"
              ...
              <el-col :lg="12">
                <el-form-item label="客户信用" prop="ma021">
                  <el-select filterable clearable v-model="form.ma021"
              ...
              <el-col :lg="12">
                <el-form-item label="首次交易" prop="ma022">
                  <el-date-picker v-model="form.ma022" type="datetime" :teleported="false"
              ...
              <el-col :lg="12">
                <el-form-item label="最近交易" prop="ma023">
                  <el-date-picker v-model="form.ma023" type="datetime" :teleported="false"
                    :placeholder="$t('btn.dateselect')"></el-date-picker>
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="供应商" prop="ma024">
                  <el-input v-model="form.ma024" :placeholder="$t('btn.enterPrefix')+'供应商'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="40" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="国家地区" prop="ma025">
                  <el-select filterable clearable v-model="form.ma025"
              ...
              <el-col :lg="12">
                <el-form-item label="州省" prop="ma026">
                  <el-select-v2 filterable clearable v-model="form.ma026"
              ...
              <el-col :lg="12">
                <el-form-item label="市" prop="ma027">
                  <el-select-v2 filterable clearable v-model="form.ma027"
              ...
              <el-col :lg="12">
                <el-form-item label="县" prop="ma028">
                  <el-input v-model="form.ma028" :placeholder="$t('btn.enterPrefix')+'县'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="40" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="地址" prop="ma029">
                  <el-input v-model="form.ma029" :placeholder="$t('btn.enterPrefix')+'地址'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="200" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="地址1" prop="ma030">
                  <el-input v-model="form.ma030" :placeholder="$t('btn.enterPrefix')+'地址1'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="200" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="地址2" prop="ma031">
                  <el-input v-model="form.ma031" :placeholder="$t('btn.enterPrefix')+'地址2'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="200" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="邮政编码" prop="ma032">
                  <el-input v-model="form.ma032" :placeholder="$t('btn.enterPrefix')+'邮政编码'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="地址号码" prop="ma033">
                  <el-input v-model="form.ma033" :placeholder="$t('btn.enterPrefix')+'地址号码'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="20" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="联系人" prop="ma034">
                  <el-input v-model="form.ma034" :placeholder="$t('btn.enterPrefix')+'联系人'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="200" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="电邮" prop="ma035">
                  <el-input v-model="form.ma035" :placeholder="$t('btn.enterPrefix')+'电邮'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="50" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="电话" prop="ma036">
                  <el-input v-model="form.ma036" :placeholder="$t('btn.enterPrefix')+'电话'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="传真" prop="ma037">
                  <el-input v-model="form.ma037" :placeholder="$t('btn.enterPrefix')+'传真'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="160" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="手机" prop="ma038">
                  <el-input v-model="form.ma038" :placeholder="$t('btn.enterPrefix')+'手机'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="160" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="营业执照附件" prop="ma040">
                  <UploadFile v-model="form.ma040" fileSize="20" :fileType="['pdf']" limit="1"
                    :data=" {fileNameType:1, fileDir: 'logistics/sdclient' ,uploadType: 1}" />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="其它附件" prop="ma041">
                  <UploadFile v-model="form.ma041" fileSize="20" :fileType="['pdf']" limit="1"
                    :data=" {fileNameType:1, fileDir: 'logistics/sdclient' ,uploadType: 1}" />
                </el-form-item>
              </el-col>
...
<script setup name="sdclient">
  ...
  const columns = ref([
    ...
    { visible: false, prop: 'ma002', label: '集团' },
    ...
    { visible: true, prop: 'ma012', label: '税别' },
    { visible: false, prop: 'ma013', label: '主营业务' },
    { visible: true, prop: 'ma014', label: '交易币种' },
    { visible: true, prop: 'ma015', label: '付款条件' },
    { visible: true, prop: 'ma016', label: '付款方式' },
    { visible: true, prop: 'ma017', label: '统驭科目' },
    { visible: false, prop: 'ma018', label: '贸易条件' },
    { visible: false, prop: 'ma019', label: '装运条件' },
    { visible: true, prop: 'ma020', label: '客户等级' },
    { visible: false, prop: 'ma021', label: '客户信用' },
    { visible: false, prop: 'ma022', label: '首次交易' },
    { visible: false, prop: 'ma023', label: '最近交易' },
    { visible: true, prop: 'ma024', label: '供应商' },
    { visible: true, prop: 'ma025', label: '国家地区' },
