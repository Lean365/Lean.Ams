...
<template>
  <div>
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :lg="24">
          <el-form-item label="销售组织" prop="mb003">
            <el-select filterable clearable v-model="queryParams.mb003"
          ...
          <el-form-item label="行业类别" prop="mb004">
            <el-select filterable clearable v-model="queryParams.mb004"
          ...
          <el-form-item label="企业性质" prop="mb005">
            <el-select filterable clearable v-model="queryParams.mb005"
          ...
          <el-form-item label="客户名称" prop="mb008">
            <el-input v-model="queryParams.mb008"
              :placeholder="$t('btn.enterSearchPrefix')+'客户名称'+$t('btn.enterSearchSuffix')" />
          </el-form-item>
          <el-form-item label="税别" prop="mb012">
            <el-select filterable clearable v-model="queryParams.mb012"
              :placeholder="$t('btn.selectSearchPrefix')+'税别'+$t('btn.selectSearchSuffix')">
              <el-option v-for="item in   options.sys_tax_type " :key="item.dictValue" :label="item.dictLabel"
                :value="item.dictValue">
                <span class="fl">{{ item.dictLabel }}</span>
                <span class="fr" style="color: var(--el-text-color-secondary);">{{ item.dictValue }}</span>
              </el-option>
          ...
          <el-form-item label="交易币种" prop="mb014">
            <el-select filterable clearable v-model="queryParams.mb014"
          ...
          <el-form-item label="付款条件" prop="mb015">
            <el-select filterable clearable v-model="queryParams.mb015"
          ...
          <el-form-item label="付款方式" prop="mb016">
            <el-select filterable clearable v-model="queryParams.mb016"
          ...
          <el-form-item label="统驭科目" prop="mb017">
            <el-select filterable clearable v-model="queryParams.mb017"
              :placeholder="$t('btn.selectSearchPrefix')+'统驭科目'+$t('btn.selectSearchSuffix')">
              <el-option v-for="item in   options.sql_mitkz_list " :key="item.dictValue" :label="item.dictLabel"
                :value="item.dictValue">
                <span class="fl">{{ item.dictLabel }}</span>
                <span class="fr" style="color: var(--el-text-color-secondary);">{{ item.dictValue }}</span>
              </el-option>
          ...
          <el-form-item label="客户等级" prop="mb020">
            <el-select filterable clearable v-model="queryParams.mb020"
          ...
          <el-form-item label="供应商" prop="mb024">
            <el-input v-model="queryParams.mb024"
              :placeholder="$t('btn.enterSearchPrefix')+'供应商'+$t('btn.enterSearchSuffix')" />
          </el-form-item>
          <el-form-item label="国家地区" prop="mb025">
            <el-select filterable clearable v-model="queryParams.mb025"
          ...
          <el-form-item label="冻结标记" prop="mb039">
            <el-radio-group v-model="queryParams.mb039">
    ...
    <el-table border height="600px" :data="dataList" v-loading="loading" ref="table"
      ...
      <el-table-column prop="mb002" label="集团" align="center" :show-overflow-tooltip="true"
      ...
      <el-table-column prop="mb006" label="客户代码" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb006')" />
      <el-table-column prop="mb007" label="客户简称" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb007')" />
      <el-table-column prop="mb008" label="客户名称" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb008')" />
      <el-table-column prop="mb009" label="企业法人" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb009')" />
      <el-table-column prop="mb010" label="税号" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb010')" />
      <el-table-column prop="mb011" label="营业执照" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb011')" />
      ...
      <el-table-column prop="mb013" label="主营业务" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb013')" />
      ...
      <el-table-column prop="mb024" label="供应商" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb024')" />
      ...
      <el-table-column prop="mb028" label="县" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb028')" />
      <el-table-column prop="mb029" label="地址" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb029')" />
      <el-table-column prop="mb030" label="地址1" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb030')" />
      <el-table-column prop="mb031" label="地址2" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb031')" />
      <el-table-column prop="mb032" label="邮政编码" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb032')" />
      <el-table-column prop="mb033" label="地址号码" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb033')" />
      <el-table-column prop="mb034" label="联系人" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb034')" />
      <el-table-column prop="mb035" label="电邮" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb035')" />
      <el-table-column prop="mb036" label="电话" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb036')" />
      <el-table-column prop="mb037" label="传真" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb037')" />
      <el-table-column prop="mb038" label="手机" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb038')" />
      ...
      <el-table-column prop="mb040" label="营业执照附件" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb040')" />
      <el-table-column prop="mb041" label="其它附件" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('mb041')" />
            ...
            <el-row :gutter="20">
              ...
              <el-col :lg="12">
                <el-form-item label="集团" prop="mb002">
                  <el-input v-model="form.mb002" :placeholder="$t('btn.enterPrefix')+'集团'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="销售组织" prop="mb003">
                  <el-select filterable clearable v-model="form.mb003"
              ...
              <el-col :lg="12">
                <el-form-item label="行业类别" prop="mb004">
                  <el-select filterable clearable v-model="form.mb004"
              ...
              <el-col :lg="12">
                <el-form-item label="企业性质" prop="mb005">
                  <el-select filterable clearable v-model="form.mb005"
              ...
              <el-col :lg="12">
                <el-form-item label="客户代码" prop="mb006">
                  <el-input v-model="form.mb006" :placeholder="$t('btn.enterPrefix')+'客户代码'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="客户简称" prop="mb007">
                  <el-input v-model="form.mb007" :placeholder="$t('btn.enterPrefix')+'客户简称'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="客户名称" prop="mb008">
                  <el-input v-model="form.mb008" :placeholder="$t('btn.enterPrefix')+'客户名称'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="企业法人" prop="mb009">
                  <el-input v-model="form.mb009" :placeholder="$t('btn.enterPrefix')+'企业法人'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="税号" prop="mb010">
                  <el-input v-model="form.mb010" :placeholder="$t('btn.enterPrefix')+'税号'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="营业执照" prop="mb011">
                  <el-input v-model="form.mb011" :placeholder="$t('btn.enterPrefix')+'营业执照'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="100" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="税别" prop="mb012">
                  <el-select filterable clearable v-model="form.mb012"
              ...
              <el-col :lg="12">
                <el-form-item label="主营业务" prop="mb013">
                  <el-input v-model="form.mb013" :placeholder="$t('btn.enterPrefix')+'主营业务'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="200" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="交易币种" prop="mb014">
                  <el-select filterable clearable v-model="form.mb014"
              ...
              <el-col :lg="12">
                <el-form-item label="付款条件" prop="mb015">
                  <el-select filterable clearable v-model="form.mb015"
              ...
              <el-col :lg="12">
                <el-form-item label="付款方式" prop="mb016">
                  <el-select filterable clearable v-model="form.mb016"
              ...
              <el-col :lg="12">
                <el-form-item label="统驭科目" prop="mb017">
                  <el-select filterable clearable v-model="form.mb017"
              ...
              <el-col :lg="12">
                <el-form-item label="贸易条件" prop="mb018">
                  <el-select filterable clearable v-model="form.mb018"
              ...
              <el-col :lg="12">
                <el-form-item label="装运条件" prop="mb019">
                  <el-select filterable clearable v-model="form.mb019"
              ...
              <el-col :lg="12">
                <el-form-item label="客户等级" prop="mb020">
                  <el-select filterable clearable v-model="form.mb020"
              ...
              <el-col :lg="12">
                <el-form-item label="客户信用" prop="mb021">
                  <el-select filterable clearable v-model="form.mb021"
              ...
              <el-col :lg="12">
                <el-form-item label="首次交易" prop="mb022">
                  <el-date-picker v-model="form.mb022" type="datetime" :teleported="false"
              ...
              <el-col :lg="12">
                <el-form-item label="最近交易" prop="mb023">
                  <el-date-picker v-model="form.mb023" type="datetime" :teleported="false"
                    :placeholder="$t('btn.dateselect')"></el-date-picker>
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="供应商" prop="mb024">
                  <el-input v-model="form.mb024" :placeholder="$t('btn.enterPrefix')+'供应商'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="40" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="国家地区" prop="mb025">
                  <el-select filterable clearable v-model="form.mb025"
              ...
              <el-col :lg="12">
                <el-form-item label="州省" prop="mb026">
                  <el-select-v2 filterable clearable v-model="form.mb026"
                    :placeholder="$t('btn.selectPrefix')+'州省'+$t('btn.selectSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="市" prop="mb027">
                  <el-select-v2 filterable clearable v-model="form.mb027"
                    :placeholder="$t('btn.selectPrefix')+'市'+$t('btn.selectSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="县" prop="mb028">
                  <el-input v-model="form.mb028" :placeholder="$t('btn.enterPrefix')+'县'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="40" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="地址" prop="mb029">
                  <el-input v-model="form.mb029" :placeholder="$t('btn.enterPrefix')+'地址'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="200" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="地址1" prop="mb030">
                  <el-input v-model="form.mb030" :placeholder="$t('btn.enterPrefix')+'地址1'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="200" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="地址2" prop="mb031">
                  <el-input v-model="form.mb031" :placeholder="$t('btn.enterPrefix')+'地址2'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="200" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="邮政编码" prop="mb032">
                  <el-input v-model="form.mb032" :placeholder="$t('btn.enterPrefix')+'邮政编码'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="地址号码" prop="mb033">
                  <el-input v-model="form.mb033" :placeholder="$t('btn.enterPrefix')+'地址号码'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="20" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="联系人" prop="mb034">
                  <el-input v-model="form.mb034" :placeholder="$t('btn.enterPrefix')+'联系人'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="200" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="电邮" prop="mb035">
                  <el-input v-model="form.mb035" :placeholder="$t('btn.enterPrefix')+'电邮'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="50" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="电话" prop="mb036">
                  <el-input v-model="form.mb036" :placeholder="$t('btn.enterPrefix')+'电话'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="160" />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="传真" prop="mb037">
                  <el-input v-model="form.mb037" :placeholder="$t('btn.enterPrefix')+'传真'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="160" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="手机" prop="mb038">
                  <el-input v-model="form.mb038" :placeholder="$t('btn.enterPrefix')+'手机'+$t('btn.enterSuffix')"
                    show-word-limit maxlength="160" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="营业执照附件" prop="mb040">
                  <UploadFile v-model="form.mb040" fileSize="20" :fileType="['pdf']" limit="1"
                    :data=" {fileNameType:1, fileDir: 'logistics/sdcustomer' ,uploadType: 1}" />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="其它附件" prop="mb041">
                  <UploadFile v-model="form.mb041" fileSize="20" :fileType="['pdf']" limit="1"
                    :data=" {fileNameType:1, fileDir: 'logistics/sdcustomer' ,uploadType: 1}" />
                </el-form-item>
              </el-col>
...
<script setup name="sdcustomer">
  ...
  const columns = ref([
    ...
    { visible: false, prop: 'mb002', label: '集团' },
    ...
    { visible: true, prop: 'mb012', label: '税别' },
    { visible: false, prop: 'mb013', label: '主营业务' },
    { visible: true, prop: 'mb014', label: '交易币种' },
    { visible: true, prop: 'mb015', label: '付款条件' },
    { visible: true, prop: 'mb016', label: '付款方式' },
    { visible: true, prop: 'mb017', label: '统驭科目' },
    { visible: false, prop: 'mb018', label: '贸易条件' },
    { visible: false, prop: 'mb019', label: '装运条件' },
    { visible: true, prop: 'mb020', label: '客户等级' },
    { visible: false, prop: 'mb021', label: '客户信用' },
    { visible: false, prop: 'mb022', label: '首次交易' },
    { visible: false, prop: 'mb023', label: '最近交易' },
    { visible: true, prop: 'mb024', label: '供应商' },
    { visible: true, prop: 'mb025', label: '国家地区' },
