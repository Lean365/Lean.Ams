  ...
  <div>
        ...
        <el-col :lg="24">
          ...
          <el-form-item label="物料" prop="md005">
            <el-select-v2 filterable clearable v-model="queryParams.md005"
              :options="options.sql_marb_sales.map(item =>({label: item.dictLabel, value: item.dictValue}))"
          ...
          <el-form-item label="本币利润中心" prop="md014">
            <el-select-v2 filterable clearable v-model="queryParams.md014"
    ...
    <el-table border height="600px" :data="dataList" v-loading="loading" ref="table"
      ...
      <el-table-column prop="md005" label="物料" align="center" v-if="columns.showColumn('md005')">
        <template #default="scope">
          <dict-tag :options=" options.sql_marb_sales " :value="scope.row.md005" />
        </template>
      </el-table-column>
      ...
      <el-table-column prop="md009" label="原币定价单位" align="center" v-if="columns.showColumn('md009')" />
      ...
      <el-table-column prop="md013" label="本币定价单位" align="center" v-if="columns.showColumn('md013')" />
      ...
      <el-table-column prop="md015" label="汇率" align="center" v-if="columns.showColumn('md015')" />
      <el-table-column prop="md016" label="生效日期" :show-overflow-tooltip="true" v-if="columns.showColumn('md016')" />
      <el-table-column prop="md017" label="失效日期" :show-overflow-tooltip="true" v-if="columns.showColumn('md017')" />
            ...
            <el-row :gutter="20">
              ...
              <el-col :lg="12">
                <el-form-item label="物料文本" prop="md006">
                  <el-input v-model="form.md006" :placeholder="$t('btn.enterPrefix')+'物料文本'+$t('btn.enterSuffix')"
              ...
              <el-col :lg="12">
                <el-form-item label="原币定价单位" prop="md009">
                  <el-input-number v-model.number="form.md009" :controls="true" controls-position="right"
                    :placeholder="$t('btn.enterPrefix')+'原币定价单位'+$t('btn.enterSuffix')" />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="原币利润中心" prop="md010">
                  <el-select-v2 filterable clearable v-model="form.md010"
              ...
              <el-col :lg="12">
                <el-form-item label="本币定价单位" prop="md013">
                  <el-input-number v-model.number="form.md013" :controls="true" controls-position="right"
                    :placeholder="$t('btn.enterPrefix')+'本币定价单位'+$t('btn.enterSuffix')" />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="本币利润中心" prop="md014">
                  <el-select-v2 filterable clearable v-model="form.md014"
              ...
              <el-col :lg="12">
                <el-form-item label="汇率" prop="md015">
                  <el-input-number v-model.number="form.md015" :controls="true" controls-position="right"
                    :placeholder="$t('btn.enterPrefix')+'汇率'+$t('btn.enterSuffix')" />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="生效日期" prop="md016">
              ...
              <el-col :lg="12">
                <el-form-item label="失效日期" prop="md017">
                  <el-date-picker v-model="form.md017" type="datetime" :teleported="false"
                    :placeholder="$t('btn.dateselect')"></el-date-picker>
                </el-form-item>
              </el-col>
...
<script setup name="sdsellingprice">
  ...
  const columns = ref([
    ...
    { visible: false, prop: 'md009', label: '原币定价单位' },
    { visible: false, prop: 'md010', label: '原币利润中心' },
    { visible: false, prop: 'md011', label: '本币价格' },
    { visible: false, prop: 'md012', label: '本币种' },
    { visible: false, prop: 'md013', label: '本币定价单位' },
    { visible: false, prop: 'md014', label: '本币利润中心' },
    { visible: false, prop: 'md015', label: '汇率' },
    { visible: false, prop: 'md016', label: '生效日期' },
    { visible: false, prop: 'md017', label: '失效日期' },
  ...
  const state = reactive({
    ...
    rules: {
      ...
      md009: [{ required: true, message: "原币定价单位" + proxy.$t('btn.isEmpty'), trigger: "blur", type: "number" }],
      md010: [{ required: true, message: "原币利润中心" + proxy.$t('btn.isEmpty'), trigger: "blur" }],
      ...
      md013: [{ required: true, message: "本币定价单位" + proxy.$t('btn.isEmpty'), trigger: "blur", type: "number" }],
      md014: [{ required: true, message: "本币利润中心" + proxy.$t('btn.isEmpty'), trigger: "blur" }],
      md015: [{ required: true, message: "汇率" + proxy.$t('btn.isEmpty'), trigger: "blur" }],
      md016: [{ required: true, message: "生效日期" + proxy.$t('btn.isEmpty'), trigger: "blur" }],
      md017: [{ required: true, message: "失效日期" + proxy.$t('btn.isEmpty'), trigger: "blur" }],
    },
    //字典名称
    options: {
