...
<template>
  <div>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="warning" plain icon="download" @click="handleExport" v-hasPermi="['DiffLog:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border header-cell-class-name="el-table-header-cell"
      ...
      <el-table-column label="操作" width="130">
        <template #default="scope">
          ...
          <el-button v-hasPermi="['DiffLog:delete']" type="danger" icon="delete" title="删除" text
...
<script setup name="DiffLog">
  import { listDiffLog, delDiffLog } from '@/api/monitor/difflog.js'
