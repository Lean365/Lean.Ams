<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="操作状态" prop="isStated">
        <el-select v-model="queryParams.isStated" placeholder="操作状态" clearable>
      ...
      <el-form-item label="操作时间">
        <el-date-picker v-model="dateRange" type="datetimerange" range-separator="-" start-placeholder="开始日期"
          end-placeholder="结束日期" :default-time="defaultTime" value-format="YYYY-MM-DD HH:mm:ss"
    ...
    <el-table height="600" v-loading="loading" border :data="list" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作状态" align="center" prop="isStated" v-if="columns.showColumn('isStated')">
        <template #default="{ row }">
      ...
      <el-table-column label="错误信息" prop="errorMsg" width="220" v-if="columns.showColumn('errorMsg')" />
      ...
      <el-table-column prop="method" label="操作方法" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('method')" />
      <el-table-column prop="operParam" label="请求参数" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('operParam')" />
      <el-table-column prop="jsonResult" label="返回结果" align="center" :show-overflow-tooltip="true"
