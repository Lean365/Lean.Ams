        ...
        <el-card class="box-card">
          <template #header>
            <div class="card-header">
              ...
              <el-button text @click="getList()">{{$t('btn.refresh')}}</el-button>
            </div>
          </template>
              ...
              <el-tooltip placement="top-end">
                <template #content>
                  <div style="font-size: 12px">
                    ...
                    <div style="padding: 3px">{{$t('pserverlog.usedRam')}}：{{ sysFile.availableFreeSpace }}GB</div>
                    <div style="padding: 3px">{{$t('pserverlog.freeRam')}}：{{ sysFile.used }}GB</div>
                  </div>
                </template>
                <div class="content">
