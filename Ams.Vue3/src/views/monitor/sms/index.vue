...
<template>
  <div>
    ...
    <el-row :gutter="15" class="mb10">
      <el-col :span="1.5">
        <el-button type="warning" plain icon="download" @click="handleExport" v-hasPermi="['SmsLog:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border header-cell-class-name="el-table-header-cell"
      ...
      <el-table-column label="操作" width="60">
        <template #default="scope">
          <el-button type="danger" size="small" icon="delete" title="删除" v-hasPermi="['SmsLog:delete']"
...
<script setup name="SmsLog">
  ...
  function handleExport() {
    proxy
      ...
      .then(async () => {
        await proxy.downFile('/system/SmsLog/export', { ...queryParams })
      })
  }
