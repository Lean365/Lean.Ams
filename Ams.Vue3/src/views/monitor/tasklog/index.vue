  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="auto">
      <el-form-item :label="$t('ptask.name')" prop="jobName">
        <el-input v-model="queryParams.jobName" :placeholder="$t('btn.enter')+$t('ptask.name')" clearable
          style="width: 240px" @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item :label="$t('ptask.taskGroup')" prop="jobGroup">
        <el-select v-model="queryParams.jobGroup" :placeholder="$t('btn.enter')+$t('ptask.taskGroup')" clearable
          style="width: 240px">
...
<script setup name="tasklog">
  import { listJobLog, delJobLog, exportJobLog, cleanJobLog } from '@/api/monitor/tasklog'
  ...
  function handleDelete(row) {
    ...
    proxy
      .$confirm(proxy.$t('common.tipConfirmDel') + jobLogIds + proxy.$t('common.tipConfirmDelDataitems'), proxy.$t('btn.delete') + ' ' + proxy.$t('common.tip'), {
