...
<template>
  <div>
    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent label-width="auto">
      ...
      <el-form-item label="工号" prop="mj004">
        <el-input v-model="queryParams.mj004" :placeholder="$t('btn.enterSearchPrefix')+'工号'+$t('btn.enterSearchSuffix')" />
      </el-form-item>
        </el-col>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="mj003" label="生效日" :show-overflow-tooltip="true"  v-if="columns.showColumn('mj003')"/>
      <el-table-column prop="mj004" label="工号" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mj004')"/>
      <el-table-column prop="mj005" label="账号" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('mj005')"/>
      <el-table-column prop="mj006" label="基数" align="center" v-if="columns.showColumn('mj006')"/>
      <el-table-column prop="mj007" label="提取金额" align="center" v-if="columns.showColumn('mj007')"/>
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="生效日" prop="mj003">
              <el-date-picker v-model="form.mj003" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="工号" prop="mj004">
              <el-input   v-model="form.mj004" :placeholder="$t('btn.enterPrefix')+'工号'+$t('btn.enterSuffix')"  show-word-limit   maxlength="8"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="账号" prop="mj005">
              <el-input   v-model="form.mj005" :placeholder="$t('btn.enterPrefix')+'账号'+$t('btn.enterSuffix')"  show-word-limit   maxlength="40"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="基数" prop="mj006">
              <el-input-number v-model.number="form.mj006" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'基数'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="提取金额" prop="mj007">
              <el-input-number v-model.number="form.mj007" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'提取金额'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>
...
const columns = ref([
  ...
  { visible: true, prop: 'mj003', label: '生效日' },
  { visible: true, prop: 'mj004', label: '工号' },
  { visible: true, prop: 'mj005', label: '账号' },
  { visible: true, prop: 'mj006', label: '基数' },
  { visible: true, prop: 'mj007', label: '提取金额' },
...
function getList(){
  proxy.addDateRange(queryParams, dateRangeMj003.value, 'Mj003');
  loading.value = true
...
//正则表达式
  rules: {
    ...
    mj003: [{ required: true, message: "生效日"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
    mj004: [{ required: true, message: "工号"+proxy.$t('btn.isEmpty'), trigger: "blur"     }],
