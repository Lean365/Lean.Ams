...
<template>
  <div>
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border header-cell-class-name="el-table-header-cell"
      ...
      <el-table-column prop="topicName" label="话题名" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('topicName')" />
      <el-table-column prop="topicDescription" label="话题描述" align="center" :show-overflow-tooltip="true"
      ...
      <el-table-column label="操作" width="160">
        <template #default="scope">
          <el-button type="success" size="small" icon="edit" title="编辑" v-hasPermi="['articletopic:edit']"
            @click="handleUpdate(scope.row)"></el-button>
          <el-button type="danger" size="small" icon="delete" title="删除" v-hasPermi="['articletopic:delete']"
...
<script setup name="articletopic">
  import { listArticleTopic, addArticleTopic, delArticleTopic, updateArticleTopic, getArticleTopic } from '@/api/routine/articletopic.js'
