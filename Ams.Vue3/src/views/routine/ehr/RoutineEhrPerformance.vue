...
<template>
  <div>
    ...
    <el-row :gutter="15" class="mb10">
      ...
      <el-col :span="1.5">
        <el-button class="btn-edit" :disabled="single" v-hasPermi="['routine:ehrperformance:edit']" plain icon="edit" @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button class="btn-deletebatch" :disabled="multiple" v-hasPermi="['routine:ehrperformance:delete']" plain icon="delete" @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData
                  templateUrl="Routine/RoutineEhrPerformance/importTemplate"
                  importUrl="/Routine/RoutineEhrPerformance/importData"
      ...
      <el-col :span="1.5">
        <el-button class="btn-export" plain icon="download" @click="handleExport" v-hasPermi="['routine:ehrperformance:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-table border height="600px"
      ...
      <el-table-column prop="ml009" label="初评人" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('ml009')"/>
      ...
      <el-table-column prop="ml012" label="二次考评人" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('ml012')"/>
      <el-table-column prop="ml013" label="二次考评日期" :show-overflow-tooltip="true"  v-if="columns.showColumn('ml013')"/>
      <el-table-column prop="ml014" label="三次评分" align="center" v-if="columns.showColumn('ml014')"/>
      <el-table-column prop="ml015" label="三次考评人" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('ml015')"/>
      <el-table-column prop="ml016" label="三次考评日期" :show-overflow-tooltip="true"  v-if="columns.showColumn('ml016')"/>
      <el-table-column prop="ml017" label="四次评分" align="center" v-if="columns.showColumn('ml017')"/>
      <el-table-column prop="ml018" label="四次考评人" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('ml018')"/>
      <el-table-column prop="ml019" label="四次考评日期" :show-overflow-tooltip="true"  v-if="columns.showColumn('ml019')"/>
      <el-table-column prop="ml020" label="五次评分" align="center" v-if="columns.showColumn('ml020')"/>
      <el-table-column prop="ml021" label="五次考评人" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('ml021')"/>
      <el-table-column prop="ml022" label="五次考评日期" :show-overflow-tooltip="true"  v-if="columns.showColumn('ml022')"/>
      <el-table-column prop="ml023" label="六次评分" align="center" v-if="columns.showColumn('ml023')"/>
      <el-table-column prop="ml024" label="六次考评人" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('ml024')"/>
      <el-table-column prop="ml025" label="六次考评日期" :show-overflow-tooltip="true"  v-if="columns.showColumn('ml025')"/>
      <el-table-column prop="remark" label="备注" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('remark')"/>
      <el-table-column :label="$t('btn.operation')" width="160" align="center">
        <template #default="scope">
          <el-button-group>
          <el-button class="btn-edit" plain size="small" icon="edit" :title="$t('btn.edit')" v-hasPermi="['routine:ehrperformance:edit']" @click="handleUpdate(scope.row)"></el-button>
          <el-button class="btn-delete" plain size="small" icon="delete" :title="$t('btn.delete')" v-hasPermi="['routine:ehrperformance:delete']" @click="handleDelete(scope.row)"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="考核项目" prop="ml007">
              <el-input-number v-model.number="form.ml007" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'考核项目'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="初次评分" prop="ml008">
              <el-input-number v-model.number="form.ml008" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'初次评分'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="初评人" prop="ml009">
              <el-input   v-model="form.ml009" :placeholder="$t('btn.enterPrefix')+'初评人'+$t('btn.enterSuffix')"  show-word-limit  maxlength="40"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="初评日期" prop="ml010">
              <el-date-picker v-model="form.ml010" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="二次评分" prop="ml011">
              <el-input-number v-model.number="form.ml011" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'二次评分'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="二次考评人" prop="ml012">
              <el-input   v-model="form.ml012" :placeholder="$t('btn.enterPrefix')+'二次考评人'+$t('btn.enterSuffix')"  show-word-limit  maxlength="40"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="二次考评日期" prop="ml013">
              <el-date-picker v-model="form.ml013" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="三次评分" prop="ml014">
              <el-input-number v-model.number="form.ml014" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'三次评分'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="三次考评人" prop="ml015">
              <el-input   v-model="form.ml015" :placeholder="$t('btn.enterPrefix')+'三次考评人'+$t('btn.enterSuffix')"  show-word-limit  maxlength="40"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="三次考评日期" prop="ml016">
              <el-date-picker v-model="form.ml016" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="四次评分" prop="ml017">
              <el-input-number v-model.number="form.ml017" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'四次评分'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="四次考评人" prop="ml018">
              <el-input   v-model="form.ml018" :placeholder="$t('btn.enterPrefix')+'四次考评人'+$t('btn.enterSuffix')"  show-word-limit  maxlength="40"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="四次考评日期" prop="ml019">
              <el-date-picker v-model="form.ml019" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="五次评分" prop="ml020">
              <el-input-number v-model.number="form.ml020" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'五次评分'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="五次考评人" prop="ml021">
              <el-input   v-model="form.ml021" :placeholder="$t('btn.enterPrefix')+'五次考评人'+$t('btn.enterSuffix')"  show-word-limit  maxlength="40"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="五次考评日期" prop="ml022">
              <el-date-picker v-model="form.ml022" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="六次评分" prop="ml023">
              <el-input-number v-model.number="form.ml023" :controls="true" controls-position="right" :placeholder="$t('btn.enterPrefix')+'六次评分'+$t('btn.enterSuffix')" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="六次考评人" prop="ml024">
              <el-input   v-model="form.ml024" :placeholder="$t('btn.enterPrefix')+'六次考评人'+$t('btn.enterSuffix')"  show-word-limit  maxlength="40"/>
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="六次考评日期" prop="ml025">
              <el-date-picker v-model="form.ml025" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>
...
//后台操作函数
import { listRoutineEhrPerformance,
