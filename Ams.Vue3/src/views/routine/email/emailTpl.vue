...
<template>
  <div>
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border header-cell-class-name="el-table-header-cell"
      ...
      <el-table-column prop="content" label="模板内容" align="center" :show-overflow-tooltip="true"
      ...
      <el-table-column prop="updateBy" label="更新人" align="center" :show-overflow-tooltip="true"
      ...
      <el-table-column label="操作" width="180">
        <template #default="scope">
          ...
          <el-button type="success" size="small" icon="edit" title="编辑" v-hasPermi="['tool:emailtpl:edit']"
            @click="handleUpdate(scope.row)"></el-button>
          <el-button type="danger" size="small" icon="delete" title="删除" v-hasPermi="['tool:emailtpl:delete']"
...
<script setup name="emailtpl">
  import { listEmailTpl, addEmailTpl, delEmailTpl, updateEmailTpl, getEmailTpl } from '@/api/routine/emailtpl.js'
