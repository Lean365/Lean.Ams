    ...
    <el-row>
      ...
      <el-col :lg="6">
        <el-form-item label="选择模板" prop="emailTpl">
          <el-select v-model="form.emailTpl" placeholder="邮件模板" @change="handleSelectTpl" clearable>
            <el-option v-for="dict in emailTplOptions" :key="dict.dictValue" :label="dict.dictLabel"
              :value="dict.dictValue" />
          </el-select>
        </el-form-item>
      </el-col>
      <el-col :lg="6">
        <el-form-item label="是否立即送出" prop="isSend">
          <el-switch v-model="form.isSend" :active-value="true" :in-active-value="false" active-text="是"
...
<script setup name="sendemail">
  ...
  import { listEmailTpl, getEmailTpl } from '@/api/routine/emailtpl.js'
