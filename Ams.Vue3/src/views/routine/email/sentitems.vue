...
<template>
  <div>
    ...
    <el-row :gutter="15" class="mb10">
      ...
      <el-col :span="1.5">
        <el-button type="danger" :disabled="multiple" v-hasPermi="['emaillog:delete']" plain icon="delete"
          @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border header-cell-class-name="el-table-header-cell"
      ...
      <el-table-column label="操作" width="200">
        <template #default="scope">
          ...
          <el-button type="danger" size="small" icon="delete" text v-hasPermi="['emaillog:delete']"
...
<script setup name="sentitems">
  import { listEmailLog, sendEmail, delEmailLog } from '@/api/routine/sentitems.js'
  ...
  function handleSendEmail() {
    router.replace({ path: '/Mail/SendMail' })
  }
