<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="danger" plain icon="delete" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['PRIV_TasksqzLog_DELETE']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="delete" @click="handleClean" :disabled="total <= 0"
          v-hasPermi="['PRIV_TasksqzLog_REMOVE']">清空</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="download" @click="handleExport"
          v-hasPermi="['PRIV_TasksqzLog_EXPORT']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="TasksqzLogList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="日志编号" width="80" align="center" prop="TasksqzLogId" />
    ...
    <el-dialog title="日志详细" v-model="open" width="700px" append-to-body>
      <el-form ref="formRef" :model="form" label-width="100px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="日志序号：">{{ form.TasksqzLogId }}</el-form-item>
...
<script setup name="job/log">
  ...
  function handleDelete(row) {
    ...
    proxy
      .$confirm('是否确认删除调度日志编号为"' + TasksqzLogIds + '"的数据项?', '警告', {
