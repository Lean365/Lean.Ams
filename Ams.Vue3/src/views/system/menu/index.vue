<template>
  <div class="app-container">
    ...
    <!-- 数据区域 -->
    <vxe-table :height="tableHeight" height="650" border show-overflow ref="listRef" :loading="loading"
          ...
          <el-col :lg="12" v-if="form.menuType != 'F'">
            <el-form-item>
              ...
              <el-radio-group v-model="form.isStated">
                <el-radio v-for="dict in sys_normal_disable" :key="dict.dictValue" :value="parseInt( dict.dictValue)">{{
