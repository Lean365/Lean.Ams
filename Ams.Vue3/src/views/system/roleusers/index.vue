<template>
  <div class="app-container">
    ...
    <el-table ref="roleUserTableRef" v-loading="loading" :data="roleUserList"
      ...
      <el-table-column prop="isStated" align="center" :label="$t('prole.isStated')" width="110">
        <template #default="scope">
          <dict-tag :options="statusOptions" :value="scope.row.isStated" />
        </template>
      </el-table-column>
      <el-table-column prop="remark" :show-overflow-tooltip="true" align="center" :label="$t('prole.reMarks')" />
      <el-table-column align="center" :label="$t('btn.operation')">
        <template #default="scope">
          <el-button plain type="warning" size="small" icon="circle-close" @click="handleCancelPerm(scope.row)"
      ...
      <el-row>
        <el-col>
          <el-table ref="userTable" v-loading="loadingUser" :data="dataUserTable"
            ...
            <el-table-column prop="userName" align="center" :label="$t('puser.userName')" width="150" />
            <el-table-column prop="nickName" align="center" :label="$t('puser.userNick')" width="150" />
            <el-table-column prop="isStated" align="center" :label="$t('prole.isStated')">
              <template #default="scope">
                <dict-tag :options="statusOptions" :value="scope.row.isStated" />
              </template>
            </el-table-column>
