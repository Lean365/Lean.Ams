namespace Ams.WebApi.Controllers.System
{
    ...
    public class SysUserMsgController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpGet("list")]
        [ActionPermissionFilter(Permission = "system:msg:list")]
        ...
        /// <returns></returns>
        [HttpGet("{MsgId}")]
        [ActionPermissionFilter(Permission = "system:msg:query")]
        ...
        /// <returns></returns>
        [HttpPost]
        [ActionPermissionFilter(Permission = "system:msg:add")]
        [Log(Title = "用户消息", BusinessType = BusinessType.ADD)]
        ...
        [ActionPermissionFilter(Permission = "system:msg:delete")]
        ...
        [ActionPermissionFilter(Permission = "system:msg:read")]
        ...
        /// </summary>
        /// <returns></returns>
        [Log(Title = "用户消息", BusinessType = BusinessType.EXPORT, IsSaveResponseData = false)]
        [HttpGet("export")]
        [ActionPermissionFilter(Permission = "system:msg:export")]
        public IActionResult Export([FromQuery] SysUserMsgQueryDto parm)
        {
            ...
            var result = ExportExcelMini(list, "用户消息", "用户消息");
        ...
        /// </summary>
        /// <returns></returns>
        [Log(Title = "用户消息", BusinessType = BusinessType.EMPTY)]
        [ActionPermissionFilter(Permission = "system:msg:empty")]
        [HttpDelete("clean")]
