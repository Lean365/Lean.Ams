...
namespace Ams.WebApi.Controllers.Generate
{
    ...
    public class CodeGeneratorController : BaseController
    {
        ...
        public IActionResult ImportTableSave([FromBody] ImportCodeGenTableDto dto)
        {
            ...
            {
                throw new CustomizeException("表或数据库不能为空");
            }
        ...
        {
            if (genTableDto == null) throw new CustomizeException("请求参数错误");
        ...
        public IActionResult Preview([FromQuery] GenerateDto dto, [FromRoute] int tableId = 0)
        {
            ...
            {
                throw new CustomizeException(ResultCode.CUSTOM_ERROR, "请求参数为空");
            }
        ...
        {
            if (string.IsNullOrEmpty(tableName) || tableId <= 0) throw new CustomizeException("参数错误");
            GenTable table = GenTableService.GetGenTableInfo(tableId);
            if (table == null) { throw new CustomizeException("同步数据失败，原表结构不存在"); }
