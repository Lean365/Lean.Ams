...
using Ams.Service.IService.Generator;
using Ams.Service.IService.Systems;

namespace Ams.Admin.WebApi.Controllers.Generator
{
    /// <summary>
    /// 代码生成
    /// API控制器
    ...
    public class GeneratorController : BaseController
    {
        ...
        private readonly IGeneratorService GenTableService;
        ...
        public GeneratorController(
            IGeneratorService genTableService,
        ...
        [ActionPermissionFilter(Permission = "tool:gen:codeimport")]
        public IActionResult ImportTableSave([FromBody] ImportGeneratorTableDto dto)
        {
            ...
            foreach (var table in dto.Tables)
            {
                ...
                GenTable genTable = GeneratorTool.InitTable(initTableDto);
        ...
        [ActionPermissionFilter(Permission = "tool:gen:codeedit")]
        public IActionResult EditSave([FromBody] Model.Dto.Generator.GeneratorDto genTableDto)
        {
        ...
        public IActionResult Preview([FromQuery] CodeGenerator.Model.GeneratorDto dto, [FromRoute] int tableId = 0)
        {
            dto.TableId = tableId;
        ...
        public IActionResult CodeGenerate([FromBody] CodeGenerator.Model.GeneratorDto dto)
        {
            if (dto == null || dto.TableId <= 0)
            {
                throw new CustomException(ResultCode.CUSTOM_ERROR, "请求参数为空");
