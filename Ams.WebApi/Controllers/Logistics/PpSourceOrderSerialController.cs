...
namespace Ams.WebApi.Controllers.Logistics
{
    ...
    public class PpSourceOrderSerialController : BaseController
    {
        ...
        [Log(Title = "源订单序列号", BusinessType = BusinessType.INSERT)]
        ...
        [Log(Title = "源订单序列号", BusinessType = BusinessType.UPDATE)]
        ...
        /// </summary>
        /// <returns></returns>
        [Log(Title = "源订单序列号", BusinessType = BusinessType.EXPORT, IsSaveResponseData = false)]
        [HttpGet("export")]
