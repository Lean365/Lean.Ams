...
namespace Ams.WebApi.Controllers.Routine
{
    ...
    public class ArticleCategoryController : BaseController
    {
        ...
        [HttpPost]
        [Verify]
        [ActionPermissionFilter(Permission = "routine:articlecategory:add")]
        ...
        /// <returns></returns>
        [HttpDelete("{ids}")]
        [ActionPermissionFilter(Permission = "routine:articlecategory:delete")]
        ...
        [HttpGet("export")]
        [ActionPermissionFilter(Permission = "routine:articlecategory:export")]
