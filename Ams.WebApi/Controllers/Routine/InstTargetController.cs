...
namespace Ams.WebApi.Controllers.Routine
{
    ...
    public class InstTargetController : BaseController
    {
        ...
        public IActionResult GetInstTarget(long Id)
        {
            var response = _InstTargetService.GetInfo(Id);
        ...
        public IActionResult AddInstTarget([FromBody] InstTargetDto parm)
        {
           // 校验输入项目唯一性
            ...
            if (UserConstants.NOT_UNIQUE.Equals(_InstTargetService.CheckInputUnique(parm.Id.ToString())))
            {
