...
namespace Ams.WebApi.Controllers.Routine
{
    ...
    public class RoutineEhrEmployeeController : BaseController
    {
        ...
        [Log(Title = "人事", BusinessType = BusinessType.INSERT)]
        public IActionResult AddRoutineEhrEmployee([FromBody] RoutineEhrEmployeeDto parm)
        {
           // 校验输入项目唯一性
            ...
            {
                return ToResponse(ApiResult.Error($"新增人事 '{parm.EeSfId}'失败(Add failed)，输入的人事已存在(The entered already exists)"));
            }
        ...
        [Log(Title = "人事", BusinessType = BusinessType.UPDATE)]
        ...
        /// </summary>
        /// <returns></returns>
        [Log(Title = "人事", BusinessType = BusinessType.EXPORT, IsSaveResponseData = false)]
        [HttpGet("export")]
