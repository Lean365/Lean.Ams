...
namespace Ams.WebApi.Controllers.Routine
{
    ...
    public class RoutineEhrPerformanceController : BaseController
    {
        ...
        public IActionResult GetRoutineEhrPerformance(long EpSfId)
        {
            var response = _RoutineEhrPerformanceService.GetInfo(EpSfId);
        ...
        public IActionResult AddRoutineEhrPerformance([FromBody] RoutineEhrPerformanceDto parm)
        {
           // 校验输入项目唯一性
            ...
            if (UserConstants.NOT_UNIQUE.Equals(_RoutineEhrPerformanceService.CheckInputUnique(parm.EpSfId.ToString())))
            {
