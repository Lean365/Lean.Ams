...
namespace Ams.WebApi.Controllers.Routine
{
    ...
    public class RoutineEhrPerformanceMaController : BaseController
    {
        ...
        public IActionResult GetRoutineEhrPerformanceMa(long Id)
        {
            var response = _RoutineEhrPerformanceMaService.GetInfo(Id);
        ...
        public IActionResult AddRoutineEhrPerformanceMa([FromBody] RoutineEhrPerformanceMaDto parm)
        {
           // 校验输入项目唯一性
            ...
            if (UserConstants.NOT_UNIQUE.Equals(_RoutineEhrPerformanceMaService.CheckInputUnique(parm.Id.ToString())))
            {
