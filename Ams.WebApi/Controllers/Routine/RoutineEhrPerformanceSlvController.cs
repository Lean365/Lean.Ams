...
namespace Ams.WebApi.Controllers.Routine
{
    ...
    public class RoutineEhrPerformanceSlvController : BaseController
    {
        ...
        public IActionResult GetRoutineEhrPerformanceSlv(long EpSfId)
        {
            var response = _RoutineEhrPerformanceSlvService.GetInfo(EpSfId);
        ...
        public IActionResult AddRoutineEhrPerformanceSlv([FromBody] RoutineEhrPerformanceSlvDto parm)
        {
           // 校验输入项目唯一性
            ...
            if (UserConstants.NOT_UNIQUE.Equals(_RoutineEhrPerformanceSlvService.CheckInputUnique(parm.EpSfId.ToString())))
            {
