...
namespace Ams.WebApi.Controllers.Routine
{
    ...
    public class RoutineEhrTrainingMaController : BaseController
    {
        ...
        public IActionResult GetRoutineEhrTrainingMa(long EpSfId)
        {
            var response = _RoutineEhrTrainingMaService.GetInfo(EpSfId);
        ...
        public IActionResult AddRoutineEhrTrainingMa([FromBody] RoutineEhrTrainingMaDto parm)
        {
           // 校验输入项目唯一性
            ...
            if (UserConstants.NOT_UNIQUE.Equals(_RoutineEhrTrainingMaService.CheckInputUnique(parm.EpSfId.ToString())))
            {
