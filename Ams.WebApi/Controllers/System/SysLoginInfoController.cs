...
namespace Ams.WebApi.Controllers.System
{
    ...
    public class SysLoginInfoController : BaseController
    {
        ...
        public IActionResult Login([FromBody] LoginBodyDto loginBody)
        {
            ...
            LoginLogService.CheckLockUser(loginBody.Username);
            string location = HttpContextExtension.GetIpInfo(loginBody.LoginIP);
            var user = LoginLogService.Login(loginBody, new LoginLog() { LoginLocation = location });
        ...
        public IActionResult GetUserInfo()
        {
            ...
            //前端校验按钮权限使用
            //角色信息集合 eg: admin,yunying,common
        ...
        public IActionResult ScanLogin([FromBody] ScanDto dto)
        {
            ...
            LoginLogService.CheckLockUser(name);
        ...
        public IActionResult CheckMobile([FromBody] PhoneLoginDto dto)
        {
            ...
            SmsLogService.AddSmsLog(new SmsLog()
            {
                Userid = info.UserId,
        ...
        public IActionResult PhoneLogin([FromBody] PhoneLoginDto loginBody)
        {
            ...
            {
                return ToResponse(ResultCode.CUSTOM_ERROR, "短信验证错误");
            }
            ...
            LoginLogService.CheckLockUser(info.UserName);
            string location = HttpContextExtension.GetIpInfo(loginBody.LoginIP);
            var user = LoginLogService.PhoneLogin(loginBody, new LoginLog() { LoginLocation = location }, info);
