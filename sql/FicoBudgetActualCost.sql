...
VALUES ('预算实际明细', 1137, 999, 'FicoBudgetActualCost', 'accounting/FicoBudgetActualCost', 0, 0, 'C', '0', '0', 'fico:budgetactualcost:list', 'icon1', 'Lean365', GETDATE(), 'menu.fico.budgetactualcost');
...
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1137001,'zh-cn', 'menu.fico.budgetactualcost', '预算实际明细', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1137002,'zh-tw', 'menu.fico.budgetactualcost', 'TW_预算实际明细', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1137003,'en', 'menu.fico.budgetactualcost', 'EN_预算实际明细', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1137004,'ja', 'menu.fico.budgetactualcost', 'JA_预算实际明细', 'Lean365', GETDATE());