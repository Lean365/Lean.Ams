...
VALUES ('资产预算', 1137, 999, 'FicoBudgetAsset', 'accounting/FicoBudgetAsset', 0, 0, 'C', '0', '0', 'fico:budgetasset:list', 'icon1', 'Lean365', GETDATE(), 'menu.fico.budgetasset');
...
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1137001,'zh-cn', 'menu.fico.budgetasset', '资产预算', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1137002,'zh-tw', 'menu.fico.budgetasset', 'TW_资产预算', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1137003,'en', 'menu.fico.budgetasset', 'EN_资产预算', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1137004,'ja', 'menu.fico.budgetasset', 'JA_资产预算', 'Lean365', GETDATE());