...
VALUES ('公司科目', 1136, 999, 'FicoCorpTitle', 'accounting/FicoCorpTitle', 0, 0, 'C', '0', '0', 'fico:corptitle:list', 'icon1', 'Lean365', GETDATE(), 'menu.fico.corptitle');
...
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1136001,'zh-cn', 'menu.fico.corptitle', '公司科目', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1136002,'zh-tw', 'menu.fico.corptitle', 'TW_公司科目', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1136003,'en', 'menu.fico.corptitle', 'EN_公司科目', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1136004,'ja', 'menu.fico.corptitle', 'JA_公司科目', 'Lean365', GETDATE());