...
VALUES ('部门消耗', 1138, 999, 'FicoDeptConsuming', 'accounting/FicoDeptConsuming', 0, 0, 'C', '0', '0', 'fico:deptconsuming:list', 'icon1', 'Lean365', GETDATE(), 'menu.fico.deptconsuming');
...
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1138001,'zh-cn', 'menu.fico.deptconsuming', '部门消耗', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1138002,'zh-tw', 'menu.fico.deptconsuming', 'TW_部门消耗', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1138003,'en', 'menu.fico.deptconsuming', 'EN_部门消耗', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1138004,'ja', 'menu.fico.deptconsuming', 'JA_部门消耗', 'Lean365', GETDATE());