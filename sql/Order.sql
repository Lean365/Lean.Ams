...
VALUES ('生产工单', 1003021, 999, 'Order', 'logistics/Order', 0, 0, 'C', '0', '0', 'pp:order:list', 'icon1', 'Lean365', GETDATE(), 'menu.pp.order');
...
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1003021001,'zh-cn', 'menu.pp.order', '生产工单', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1003021002,'zh-tw', 'menu.pp.order', 'TW_生产工单', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1003021003,'en', 'menu.pp.order', 'EN_生产工单', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1003021004,'ja', 'menu.pp.order', 'JA_生产工单', 'Lean365', GETDATE());