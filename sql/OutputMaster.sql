...
VALUES ('oph主表', 1003023, 999, 'OutputMaster', 'logistics/OutputMaster', 0, 0, 'C', '0', '0', 'pp:outputmaster:list', 'icon1', 'Lean365', GETDATE(), 'menu.pp.outputmaster');
...
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1003023001,'zh-cn', 'menu.pp.outputmaster', 'oph主表', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1003023002,'zh-tw', 'menu.pp.outputmaster', 'TW_oph主表', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1003023003,'en', 'menu.pp.outputmaster', 'EN_oph主表', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1003023004,'ja', 'menu.pp.outputmaster', 'JA_oph主表', 'Lean365', GETDATE());