...
VALUES ('Pmc设变', 1145, 999, 'PpEcSlavePmc', 'logistics/PpEcSlavePmc', 0, 0, 'C', '0', '0', 'pp:ecslavepmc:list', 'icon1', 'Lean365', GETDATE(), 'menu.pp.ecslavepmc');
...
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1145001,'zh-cn', 'menu.pp.ecslavepmc', 'Pmc设变', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1145002,'zh-tw', 'menu.pp.ecslavepmc', 'TW_Pmc设变', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1145003,'en', 'menu.pp.ecslavepmc', 'EN_Pmc设变', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1145004,'ja', 'menu.pp.ecslavepmc', 'JA_Pmc设变', 'Lean365', GETDATE());