...
VALUES ('生产班组', 1121, 999, 'PpLine', 'logistics/PpLine', 0, 0, 'C', '0', '0', 'pp:line:list', 'icon1', 'Lean365', GETDATE(), 'menu.pp.line');
...
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1121001,'zh-cn', 'menu.pp.line', '生产班组', 'Lean365', GETDATE());

INSERT INTO sys_locale(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1121002,'zh-tw', 'menu.pp.line', 'TW_生产班组', 'Lean365', GETDATE());

INSERT INTO sys_locale(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1121003,'en', 'menu.pp.line', 'EN_生产班组', 'Lean365', GETDATE());

INSERT INTO sys_locale(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1121004,'ja', 'menu.pp.line', 'JA_生产班组', 'Lean365', GETDATE());