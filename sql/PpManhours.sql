...
VALUES ('标准工时', 1139, 999, 'PpManhours', 'logistics/PpManhours', 0, 0, 'C', '0', '0', 'pp:manhours:list', 'icon1', 'Lean365', GETDATE(), 'menu.pp.manhours');
...
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1139001,'zh-cn', 'menu.pp.manhours', '标准工时', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1139002,'zh-tw', 'menu.pp.manhours', 'TW_标准工时', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1139003,'en', 'menu.pp.manhours', 'EN_标准工时', 'Lean365', GETDATE());
