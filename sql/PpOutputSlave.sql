...
VALUES ('oph从表', 1155, 999, 'PpOutputSlave', 'logistics/PpOutputSlave', 0, 0, 'C', '0', '0', 'pp:outputslave:list', 'icon1', 'Lean365', GETDATE(), 'menu.pp.outputslave');
...
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1155001,'zh-cn', 'menu.pp.outputslave', 'oph从表', 'Lean365', GETDATE());

INSERT INTO sys_locale(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1155002,'zh-tw', 'menu.pp.outputslave', 'TW_oph从表', 'Lean365', GETDATE());

INSERT INTO sys_locale(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1155003,'en', 'menu.pp.outputslave', 'EN_oph从表', 'Lean365', GETDATE());

INSERT INTO sys_locale(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1155004,'ja', 'menu.pp.outputslave', 'JA_oph从表', 'Lean365', GETDATE());