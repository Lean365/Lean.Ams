...
VALUES ('组立不良slv', 1284, 999, 'PpRepairAssySlv', 'logistics/PpRepairAssySlv', 0, 0, 'C', '0', '0', 'pp:repairassyslv:list', 'icon1', 'Lean365', GETDATE(), 'menu.pp.repairassyslv');
...
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1284001,'zh-cn', 'menu.pp.repairassyslv', '组立不良slv', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1284002,'zh-tw', 'menu.pp.repairassyslv', 'TW_组立不良slv', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1284003,'en', 'menu.pp.repairassyslv', 'EN_组立不良slv', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1284004,'ja', 'menu.pp.repairassyslv', 'JA_组立不良slv', 'Lean365', GETDATE());