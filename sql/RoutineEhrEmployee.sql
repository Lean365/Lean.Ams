...
VALUES ('人事信息', 1210, 999, 'RoutineEhrEmployee', 'routine/RoutineEhrEmployee', 0, 0, 'C', '0', '0', 'routine:ehremployee:list', 'icon1', 'Lean365', GETDATE(), 'menu.routine.ehremployee');
...
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1210001,'zh-cn', 'menu.routine.ehremployee', '人事信息', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1210002,'zh-tw', 'menu.routine.ehremployee', 'TW_人事信息', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1210003,'en', 'menu.routine.ehremployee', 'EN_人事信息', 'Lean365', GETDATE());

INSERT INTO sys_locale_lang(id,lang_code, lang_key, lang_name, Create_by, Create_time) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+1210004,'ja', 'menu.routine.ehremployee', 'JA_人事信息', 'Lean365', GETDATE());